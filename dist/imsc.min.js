...
b.push(q[0].contents[a]);q[0].contents=b}q[0]instanceof t&&1===q[0].contents.length&&q[0].contents[0]instanceof u&&(q[0].text=q[0].contents[0].text,delete q[0].contents)}else if(q[0]instanceof D)if(q[0].node.uri===n.ns_tt&&"metadata"===q[0].node.local)x--;else if(0<x&&e&&"onCloseTag"in e)e.onCloseTag();F.shift();g.shift();q.shift()};m.ontext=function(b){if(void 0!==q[0])if(q[0]instanceof t||q[0]instanceof P){if(q[0]instanceof t){var a=q[0].styleAttrs[l.byName.ruby.qname];if("container"===a||"textContainer"===
...
m,f.appendChild(g),d.mra=m);(m=b.styleAttrs[n.byName.rubyReserve.qname])&&"none"!==m[0]&&(d.rubyReserve=m);b.styleAttrs[n.byName.fillLineGap.qname]&&(d.flg=!0);if("span"===b.kind&&b.text)if((m=b.styleAttrs[n.byName.textEmphasis.qname])&&"none"!==m.style&&(d.textEmphasis=!0),n.byName.textCombine.qname in b.styleAttrs&&"all"===b.styleAttrs[n.byName.textCombine.qname])f.textContent=b.text,m&&M(d,f,b,m);else for(e="",k=0;k<b.text.length;k++){e+=b.text.charAt(k);var t=b.text.charCodeAt(k);if(55296>t||
56319<t||k===b.text.length-1)t=document.createElement("span"),t.textContent=e,m&&M(d,t,b,m),f.appendChild(t),e="",t._isd_element=b}for(var u in b.contents)b.contents.hasOwnProperty(u)&&A(d,g,b.contents[u],b);u=[];if("p"===b.kind){h(d,g,u,null);if(d.rubyReserve){for(m=0;m<u.length;m++){e=document.createElement("ruby");k=document.createElement("rb");k.textContent="\u200b";e.appendChild(k);var l=d.rubyReserve[1].toUsedLength(d.w,d.h)+"px";"both"===d.rubyReserve[0]||"outside"===d.rubyReserve[0]&&1==u.length?
(k=document.createElement("rtc"),k.style[C]=z?"after":"under",k.textContent="\u200b",k.style.fontSize=l,t=document.createElement("rtc"),t.style[C]=z?"before":"over",t.textContent="\u200b",t.style.fontSize=l,e.appendChild(k),e.appendChild(t)):(k=document.createElement("rtc"),k.textContent="\u200b",k.style.fontSize=l,k.style[C]="after"===d.rubyReserve[0]||"outside"===d.rubyReserve[0]&&0<m?z?"after":"tb"===d.bpd||"rl"===d.bpd?"under":"over":z?"before":"tb"===d.bpd||"rl"===d.bpd?"over":"under",e.appendChild(k));
k=null;for(t=0;t<u[m].rbc.length;t++)if("ruby"===u[m].rbc[t].localName){k=u[m].rbc[t];for(t=0;t<k.style.length;t++)e.style.setProperty(k.style.item(t),k.style.getPropertyValue(k.style.item(t)));break}k=k||u[m].elements[0].node;k.parentElement.insertBefore(e,k)}d.rubyReserve=null}if(d.ruby||d.rubyReserve){for(m=0;m<u.length;m++)for(e=0;e<u[m].rbc.length;e++)u[m].rbc[e].style[C]||(u[m].rbc[e].style[C]=z?0===m?"before":"after":"tb"===d.bpd?0===m?"over":"under":"rl"===d.bpd?0===m?"over":"under":0===m?
...
null}if(d.lp){m=d.lp.multiply(d.lp.toUsedLength(d.w,d.h),d.options.sizeAdjust);for(e=0;e<u.length;e++)if(k=Math.ceil(m)+"px",t="-"+Math.ceil(m)+"px",0!==u[e].elements.length){l=u[e].elements[u[e].start_elem];var p=u[e].elements[u[e].end_elem];if(l===p&&(elementBoundingRect=l.node.getBoundingClientRect(),0==elementBoundingRect.width||0==elementBoundingRect.height))continue;"lr"===d.ipd?(l.node.style.marginLeft=t,l.node.style.paddingLeft=k):"rl"===d.ipd?(l.node.style.paddingRight=k,l.node.style.marginRight=
t):"tb"===d.ipd&&(l.node.style.paddingTop=k,l.node.style.marginTop=t);"lr"===d.ipd?(p.node.style.paddingRight=k,p.node.style.marginRight=t):"rl"===d.ipd?(p.node.style.paddingLeft=k,p.node.style.marginLeft=t):"tb"===d.ipd&&(p.node.style.paddingBottom=k,p.node.style.marginBottom=t)}"tb"===d.bpd?(d.removePaddingElement.style.paddingLeft=0,d.removePaddingElement.style.paddingRight=0):(d.removePaddingElement.style.paddingTop=0,d.removePaddingElement.style.paddingBottom=0);d.lp=null}for(m=0;m<u.length;m++)for(e=
u[m],k=1;k<e.elements.length;){t=e.elements[k-1].node;l=e.elements[k].node;if("SPAN"===t.tagName&&"SPAN"===l.tagName&&t._isd_element===l._isd_element){t.textContent+=l.textContent;for(p=0;p<l.style.length;p++){var r=l.style[p];if(0<=r.indexOf("border")||0<=r.indexOf("padding")||0<=r.indexOf("margin"))t.style[r]=l.style[r]}l.parentElement.removeChild(l);t=!0}else t=!1;t?e.elements.splice(k,1):k++}m=[];for(t=0;t<u.length;t++)for(l=0;l<u[t].elements.length;l++)if(e=u[t].elements[l].node,k=a(e,m,!1))e.style.backgroundColor=
k;for(e=0;e<m.length;e++)m[e].style.backgroundColor="";if(d.flg){e=D(g.getBoundingClientRect(),d);m=e.before;e=e.after;k=Math.sign(e-m);for(t=0;t<=u.length;t++){l=0===t?Math.round(m):t===u.length?Math.round(e):Math.round((u[t-1].after+u[t].before)/2);if(0<t&&u[t-1])for(r=0;r<u[t-1].elements.length;r++){var H=u[t-1].elements[r];p=k*(l-H.after)+"px";"lr"===d.bpd?H.node.style.paddingRight=p:"rl"===d.bpd?H.node.style.paddingLeft=p:"tb"===d.bpd&&(H.node.style.paddingBottom=p)}if(t<u.length)for(r=0;r<u[t].elements.length;r++)H=
u[t].elements[r],p=k*(H.before-l)+"px","lr"===d.bpd?H.node.style.paddingLeft=p:"rl"===d.bpd?H.node.style.paddingRight=p:"tb"===d.bpd&&(H.node.style.paddingTop=p)}d.flg=null}}"region"===b.kind&&"tb"===d.bpd&&d.enableRollUp&&0<b.contents.length&&"after"===b.styleAttrs[n.byName.displayAlign.qname]&&(h(d,g,u,null),b=new c(""===b.id?"_":b.id,u),d.currentISDState[b.id]=b,d.previousISDState&&b.id in d.previousISDState&&0<d.previousISDState[b.id].plist.length&&1<b.plist.length&&b.plist[b.plist.length-2].text===
d.previousISDState[b.id].plist[d.previousISDState[b.id].plist.length-1].text&&(d=f.firstElementChild,b=b.plist[b.plist.length-1].after-b.plist[b.plist.length-1].before,d.style.bottom="-"+b+"px",d.style.transition="transform 0.4s",d.style.position="relative",d.style.transform="translateY(-"+b+"px)"))}else if(d=d.errorHandler,b="Error processing ISD element kind: "+b.kind,d&&d.error&&d.error(b))throw b;}function a(d,c,b){if(d.style.backgroundColor)return b&&!c.includes(d)&&c.push(d),d.style.backgroundColor;
if("SPAN"===d.parentElement.nodeName)return a(d.parentElement,c,!0)}function c(d,a){this.id=d;this.plist=a}function D(d,a){var b={before:null,after:null,start:null,end:null};"tb"===a.bpd?(b.before=d.top,b.after=d.bottom,"lr"===a.ipd?(b.start=d.left,b.end=d.right):(b.start=d.right,b.end=d.left)):"lr"===a.bpd?(b.before=d.left,b.after=d.right,b.start=d.top,b.end=d.bottom):"rl"===a.bpd&&(b.before=d.right,b.after=d.left,b.start=d.top,b.end=d.bottom);return b}function h(d,a,b,e){if("rt"!==a.localName&&
"rtc"!==a.localName)if(e=a.style.backgroundColor||e,0===a.childElementCount)if("span"===a.localName||"rb"===a.localName){var c=a.getBoundingClientRect();d=D(c,d);if(!(c=0===b.length)){c=d.before;var m=d.after,k=b[b.length-1].before,f=b[b.length-1].after;c=!(m<f&&c>k||f<=m&&k>=c)}c?b.push({before:d.before,after:d.after,start:d.start,end:d.end,start_elem:0,end_elem:0,elements:[],rbc:[],te:[],text:"",br:!1}):(c=Math.sign(d.after-d.before),m=Math.sign(d.end-d.start),0>c*(d.before-b[b.length-1].before)&&
(b[b.length-1].before=d.before),0<c*(d.after-b[b.length-1].after)&&(b[b.length-1].after=d.after),0>m*(d.start-b[b.length-1].start)&&(b[b.length-1].start=d.start,b[b.length-1].start_elem=b[b.length-1].elements.length),0<m*(d.end-b[b.length-1].end)&&(b[b.length-1].end=d.end,b[b.length-1].end_elem=b[b.length-1].elements.length));b[b.length-1].text+=a.textContent;b[b.length-1].elements.push({node:a,bgcolor:e,before:d.before,after:d.after})}else"br"===a.localName&&0!==b.length&&(b[b.length-1].br=!0);else for(a=
a.firstChild;a;)a.nodeType===Node.ELEMENT_NODE&&(h(d,a,b,e),"ruby"===a.localName||"rtc"===a.localName?0<b.length&&b[b.length-1].rbc.push(a):"span"===a.localName&&a.style[J]&&"none"!==a.style[J]&&0<b.length&&b[b.length-1].te.push(a)),a=a.nextSibling}function M(d,a,b,e){"none"!==e.style&&(a.style[J]="auto"===e.style?"filled":e.style+" "+e.symbol,"before"===e.position||"after"===e.position)&&(a.style[y]="tb"===d.bpd?"before"===e.position?"left over":"left under":"rl"===d.bpd?"before"===e.position?"right under":
"left under":"before"===e.position?"left under":"right under")}function k(d,a){this.qname=d;this.map=a}f.render=function(d,a,b,e,c,k,f,h,g,n){e=e||a.clientHeight;var m=c||a.clientWidth;null!==d.aspectRatio&&(c=e*d.aspectRatio,c>m?e=Math.round(m/d.aspectRatio):m=c);c=document.createElement("div");c.style.position="relative";c.style.width=m+"px";c.style.height=e+"px";c.style.margin="auto";c.style.top=0;c.style.bottom=0;c.style.left=0;c.style.right=0;c.style.zIndex=0;b={h:e,w:m,regionH:null,regionW:null,
imgResolver:b,displayForcedOnlyMode:k||!1,isd:d,errorHandler:f,previousISDState:h,enableRollUp:g||!1,currentISDState:{},flg:null,lp:null,mra:null,ipd:null,bpd:null,ruby:null,textEmphasis:null,rubyReserve:null,options:Object.assign({},n)||{}};b.options.colorAdjust&&(b.options.colorAdjust=p(b.options.colorAdjust));k=["region","body","div","p","span"];for(var D in k)k.hasOwnProperty(D)&&(f=k[D]+"BackgroundColorAdjust",b.options[f]&&(b.options[f]=p(b.options[f])));a.appendChild(c);for(var l in d.contents)d.contents.hasOwnProperty(l)&&
A(b,c,d.contents[l],d);return b.currentISDState};var B=[new k("http://www.w3.org/ns/ttml#styling backgroundColor",function(a,c,b,e){(b=(b=a.options[b.kind+"BackgroundColorAdjust"])&&b[e.toString()])&&(e=b);b=e[3];0!==b&&(void 0!=a.options.backgroundOpacityScale&&(b*=a.options.backgroundOpacityScale),c.style.backgroundColor="rgba("+e[0].toString()+","+e[1].toString()+","+e[2].toString()+","+(b/255).toString()+")")}),new k("http://www.w3.org/ns/ttml#styling color",function(a,c,b,e){b=a.options.colorOpacityScale||
1;a=a.options.colorAdjust;void 0!=a&&(a=a[e.toString()])&&(e=a);c.style.color="rgba("+e[0].toString()+","+e[1].toString()+","+e[2].toString()+","+(b*e[3]/255).toString()+")"}),new k("http://www.w3.org/ns/ttml#styling direction",function(a,c,b,e){c.style.direction=e}),new k("http://www.w3.org/ns/ttml#styling display",function(a,c,b,e){}),new k("http://www.w3.org/ns/ttml#styling displayAlign",function(a,c,b,e){c.style.display="flex";c.style.flexDirection="column";"before"===e?c.style.justifyContent=
"flex-start":"center"===e?c.style.justifyContent="center":"after"===e&&(c.style.justifyContent="flex-end")}),new k("http://www.w3.org/ns/ttml#styling extent",function(a,c,b,e){a.regionH=e.h.toUsedLength(a.w,a.h);a.regionW=e.w.toUsedLength(a.w,a.h);var d=e=0;if(b=b.styleAttrs["http://www.w3.org/ns/ttml#styling padding"])e=b[0].toUsedLength(a.w,a.h)+b[2].toUsedLength(a.w,a.h),d=b[1].toUsedLength(a.w,a.h)+b[3].toUsedLength(a.w,a.h);c.style.height=a.regionH-e+"px";c.style.width=a.regionW-d+"px"}),new k("http://www.w3.org/ns/ttml#styling fontFamily",
function(a,c,b,e){b=[];a.options.fontFamily&&(e=a.options.fontFamily.split(","));for(var d in e)e[d].hasOwnProperty(d)&&(e[d]=e[d].trim(),"monospaceSerif"===e[d]?(b.push("Courier New"),b.push('"Liberation Mono"'),b.push("Courier"),b.push("monospace")):"proportionalSansSerif"===e[d]||"default"===e[d]?(b.push("Arial"),b.push("Helvetica"),b.push('"Liberation Sans"'),b.push("sans-serif")):"monospace"===e[d]?b.push("monospace"):"sansSerif"===e[d]?b.push("sans-serif"):"serif"===e[d]?b.push("serif"):"monospaceSansSerif"===
e[d]?(b.push("Consolas"),b.push("monospace")):"proportionalSerif"===e[d]?b.push("serif"):b.push(e[d]));if(0<b.length){a=[b[0]];for(e=1;e<b.length;e++)-1==a.indexOf(b[e])&&a.push(b[e]);b=a}c.style.fontFamily=b.join(",")}),new k("http://www.w3.org/ns/ttml#styling shear",function(a,c,b,e){0!==e&&(b=-.9*e,c.style.transform="tb"===a.bpd?"skewX("+b+"deg)":"skewY("+b+"deg)")}),new k("http://www.w3.org/ns/ttml#styling fontSize",function(a,c,b,e){c.style.fontSize=e.multiply(e.toUsedLength(a.w,a.h),a.options.sizeAdjust)+
...
(b*=a.options.regionOpacityScale);c.style.opacity=b}),new k("http://www.w3.org/ns/ttml#styling origin",function(a,c,b,e){c.style.top=e.h.toUsedLength(a.w,a.h)+"px";c.style.left=e.w.toUsedLength(a.w,a.h)+"px"}),new k("http://www.w3.org/ns/ttml#styling overflow",function(a,c,b,e){c.style.overflow=e}),new k("http://www.w3.org/ns/ttml#styling padding",function(a,c,b,e){b=[];b[0]=e[0].toUsedLength(a.w,a.h)+"px";b[1]=e[3].toUsedLength(a.w,a.h)+"px";b[2]=e[2].toUsedLength(a.w,a.h)+"px";b[3]=e[1].toUsedLength(a.w,
a.h)+"px";c.style.padding=b.join(" ")}),new k("http://www.w3.org/ns/ttml#styling position",function(a,c,b,e){c.style.top=e.h.toUsedLength(a.w,a.h)+"px";c.style.left=e.w.toUsedLength(a.w,a.h)+"px"}),new k("http://www.w3.org/ns/ttml#styling rubyAlign",function(a,c,b,e){c.style.rubyAlign="spaceAround"===e?"space-around":"center"}),new k("http://www.w3.org/ns/ttml#styling rubyPosition",function(a,c,b,e){if("before"===e||"after"===e)c.parentElement.style[C]=z?e:"tb"===a.bpd?"before"===e?"over":"under":
"rl"===a.bpd?"before"===e?"over":"under":"before"===e?"under":"over"}),new k("http://www.w3.org/ns/ttml#styling showBackground",null),new k("http://www.w3.org/ns/ttml#styling textAlign",function(a,c,b,e){c.style.textAlign="start"===e?"rl"===a.ipd?"right":"left":"end"===e?"rl"===a.ipd?"left":"right":e}),new k("http://www.w3.org/ns/ttml#styling textDecoration",function(a,c,b,e){c.style.textDecoration=e.join(" ").replace("lineThrough","line-through")}),new k("http://www.w3.org/ns/ttml#styling textOutline",
function(a,c,b,e){}),new k("http://www.w3.org/ns/ttml#styling textShadow",function(a,c,b,e){b=b.styleAttrs[n.byName.textOutline.qname];var d=a.options.textOutline;if(d)if("none"===d)b=d;else{var k={};d=d.split(" ");if(0!==d.length&&2>=d.length){var f=l.parseColor(d[0]);k.color=f;null!==f&&d.shift();1===d.length&&(d=l.parseLength(d[0]))&&(k.thickness=d,b=k)}}if("none"===e&&"none"===b)c.style.textShadow="";else{k=[];"none"!==b&&(b="rgba("+b.color[0].toString()+","+b.color[1].toString()+","+b.color[2].toString()+
","+(b.color[3]/255).toString()+")",k.push("1px 1px 1px "+b),k.push("-1px 1px 1px "+b),k.push("1px -1px 1px "+b),k.push("-1px -1px 1px "+b));if("none"!==e)for(var h in e)e.hasOwnProperty(h)&&k.push(e[h].x_off.toUsedLength(a.w,a.h)+"px "+e[h].y_off.toUsedLength(a.w,a.h)+"px "+e[h].b_radius.toUsedLength(a.w,a.h)+"px rgba("+e[h].color[0].toString()+","+e[h].color[1].toString()+","+e[h].color[2].toString()+","+(e[h].color[3]/255).toString()+")");c.style.textShadow=k.join(",")}}),new k("http://www.w3.org/ns/ttml#styling textCombine",
function(a,c,b,e){c.style.textCombineUpright=e}),new k("http://www.w3.org/ns/ttml#styling textEmphasis",function(a,c,b,e){}),new k("http://www.w3.org/ns/ttml#styling unicodeBidi",function(a,c,b,e){c.style.unicodeBidi="bidiOverride"===e?"bidi-override":e}),new k("http://www.w3.org/ns/ttml#styling visibility",function(a,c,b,e){c.style.visibility=e}),new k("http://www.w3.org/ns/ttml#styling wrapOption",function(a,c,b,e){c.style.whiteSpace="wrap"===e?"preserve"===b.space?"pre-wrap":"normal":"preserve"===
b.space?"pre":"noWrap"}),new k("http://www.w3.org/ns/ttml#styling writingMode",function(a,c,b,e){if("lrtb"===e||"lr"===e)c.style.writingMode="horizontal-tb";else if("rltb"===e||"rl"===e)c.style.writingMode="horizontal-tb";else if("tblr"===e)c.style.writingMode="vertical-lr";else if("tbrl"===e||"tb"===e)c.style.writingMode="vertical-rl"}),new k("http://www.w3.org/ns/ttml#styling zIndex",function(a,c,b,e){c.style.zIndex=e}),new k("http://www.w3.org/ns/ttml/profile/imsc1#styling forcedDisplay",function(a,
c,b,e){a.displayForcedOnlyMode&&!1===e&&(c.style.visibility="hidden")})],r;for(r in B)B.hasOwnProperty(r);var z="webkitRubyPosition"in window.getComputedStyle(document.documentElement),C=z?"webkitRubyPosition":"rubyPosition",J="webkitTextEmphasisStyle"in window.getComputedStyle(document.documentElement)?"webkitTextEmphasisStyle":"textEmphasisStyle",y="webkitTextEmphasisPosition"in window.getComputedStyle(document.documentElement)?"webkitTextEmphasisPosition":"textEmphasisPosition"})("undefined"===
typeof p?this.imscHTML={}:p,"undefined"===typeof imscNames?g("./names"):imscNames,"undefined"===typeof imscStyles?g("./styles"):imscStyles,"undefined"===typeof imscUtils?g("./utils"):imscUtils)},{"./names":5,"./styles":6,"./utils":7}],3:[function(g,r,p){(function(f,g,n,l){function p(k,f,g,D,r,J,y,d,m){if(f<y.begin||f>=y.end)return null;J="regionID"in y&&""!==y.regionID?y.regionID:J;if(null!==r&&J!==g.id&&(!("contents"in y)||"contents"in y&&0===y.contents.length||""!==J))return null;var b=new h(y);
for(e in y.sets)!y.sets.hasOwnProperty(e)||f<y.sets[e].begin||f>=y.sets[e].end||(b.styleAttrs[y.sets[e].qname]=y.sets[e].value);var e={};for(var v in b.styleAttrs)if(b.styleAttrs.hasOwnProperty(v)&&(e[v]=!0,"region"===b.kind&&v===n.byName.writingMode.qname&&!(n.byName.direction.qname in b.styleAttrs))){var B=b.styleAttrs[v];if("lrtb"===B||"lr"===B)b.styleAttrs[n.byName.direction.qname]="ltr";else if("rltb"===B||"rl"===B)b.styleAttrs[n.byName.direction.qname]="rtl"}if(null!==r)for(var z in n.all)if(n.all.hasOwnProperty(z))if(v=
n.all[z],v.qname===n.byName.textDecoration.qname){B=r.styleAttrs[v.qname];var t=b.styleAttrs[v.qname],u=[];void 0===t?u=B:-1===t.indexOf("none")?((-1===t.indexOf("noUnderline")&&-1!==B.indexOf("underline")||-1!==t.indexOf("underline"))&&u.push("underline"),(-1===t.indexOf("noLineThrough")&&-1!==B.indexOf("lineThrough")||-1!==t.indexOf("lineThrough"))&&u.push("lineThrough"),(-1===t.indexOf("noOverline")&&-1!==B.indexOf("overline")||-1!==t.indexOf("overline"))&&u.push("overline")):u.push("none");b.styleAttrs[v.qname]=
u}else v.qname!==n.byName.fontSize.qname||v.qname in b.styleAttrs||"span"!==b.kind||"textContainer"!==b.styleAttrs[n.byName.ruby.qname]?v.qname!==n.byName.fontSize.qname||v.qname in b.styleAttrs||"span"!==b.kind||"text"!==b.styleAttrs[n.byName.ruby.qname]?v.inherit&&v.qname in r.styleAttrs&&!(v.qname in b.styleAttrs)&&(b.styleAttrs[v.qname]=r.styleAttrs[v.qname]):(B=r.styleAttrs[n.byName.fontSize.qname],b.styleAttrs[v.qname]="textContainer"===r.styleAttrs[n.byName.ruby.qname]?B:new l.ComputedLength(.5*
...
v,e[z.qname]=!0;else if(z="Invalid initial value for '"+z.qname+"' on element '"+b.kind,d&&d.error&&d.error(z))throw z;for(var K in n.all)if(n.all.hasOwnProperty(K)&&(C=n.all[K],C.qname in e&&null!==C.compute))if(z=C.compute(k,r,b,b.styleAttrs[C.qname],m),null!==z)b.styleAttrs[C.qname]=z;else if(b.styleAttrs[C.qname]=C.compute(k,r,b,C.parse(C.initial),m),C="Style '"+C.qname+"' on element '"+b.kind+"' cannot be computed",d&&d.error&&d.error(C))throw C;if("none"===b.styleAttrs[n.byName.display.qname])return null;
if(null===r)var I=null===D?[]:[D];else"contents"in y&&(I=y.contents);for(var H in I)I.hasOwnProperty(H)&&(r=p(k,f,g,D,b,J,I[H],d,m),null!==r&&b.contents.push(r.element));for(var G in b.styleAttrs)b.styleAttrs.hasOwnProperty(G)&&(k=!1,"span"===b.kind&&(f=b.styleAttrs[n.byName.ruby.qname],(k=("container"===f||"textContainer"===f||"baseContainer"===f)&&-1!==M.indexOf(G))||(k="container"!==f&&G===n.byName.rubyAlign.qname),k||(k=!("textContainer"===f||"text"===f)&&G===n.byName.rubyPosition.qname)),k||
(k=-1===n.byQName[G].applies.indexOf(b.kind)),k&&delete b.styleAttrs[G]);G=b.styleAttrs[n.byName.ruby.qname];if("p"===b.kind||"span"===b.kind&&("textContainer"===G||"text"===G))G=[],a(b,G),A(G),c(b);return"div"===b.kind&&n.byName.backgroundImage.qname in b.styleAttrs||"br"===b.kind||"image"===b.kind||"contents"in b&&0<b.contents.length||"span"===b.kind&&null!==b.text||"region"===b.kind&&"always"===b.styleAttrs[n.byName.showBackground.qname]?{region_id:J,element:b}:null}function A(a){function c(a){return"br"===
a.kind||/[\r\n\t ]$/.test(a.text)}function f(a){return"br"===a.kind||"preserve"===a.space&&/^[\r\n]/.test(a.text)}for(var k,h=0;h<a.length;)if(k=a[h],"br"===k.kind||"preserve"===k.space)h++;else{var g=k.text.replace(/[\t\r\n ]+/g," ");/^[ ]/.test(g)&&(0===h||c(a[h-1]))&&(g=g.substring(1));k.text=g;0===g.length?a.splice(h,1):h++}for(h=0;h<a.length;h++)k=a[h],"br"===k.kind||"preserve"===k.space?h++:/[ ]$/.test(k.text)&&(h===a.length-1||f(a[h+1]))&&(k.text=k.text.slice(0,-1))}function a(c,f){for(var k in c.contents)if(c.contents.hasOwnProperty(k)){var h=
c.contents[k],g=h.styleAttrs[n.byName.ruby.qname];if("span"!==h.kind||"textContainer"!==g&&"text"!==g)"contents"in h?a(h,f):("span"===h.kind&&0!==h.text.length||"br"===h.kind)&&f.push(h)}}function c(a){if("br"===a.kind)return!1;if("text"in a)return 0===a.text.length;if("contents"in a){for(var h=a.contents.length;h--;)c(a.contents[h])&&a.contents.splice(h,1);return 0===a.contents.length}}function D(a){this.contents=[];this.aspectRatio=a.aspectRatio;this.lang=a.lang}function h(a){this.kind=a.kind||
"region";this.lang=a.lang;a.id&&(this.id=a.id);this.styleAttrs={};for(var c in a.styleAttrs)a.styleAttrs.hasOwnProperty(c)&&(this.styleAttrs[c]=a.styleAttrs[c]);"src"in a&&(this.src=a.src);"type"in a&&(this.type=a.type);if("text"in a)this.text=a.text;else if("region"===this.kind||"contents"in a)this.contents=[];"space"in a&&(this.space=a.space)}f.generateISD=function(a,c,h){function f(a,b){function c(b){return!(a<b.begin||a>=b.end)}if(b.contents){var e={},h;for(h in b)b.hasOwnProperty(h)&&(e[h]=b[h]);
e.contents=[];b.contents.filter(c).forEach(function(b){b=f(a,b);b.regionID&&(d[b.regionID]=!0);null!==b&&e.contents.push(b)});return e}return b}var k=new D(a),g={},l={},d={};l=a.head.styling.initials[n.byName.showBackground.qname];var m=a.head.styling.initials[n.byName.backgroundColor.qname];for(A in a.head.layout.regions)if(a.head.layout.regions.hasOwnProperty(A)){var b=a.head.layout.regions[A],e=b.styleAttrs[n.byName.showBackground.qname]||l,M=b.styleAttrs[n.byName.backgroundColor.qname]||m;d[b.id]=
("always"===e||void 0===e)&&void 0!==M&&!(c<b.begin||c>=b.end)}a.body&&a.body.regionID&&(d[a.body.regionID]=!0);l=null!==a.body?f(c,a.body):null;void 0!==d[""]&&(d[""]=!0);for(var r in d)if(d[r]){var A=p(a,c,a.head.layout.regions[r],l,null,"",a.head.layout.regions[r],h,g);null!==A&&k.contents.push(A.element)}return k};var M=[n.byName.color.qname,n.byName.textCombine.qname,n.byName.textDecoration.qname,n.byName.textEmphasis.qname,n.byName.textOutline.qname,n.byName.textShadow.qname]})("undefined"===
typeof p?this.imscISD={}:p,"undefined"===typeof imscNames?g("./names"):imscNames,"undefined"===typeof imscStyles?g("./styles"):imscStyles,"undefined"===typeof imscUtils?g("./utils"):imscUtils)},{"./names":5,"./styles":6,"./utils":7}],4:[function(g,r,p){p.generateISD=g("./isd").generateISD;p.fromXML=g("./doc").fromXML;p.renderHTML=g("./html").render},{"./doc":1,"./html":2,"./isd":3}],5:[function(g,r,p){g="undefined"===typeof p?this.imscNames={}:p;g.ns_tt="http://www.w3.org/ns/ttml";g.ns_tts="http://www.w3.org/ns/ttml#styling";
