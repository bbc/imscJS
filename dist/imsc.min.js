var $jscomp=$jscomp||{};$jscomp.scope={};$jscomp.owns=function(g,r){return Object.prototype.hasOwnProperty.call(g,r)};$jscomp.assign="function"==typeof Object.assign?Object.assign:function(g,r){for(var p=1;p<arguments.length;p++){var f=arguments[p];if(f)for(var A in f)$jscomp.owns(f,A)&&(g[A]=f[A])}return g};$jscomp.ASSUME_ES5=!1;$jscomp.ASSUME_NO_NATIVE_MAP=!1;$jscomp.ASSUME_NO_NATIVE_SET=!1;
$jscomp.defineProperty=$jscomp.ASSUME_ES5||"function"==typeof Object.defineProperties?Object.defineProperty:function(g,r,p){g!=Array.prototype&&g!=Object.prototype&&(g[r]=p.value)};$jscomp.getGlobal=function(g){return"undefined"!=typeof window&&window===g?g:"undefined"!=typeof global&&null!=global?global:g};$jscomp.global=$jscomp.getGlobal(this);
$jscomp.polyfill=function(g,r,p,f){if(r){p=$jscomp.global;g=g.split(".");for(f=0;f<g.length-1;f++){var A=g[f];A in p||(p[A]={});p=p[A]}g=g[g.length-1];f=p[g];r=r(f);r!=f&&null!=r&&$jscomp.defineProperty(p,g,{configurable:!0,writable:!0,value:r})}};$jscomp.polyfill("Object.assign",function(g){return g||$jscomp.assign},"es6","es3");$jscomp.polyfill("Object.entries",function(g){return g?g:function(g){var p=[],f;for(f in g)$jscomp.owns(g,f)&&p.push([f,g[f]]);return p}},"es8","es3");
...
$jscomp.checkStringArgs=function(g,r,p){if(null==g)throw new TypeError("The 'this' value for String.prototype."+p+" must not be null or undefined");if(r instanceof RegExp)throw new TypeError("First argument to String.prototype."+p+" must not be a regular expression");return g+""};$jscomp.polyfill("String.prototype.includes",function(g){return g?g:function(g,p){return-1!==$jscomp.checkStringArgs(this,g,"includes").indexOf(g,p||0)}},"es6","es3");
$jscomp.polyfill("Math.sign",function(g){return g?g:function(g){g=Number(g);return 0===g||isNaN(g)?g:0<g?1:-1}},"es6","es3");
(function(g){"object"===typeof exports&&"undefined"!==typeof module?module.exports=g():"function"===typeof define&&define.amd?define([],g):("undefined"!==typeof window?window:"undefined"!==typeof global?global:"undefined"!==typeof self?self:this).imsc=g()})(function(){return function(){function g(r,p,f){function A(l,I){if(!p[l]){if(!r[l]){var a="function"==typeof require&&require;if(!I&&a)return a(l,!0);if(n)return n(l,!0);I=Error("Cannot find module '"+l+"'");throw I.code="MODULE_NOT_FOUND",I;}I=
p[l]={exports:{}};r[l][0].call(I.exports,function(a){return A(r[l][1][a]||a)},I,I.exports,g,r,p,f)}return p[l].exports}for(var n="function"==typeof require&&require,l=0;l<f.length;l++)A(f[l]);return A}return g}()({1:[function(g,r,p){(function(g,p,n,l,r){function f(b,d){var a=b.styleAttrs&&b.styleAttrs["http://www.w3.org/ns/ttml#styling backgroundColor"];if("span"===b.kind)!a&&d&&(b.styleAttrs||(b.styleAttrs={}),b.styleAttrs["http://www.w3.org/ns/ttml#styling backgroundColor"]=d);else if(a&&delete b.styleAttrs["http://www.w3.org/ns/ttml#styling backgroundColor"],
b.contents)for(var e=0;e<b.contents.length;e++)f(b.contents[e],a||d)}function a(b){if("contents"in b){var d="styleAttrs"in b?b.styleAttrs[l.byName.ruby.qname]:null;d="span"===b.kind&&("container"===d||"textContainer"===d||"baseContainer"===d);for(var e=b.contents.length-1;0<=e;e--)!d||"styleAttrs"in b.contents[e]&&l.byName.ruby.qname in b.contents[e].styleAttrs?a(b.contents[e]):delete b.contents[e]}}function c(b,d,a,e){var m=e&&"seq"===e.timeContainer,E=0;e&&(E=m&&a?a.end:e.begin);d.begin=d.explicit_begin?
d.explicit_begin+E:E;a=d.begin;e=null;for(var h in d.sets)d.sets.hasOwnProperty(h)&&(c(b,d.sets[h],e,d),a="seq"===d.timeContainer?d.sets[h].end:Math.max(a,d.sets[h].end),e=d.sets[h]);if("contents"in d)for(var x in d.contents)d.contents.hasOwnProperty(x)&&(c(b,d.contents[x],e,d),a="seq"===d.timeContainer?d.contents[x].end:Math.max(a,d.contents[x].end),e=d.contents[x]);else a=m?d.begin:Number.POSITIVE_INFINITY;d.end=null!==d.explicit_end&&null!==d.explicit_dur?Math.min(d.begin+d.explicit_dur,E+d.explicit_end):
null===d.explicit_end&&null!==d.explicit_dur?d.begin+d.explicit_dur:null!==d.explicit_end&&null===d.explicit_dur?E+d.explicit_end:a;delete d.explicit_begin;delete d.explicit_dur;delete d.explicit_end;b._registerEvent(d)}function F(b){this.node=b}function h(){this.events=[];this.head=new M;this.body=null}function M(){this.styling=new k;this.layout=new z}function k(){this.styles={};this.initials={}}function A(){this.styleRefs=this.styleAttrs=this.id=null}function V(){this.styleAttrs=null}function z(){this.regions=
{}}function C(b,d){this.kind="image";this.src=b;this.type=d}function J(b){this.id=b}function y(b){this.regionID=b}function d(b){this.styleAttrs=b}function m(b){this.sets=b}function b(b){this.contents=b}function e(b,d,a){this.explicit_begin=b;this.explicit_end=d;this.explicit_dur=a}function v(){this.kind="body"}function Q(){this.kind="div"}function P(){this.kind="p"}function t(){this.kind="span"}function u(){this.kind="span"}function S(){this.kind="br"}function K(){}function W(){}function H(b){var d=
...
L(d,"Cannot parse styling attribute "+m+" --\x3e "+b.attributes[e].value)}}return a}function O(b,d,a){for(var e in b.attributes)if(b.attributes.hasOwnProperty(e)&&b.attributes[e].uri===d&&b.attributes[e].local===a)return b.attributes[e].value;return null}function aa(b,d){b=O(b,n.ns_tts,"extent");if(null===b)return null;var a=b.split(" ");if(2!==a.length)return N(d,"Malformed extent (ignoring)"),null;b=r.parseLength(a[0]);a=r.parseLength(a[1]);return a&&b?{h:a,w:b}:(N(d,"Malformed extent values (ignoring)"),
null)}function T(b,d,a){var e=/^(\d{2,}):(\d\d):(\d\d(?:\.\d+)?)$/,m=/^(\d{2,}):(\d\d):(\d\d):(\d{2,})$/,c=/^(\d+(?:\.\d+)?)t$/,h=/^(\d+(?:\.\d+)?)ms$/,E=/^(\d+(?:\.\d+)?)s$/,k=/^(\d+(?:\.\d+)?)h$/,n=/^(\d+(?:\.\d+)?)m$/,x,v=null;null!==(x=/^(\d+(?:\.\d+)?)f$/.exec(a))?null!==d&&(v=parseFloat(x[1])/d):null!==(x=c.exec(a))?null!==b&&(v=parseFloat(x[1])/b):null!==(x=h.exec(a))?v=parseFloat(x[1])/1E3:null!==(x=E.exec(a))?v=parseFloat(x[1]):null!==(x=k.exec(a))?v=3600*parseFloat(x[1]):null!==(x=n.exec(a))?
...
a):L(e,"Non-existant style id referenced")}}function U(b,d){for(var a in b)!b.hasOwnProperty(a)||a in d||(d[a]=b[a])}function N(b,d){if(b&&b.warn&&b.warn(d))throw d;}function L(b,d){if(b&&b.error&&b.error(d))throw d;}function D(b,d){b&&b.fatal&&b.fatal(d);throw d;}function Z(b,d){for(var a=0,e=b.length-1,m;a<=e;){m=Math.floor((a+e)/2);var c=b[m];if(c<d)a=m+1;else if(c>d)e=m-1;else return{found:!0,index:m}}return{found:!1,index:a}}g.fromXML=function(b,d,e){var m=p.parser(!0,{xmlns:!0}),q=[],g=[],E=
[],x=0,w=null;m.onclosetag=function(b){if(q[0]instanceof K)null!==w.head&&null!==w.head.styling&&Y(w.head.styling,q[0].styleRefs,q[0].styleAttrs,d),delete q[0].styleRefs;else if(q[0]instanceof k)for(var a in q[0].styles)q[0].styles.hasOwnProperty(a)&&X(q[0],q[0].styles[a],d);else if(q[0]instanceof P||q[0]instanceof t){if(1<q[0].contents.length){b=[q[0].contents[0]];for(a=1;a<q[0].contents.length;a++)q[0].contents[a]instanceof u&&b[b.length-1]instanceof u?b[b.length-1].text+=q[0].contents[a].text:
b.push(q[0].contents[a]);q[0].contents=b}q[0]instanceof t&&1===q[0].contents.length&&q[0].contents[0]instanceof u&&(q[0].text=q[0].contents[0].text,delete q[0].contents)}else if(q[0]instanceof F)if(q[0].node.uri===n.ns_tt&&"metadata"===q[0].node.local)x--;else if(0<x&&e&&"onCloseTag"in e)e.onCloseTag();E.shift();g.shift();q.shift()};m.ontext=function(b){if(void 0!==q[0])if(q[0]instanceof t||q[0]instanceof P){if(q[0]instanceof t){var a=q[0].styleAttrs[l.byName.ruby.qname];if("container"===a||"textContainer"===
a||"baseContainer"===a)return}a=new u;a.initFromText(w,q[0],b,g[0],E[0],d);q[0].contents.push(a)}else if(q[0]instanceof F&&0<x&&e&&"onText"in e)e.onText(b)};m.onopentag=function(b){function a(b){n.ttaf_map[b.uri]&&(b.uri=n.ttaf_map[b.uri])}var m=b.attributes["xml:space"];m?E.unshift(m.value):0===E.length?E.unshift("default"):E.unshift(E[0]);(m=b.attributes["xml:lang"])?g.unshift(m.value):0===g.length?g.unshift(""):g.unshift(g[0]);a(b);if(b.attributes)for(var c in b.attributes)b.attributes.hasOwnProperty(c)&&
a(b.attributes[c]);if(b.uri===n.ns_tt)if("tt"===b.local)null!==w&&D(d,"Two <tt> elements at ("+this.line+","+this.column+")"),w=new h,w.initFromNode(b,g[0],d),q.unshift(w);else if("head"===b.local)q[0]instanceof h||D(d,"Parent of <head> element is not <tt> at ("+this.line+","+this.column+")"),q.unshift(w.head);else if("styling"===b.local)q[0]instanceof M||D(d,"Parent of <styling> element is not <head> at ("+this.line+","+this.column+")"),q.unshift(w.head.styling);else if("style"===b.local)if(q[0]instanceof
k){var f=new A;f.initFromNode(b,d);f.id?w.head.styling.styles[f.id]=f:L(d,"<style> element missing @id attribute");q.unshift(f)}else q[0]instanceof K?(f=new A,f.initFromNode(b,d),U(f.styleAttrs,q[0].styleAttrs),q.unshift(f)):D(d,"Parent of <style> element is not <styling> or <region> at ("+this.line+","+this.column+")");else if("initial"===b.local)if(q[0]instanceof k){c=new V;c.initFromNode(b,d);for(f in c.styleAttrs)c.styleAttrs.hasOwnProperty(f)&&(w.head.styling.initials[f]=c.styleAttrs[f]);q.unshift(c)}else D(d,
"Parent of <initial> element is not <styling> at ("+this.line+","+this.column+")");else if("layout"===b.local)q[0]instanceof M||D(d,"Parent of <layout> element is not <head> at "+this.line+","+this.column+")"),q.unshift(w.head.layout);else if("region"===b.local)q[0]instanceof z||D(d,"Parent of <region> element is not <layout> at "+this.line+","+this.column+")"),f=new K,f.initFromNode(w,b,g[0],d),!f.id||f.id in w.head.layout.regions?L(d,"Ignoring <region> with duplicate or missing @id at "+this.line+
","+this.column+")"):w.head.layout.regions[f.id]=f,q.unshift(f);else if("body"===b.local)q[0]instanceof h||D(d,"Parent of <body> element is not <tt> at "+this.line+","+this.column+")"),null!==w.body&&D(d,"Second <body> element at "+this.line+","+this.column+")"),f=new v,f.initFromNode(w,b,g[0],d),w.body=f,q.unshift(f);else if("div"===b.local){q[0]instanceof Q||q[0]instanceof v||D(d,"Parent of <div> element is not <body> or <div> at "+this.line+","+this.column+")");f=new Q;f.initFromNode(w,q[0],b,
g[0],d);if(c=f.styleAttrs[l.byName.backgroundImage.qname])f.contents.push(new C(c)),delete f.styleAttrs[l.byName.backgroundImage.qname];q[0].contents.push(f);q.unshift(f)}else"image"===b.local?(q[0]instanceof Q||D(d,"Parent of <image> element is not <div> at "+this.line+","+this.column+")"),f=new C,f.initFromNode(w,q[0],b,g[0],d),q[0].contents.push(f),q.unshift(f)):"p"===b.local?(q[0]instanceof Q||D(d,"Parent of <p> element is not <div> at "+this.line+","+this.column+")"),f=new P,f.initFromNode(w,
q[0],b,g[0],d),q[0].contents.push(f),q.unshift(f)):"span"===b.local?(q[0]instanceof t||q[0]instanceof P||D(d,"Parent of <span> element is not <span> or <p> at "+this.line+","+this.column+")"),f=new t,f.initFromNode(w,q[0],b,g[0],E[0],d),q[0].contents.push(f),q.unshift(f)):"br"===b.local?(q[0]instanceof t||q[0]instanceof P||D(d,"Parent of <br> element is not <span> or <p> at "+this.line+","+this.column+")"),f=new S,f.initFromNode(w,q[0],b,g[0],d),q[0].contents.push(f),q.unshift(f)):"set"===b.local?
(q[0]instanceof t||q[0]instanceof P||q[0]instanceof Q||q[0]instanceof v||q[0]instanceof K||q[0]instanceof S||D(d,"Parent of <set> element is not a content element or a region at "+this.line+","+this.column+")"),f=new W,f.initFromNode(w,q[0],b,d),q[0].sets.push(f),q.unshift(f)):q.unshift(new F(b));else q.unshift(new F(b));if(q[0]instanceof F)if(b.uri===n.ns_tt&&"metadata"===b.local)x++;else if(0<x&&e&&"onOpenTag"in e){f=[];for(var u in b.attributes)b.attributes.hasOwnProperty(u)&&(f[b.attributes[u].uri+
...
null!==c&&(e=/(\d+)\s+(\d+)/.exec(c),null!==e?(c=parseInt(e[1]),e=parseInt(e[2]),0!==c&&0!==e?m=c/e:L(a,"Illegal aspectRatio values (ignoring)")):L(a,"Malformed aspectRatio attribute (ignoring)"));this.aspectRatio=m;m=O(b,n.ns_ttp,"timeBase");null!==m&&"media"!==m&&D(a,"Unsupported time base");b=aa(b,a);null===b?this.pxLength={h:null,w:null}:("px"===b.h.unit&&"px"===b.w.unit||D(a,"Extent on TT must be in px or absent"),this.pxLength={h:new r.ComputedLength(0,1/b.h.value),w:new r.ComputedLength(1/
b.w.value,0)});this.dimensions={h:new r.ComputedLength(0,1),w:new r.ComputedLength(1,0)};this.lang=d};h.prototype._registerEvent=function(b){if(!(b.end<=b.begin)){var d=Z(this.events,b.begin);d.found||this.events.splice(d.index,0,b.begin);b.end!==Number.POSITIVE_INFINITY&&(d=Z(this.events,b.end),d.found||this.events.splice(d.index,0,b.end))}};h.prototype.getMediaTimeRange=function(){return[this.events[0],this.events[this.events.length-1]]};h.prototype.getMediaTimeEvents=function(){return this.events};
...
a,c,h,k);b.prototype.initFromNode.call(this,a,c,h,k);this.lang=f};P.prototype.initFromNode=function(a,c,h,f,k){d.prototype.initFromNode.call(this,a,c,h,k);e.prototype.initFromNode.call(this,a,c,h,k);m.prototype.initFromNode.call(this,a,c,h,k);y.prototype.initFromNode.call(this,a,c,h,k);b.prototype.initFromNode.call(this,a,c,h,k);this.lang=f};t.prototype.initFromNode=function(a,c,h,f,k,v){d.prototype.initFromNode.call(this,a,c,h,v);e.prototype.initFromNode.call(this,a,c,h,v);m.prototype.initFromNode.call(this,
...
(m=B[g],e=b.styleAttrs[m.qname],void 0!==e&&null!==m.map&&m.map(d,f,b,e));g=f;(m=b.styleAttrs[n.byName.linePadding.qname])&&!m.isZero()&&(e=m.multiply(m.toUsedLength(d.w,d.h),d.options.sizeAdjust),0<e&&(e=Math.ceil(e)+"px","tb"===d.bpd?(g.style.paddingLeft=e,g.style.paddingRight=e):(g.style.paddingTop=e,g.style.paddingBottom=e),d.lp=m));(m=b.styleAttrs[n.byName.multiRowAlign.qname])&&"auto"!==m&&(g=document.createElement("span"),g.style.display="inline-block",g.style.textAlign=m,f.appendChild(g),
d.mra=m);(m=b.styleAttrs[n.byName.rubyReserve.qname])&&"none"!==m[0]&&(d.rubyReserve=m);b.styleAttrs[n.byName.fillLineGap.qname]&&(d.flg=!0);if("span"===b.kind&&b.text)if((m=b.styleAttrs[n.byName.textEmphasis.qname])&&"none"!==m.style&&(d.textEmphasis=!0),n.byName.textCombine.qname in b.styleAttrs&&"all"===b.styleAttrs[n.byName.textCombine.qname])f.textContent=b.text,m&&M(d,f,b,m);else for(e="",k=0;k<b.text.length;k++){e+=b.text.charAt(k);var t=b.text.charCodeAt(k);if(55296>t||56319<t||k===b.text.length-
1)t=document.createElement("span"),t.textContent=e,m&&M(d,t,b,m),f.appendChild(t),e="",t._isd_element=b}for(var u in b.contents)b.contents.hasOwnProperty(u)&&A(d,g,b.contents[u],b);u=[];if("p"===b.kind){h(d,g,u,null);if(d.rubyReserve){for(m=0;m<u.length;m++){e=document.createElement("ruby");k=document.createElement("rb");k.textContent="\u200b";e.appendChild(k);var l=d.rubyReserve[1].toUsedLength(d.w,d.h)+"px";"both"===d.rubyReserve[0]||"outside"===d.rubyReserve[0]&&1==u.length?(k=document.createElement("rtc"),
k.style[C]=z?"after":"under",k.textContent="\u200b",k.style.fontSize=l,t=document.createElement("rtc"),t.style[C]=z?"before":"over",t.textContent="\u200b",t.style.fontSize=l,e.appendChild(k),e.appendChild(t)):(k=document.createElement("rtc"),k.textContent="\u200b",k.style.fontSize=l,k.style[C]="after"===d.rubyReserve[0]||"outside"===d.rubyReserve[0]&&0<m?z?"after":"tb"===d.bpd||"rl"===d.bpd?"under":"over":z?"before":"tb"===d.bpd||"rl"===d.bpd?"over":"under",e.appendChild(k));k=null;for(t=0;t<u[m].rbc.length;t++)if("ruby"===
u[m].rbc[t].localName){k=u[m].rbc[t];for(t=0;t<k.style.length;t++)e.style.setProperty(k.style.item(t),k.style.getPropertyValue(k.style.item(t)));break}k=k||u[m].elements[0].node;k.parentElement.insertBefore(e,k)}d.rubyReserve=null}if(d.ruby||d.rubyReserve){for(m=0;m<u.length;m++)for(e=0;e<u[m].rbc.length;e++)u[m].rbc[e].style[C]||(u[m].rbc[e].style[C]=z?0===m?"before":"after":"tb"===d.bpd?0===m?"over":"under":"rl"===d.bpd?0===m?"over":"under":0===m?"under":"over");d.ruby=null}if(d.textEmphasis){for(m=
0;m<u.length;m++)for(e=0;e<u[m].te.length;e++)u[m].te[e].style[y]&&"none"!==u[m].te[e].style[y]||(u[m].te[e].style[y]="tb"===d.bpd?0===m?"left over":"left under":"rl"===d.bpd?0===m?"right under":"left under":0===m?"left under":"right under");d.textEmphasis=null}if(d.mra){for(m=0;m<u.length-1;m++)k=u[m].elements.length,0!==k&&!1===u[m].br&&(e=document.createElement("br"),k=u[m].elements[k-1].node,k.parentElement.insertBefore(e,k.nextSibling));d.mra=null}if(d.lp){m=d.lp.multiply(d.lp.toUsedLength(d.w,
d.h),d.options.sizeAdjust);for(e=0;e<u.length;e++)if(k=Math.ceil(m)+"px",t="-"+Math.ceil(m)+"px",0!==u[e].elements.length){l=u[e].elements[u[e].start_elem];var p=u[e].elements[u[e].end_elem];if(l===p&&(elementBoundingRect=l.node.getBoundingClientRect(),0==elementBoundingRect.width||0==elementBoundingRect.height))continue;"lr"===d.ipd?(l.node.style.marginLeft=t,l.node.style.paddingLeft=k):"rl"===d.ipd?(l.node.style.paddingRight=k,l.node.style.marginRight=t):"tb"===d.ipd&&(l.node.style.paddingTop=k,
l.node.style.marginTop=t);"lr"===d.ipd?(p.node.style.paddingRight=k,p.node.style.marginRight=t):"rl"===d.ipd?(p.node.style.paddingLeft=k,p.node.style.marginLeft=t):"tb"===d.ipd&&(p.node.style.paddingBottom=k,p.node.style.marginBottom=t)}d.lp=null}for(m=0;m<u.length;m++)for(e=u[m],k=1;k<e.elements.length;){t=e.elements[k-1].node;l=e.elements[k].node;if("SPAN"===t.tagName&&"SPAN"===l.tagName&&t._isd_element===l._isd_element){t.textContent+=l.textContent;for(p=0;p<l.style.length;p++){var r=l.style[p];
if(0<=r.indexOf("border")||0<=r.indexOf("padding")||0<=r.indexOf("margin"))t.style[r]=l.style[r]}l.parentElement.removeChild(l);t=!0}else t=!1;t?e.elements.splice(k,1):k++}m=[];for(t=0;t<u.length;t++)for(l=0;l<u[t].elements.length;l++)if(e=u[t].elements[l].node,k=a(e,m,!1))e.style.backgroundColor=k;for(e=0;e<m.length;e++)m[e].style.backgroundColor="";if(d.flg){e=F(g.getBoundingClientRect(),d);m=e.before;e=e.after;k=Math.sign(e-m);for(t=0;t<=u.length;t++){l=0===t?Math.round(m):t===u.length?Math.round(e):
Math.round((u[t-1].after+u[t].before)/2);if(0<t&&u[t-1])for(r=0;r<u[t-1].elements.length;r++){var H=u[t-1].elements[r];p=k*(l-H.after)+"px";"lr"===d.bpd?H.node.style.paddingRight=p:"rl"===d.bpd?H.node.style.paddingLeft=p:"tb"===d.bpd&&(H.node.style.paddingBottom=p)}if(t<u.length)for(r=0;r<u[t].elements.length;r++)H=u[t].elements[r],p=k*(H.before-l)+"px","lr"===d.bpd?H.node.style.paddingLeft=p:"rl"===d.bpd?H.node.style.paddingRight=p:"tb"===d.bpd&&(H.node.style.paddingTop=p)}d.flg=null}}"region"===
b.kind&&"tb"===d.bpd&&d.enableRollUp&&0<b.contents.length&&"after"===b.styleAttrs[n.byName.displayAlign.qname]&&(h(d,g,u,null),b=new c(""===b.id?"_":b.id,u),d.currentISDState[b.id]=b,d.previousISDState&&b.id in d.previousISDState&&0<d.previousISDState[b.id].plist.length&&1<b.plist.length&&b.plist[b.plist.length-2].text===d.previousISDState[b.id].plist[d.previousISDState[b.id].plist.length-1].text&&(d=f.firstElementChild,b=b.plist[b.plist.length-1].after-b.plist[b.plist.length-1].before,d.style.bottom=
"-"+b+"px",d.style.transition="transform 0.4s",d.style.position="relative",d.style.transform="translateY(-"+b+"px)"))}else if(d=d.errorHandler,b="Error processing ISD element kind: "+b.kind,d&&d.error&&d.error(b))throw b;}function a(d,c,b){if(d.style.backgroundColor)return b&&!c.includes(d)&&c.push(d),d.style.backgroundColor;if("SPAN"===d.parentElement.nodeName)return a(d.parentElement,c,!0)}function c(d,a){this.id=d;this.plist=a}function F(d,a){var b={before:null,after:null,start:null,end:null};
"tb"===a.bpd?(b.before=d.top,b.after=d.bottom,"lr"===a.ipd?(b.start=d.left,b.end=d.right):(b.start=d.right,b.end=d.left)):"lr"===a.bpd?(b.before=d.left,b.after=d.right,b.start=d.top,b.end=d.bottom):"rl"===a.bpd&&(b.before=d.right,b.after=d.left,b.start=d.top,b.end=d.bottom);return b}function h(d,a,b,e){if("rt"!==a.localName&&"rtc"!==a.localName)if(e=a.style.backgroundColor||e,0===a.childElementCount)if("span"===a.localName||"rb"===a.localName){var c=a.getBoundingClientRect();d=F(c,d);if(!(c=0===b.length)){c=
d.before;var m=d.after,k=b[b.length-1].before,f=b[b.length-1].after;c=!(m<f&&c>k||f<=m&&k>=c)}c?b.push({before:d.before,after:d.after,start:d.start,end:d.end,start_elem:0,end_elem:0,elements:[],rbc:[],te:[],text:"",br:!1}):(c=Math.sign(d.after-d.before),m=Math.sign(d.end-d.start),0>c*(d.before-b[b.length-1].before)&&(b[b.length-1].before=d.before),0<c*(d.after-b[b.length-1].after)&&(b[b.length-1].after=d.after),0>m*(d.start-b[b.length-1].start)&&(b[b.length-1].start=d.start,b[b.length-1].start_elem=
b[b.length-1].elements.length),0<m*(d.end-b[b.length-1].end)&&(b[b.length-1].end=d.end,b[b.length-1].end_elem=b[b.length-1].elements.length));b[b.length-1].text+=a.textContent;b[b.length-1].elements.push({node:a,bgcolor:e,before:d.before,after:d.after})}else"br"===a.localName&&0!==b.length&&(b[b.length-1].br=!0);else for(a=a.firstChild;a;)a.nodeType===Node.ELEMENT_NODE&&(h(d,a,b,e),"ruby"===a.localName||"rtc"===a.localName?0<b.length&&b[b.length-1].rbc.push(a):"span"===a.localName&&a.style[J]&&"none"!==
a.style[J]&&0<b.length&&b[b.length-1].te.push(a)),a=a.nextSibling}function M(d,a,b,e){"none"!==e.style&&(a.style[J]="auto"===e.style?"filled":e.style+" "+e.symbol,"before"===e.position||"after"===e.position)&&(a.style[y]="tb"===d.bpd?"before"===e.position?"left over":"left under":"rl"===d.bpd?"before"===e.position?"right under":"left under":"before"===e.position?"left under":"right under")}function k(a,c){this.qname=a;this.map=c}f.render=function(a,c,b,e,k,f,h,g,n,F){e=e||c.clientHeight;var d=k||
c.clientWidth;null!==a.aspectRatio&&(k=e*a.aspectRatio,k>d?e=Math.round(d/a.aspectRatio):d=k);k=document.createElement("div");k.style.position="relative";k.style.width=d+"px";k.style.height=e+"px";k.style.margin="auto";k.style.top=0;k.style.bottom=0;k.style.left=0;k.style.right=0;k.style.zIndex=0;b={h:e,w:d,regionH:null,regionW:null,imgResolver:b,displayForcedOnlyMode:f||!1,isd:a,errorHandler:h,previousISDState:g,enableRollUp:n||!1,currentISDState:{},flg:null,lp:null,mra:null,ipd:null,bpd:null,ruby:null,
textEmphasis:null,rubyReserve:null,options:Object.assign({},F)||{}};b.options.colorAdjust&&(b.options.colorAdjust=p(b.options.colorAdjust));f=["region","body","div","p","span"];for(var m in f)f.hasOwnProperty(m)&&(h=f[m]+"BackgroundColorAdjust",b.options[h]&&(b.options[h]=p(b.options[h])));c.appendChild(k);for(var l in a.contents)a.contents.hasOwnProperty(l)&&A(b,k,a.contents[l],a);return b.currentISDState};var B=[new k("http://www.w3.org/ns/ttml#styling backgroundColor",function(a,c,b,e){(b=(b=a.options[b.kind+
"BackgroundColorAdjust"])&&b[e.toString()])&&(e=b);b=e[3];0!==b&&(void 0!=a.options.backgroundOpacityScale&&(b*=a.options.backgroundOpacityScale),c.style.backgroundColor="rgba("+e[0].toString()+","+e[1].toString()+","+e[2].toString()+","+(b/255).toString()+")")}),new k("http://www.w3.org/ns/ttml#styling color",function(a,c,b,e){b=a.options.colorOpacityScale||1;a=a.options.colorAdjust;void 0!=a&&(a=a[e.toString()])&&(e=a);c.style.color="rgba("+e[0].toString()+","+e[1].toString()+","+e[2].toString()+
","+(b*e[3]/255).toString()+")"}),new k("http://www.w3.org/ns/ttml#styling direction",function(a,c,b,e){c.style.direction=e}),new k("http://www.w3.org/ns/ttml#styling display",function(a,c,b,e){}),new k("http://www.w3.org/ns/ttml#styling displayAlign",function(a,c,b,e){c.style.display="flex";c.style.flexDirection="column";"before"===e?c.style.justifyContent="flex-start":"center"===e?c.style.justifyContent="center":"after"===e&&(c.style.justifyContent="flex-end")}),new k("http://www.w3.org/ns/ttml#styling extent",
function(a,c,b,e){a.regionH=e.h.toUsedLength(a.w,a.h);a.regionW=e.w.toUsedLength(a.w,a.h);var d=e=0;if(b=b.styleAttrs["http://www.w3.org/ns/ttml#styling padding"])e=b[0].toUsedLength(a.w,a.h)+b[2].toUsedLength(a.w,a.h),d=b[1].toUsedLength(a.w,a.h)+b[3].toUsedLength(a.w,a.h);c.style.height=a.regionH-e+"px";c.style.width=a.regionW-d+"px"}),new k("http://www.w3.org/ns/ttml#styling fontFamily",function(a,c,b,e){b=[];a.options.fontFamily&&(e=a.options.fontFamily.split(","));for(var d in e)e[d].hasOwnProperty(d)&&
(e[d]=e[d].trim(),"monospaceSerif"===e[d]?(b.push("Courier New"),b.push('"Liberation Mono"'),b.push("Courier"),b.push("monospace")):"proportionalSansSerif"===e[d]||"default"===e[d]?(b.push("Arial"),b.push("Helvetica"),b.push('"Liberation Sans"'),b.push("sans-serif")):"monospace"===e[d]?b.push("monospace"):"sansSerif"===e[d]?b.push("sans-serif"):"serif"===e[d]?b.push("serif"):"monospaceSansSerif"===e[d]?(b.push("Consolas"),b.push("monospace")):"proportionalSerif"===e[d]?b.push("serif"):b.push(e[d]));
if(0<b.length){a=[b[0]];for(e=1;e<b.length;e++)-1==a.indexOf(b[e])&&a.push(b[e]);b=a}c.style.fontFamily=b.join(",")}),new k("http://www.w3.org/ns/ttml#styling shear",function(a,c,b,e){0!==e&&(b=-.9*e,c.style.transform="tb"===a.bpd?"skewX("+b+"deg)":"skewY("+b+"deg)")}),new k("http://www.w3.org/ns/ttml#styling fontSize",function(a,c,b,e){c.style.fontSize=e.multiply(e.toUsedLength(a.w,a.h),a.options.sizeAdjust)+"px"}),new k("http://www.w3.org/ns/ttml#styling fontStyle",function(a,c,b,e){c.style.fontStyle=
e}),new k("http://www.w3.org/ns/ttml#styling fontWeight",function(a,c,b,e){c.style.fontWeight=e}),new k("http://www.w3.org/ns/ttml#styling lineHeight",function(a,c,b,e){c.style.lineHeight="normal"===e?"normal":e.multiply(e.multiply(e.toUsedLength(a.w,a.h),a.options.sizeAdjust),a.options.lineHeightAdjust)+"px"}),new k("http://www.w3.org/ns/ttml#styling opacity",function(a,c,b,e){b=e;void 0!=a.options.regionOpacityScale&&(b*=a.options.regionOpacityScale);c.style.opacity=b}),new k("http://www.w3.org/ns/ttml#styling origin",
function(a,c,b,e){c.style.top=e.h.toUsedLength(a.w,a.h)+"px";c.style.left=e.w.toUsedLength(a.w,a.h)+"px"}),new k("http://www.w3.org/ns/ttml#styling overflow",function(a,c,b,e){c.style.overflow=e}),new k("http://www.w3.org/ns/ttml#styling padding",function(a,c,b,e){b=[];b[0]=e[0].toUsedLength(a.w,a.h)+"px";b[1]=e[3].toUsedLength(a.w,a.h)+"px";b[2]=e[2].toUsedLength(a.w,a.h)+"px";b[3]=e[1].toUsedLength(a.w,a.h)+"px";c.style.padding=b.join(" ")}),new k("http://www.w3.org/ns/ttml#styling position",function(a,
c,b,e){c.style.top=e.h.toUsedLength(a.w,a.h)+"px";c.style.left=e.w.toUsedLength(a.w,a.h)+"px"}),new k("http://www.w3.org/ns/ttml#styling rubyAlign",function(a,c,b,e){c.style.rubyAlign="spaceAround"===e?"space-around":"center"}),new k("http://www.w3.org/ns/ttml#styling rubyPosition",function(a,c,b,e){if("before"===e||"after"===e)c.parentElement.style[C]=z?e:"tb"===a.bpd?"before"===e?"over":"under":"rl"===a.bpd?"before"===e?"over":"under":"before"===e?"under":"over"}),new k("http://www.w3.org/ns/ttml#styling showBackground",
null),new k("http://www.w3.org/ns/ttml#styling textAlign",function(a,c,b,e){c.style.textAlign="start"===e?"rl"===a.ipd?"right":"left":"end"===e?"rl"===a.ipd?"left":"right":e}),new k("http://www.w3.org/ns/ttml#styling textDecoration",function(a,c,b,e){c.style.textDecoration=e.join(" ").replace("lineThrough","line-through")}),new k("http://www.w3.org/ns/ttml#styling textOutline",function(a,c,b,e){}),new k("http://www.w3.org/ns/ttml#styling textShadow",function(a,c,b,e){b=b.styleAttrs[n.byName.textOutline.qname];
var d=a.options.textOutline;if(d)if("none"===d)b=d;else{var k={};d=d.split(" ");if(0!==d.length&&2>=d.length){var f=l.parseColor(d[0]);k.color=f;null!==f&&d.shift();1===d.length&&(d=l.parseLength(d[0]))&&(k.thickness=d,b=k)}}if("none"===e&&"none"===b)c.style.textShadow="";else{k=[];"none"!==b&&(b="rgba("+b.color[0].toString()+","+b.color[1].toString()+","+b.color[2].toString()+","+(b.color[3]/255).toString()+")",k.push("1px 1px 1px "+b),k.push("-1px 1px 1px "+b),k.push("1px -1px 1px "+b),k.push("-1px -1px 1px "+
b));if("none"!==e)for(var h in e)e.hasOwnProperty(h)&&k.push(e[h].x_off.toUsedLength(a.w,a.h)+"px "+e[h].y_off.toUsedLength(a.w,a.h)+"px "+e[h].b_radius.toUsedLength(a.w,a.h)+"px rgba("+e[h].color[0].toString()+","+e[h].color[1].toString()+","+e[h].color[2].toString()+","+(e[h].color[3]/255).toString()+")");c.style.textShadow=k.join(",")}}),new k("http://www.w3.org/ns/ttml#styling textCombine",function(a,c,b,e){c.style.textCombineUpright=e}),new k("http://www.w3.org/ns/ttml#styling textEmphasis",
function(a,c,b,e){}),new k("http://www.w3.org/ns/ttml#styling unicodeBidi",function(a,c,b,e){c.style.unicodeBidi="bidiOverride"===e?"bidi-override":e}),new k("http://www.w3.org/ns/ttml#styling visibility",function(a,c,b,e){c.style.visibility=e}),new k("http://www.w3.org/ns/ttml#styling wrapOption",function(a,c,b,e){c.style.whiteSpace="wrap"===e?"preserve"===b.space?"pre-wrap":"normal":"preserve"===b.space?"pre":"noWrap"}),new k("http://www.w3.org/ns/ttml#styling writingMode",function(a,c,b,e){if("lrtb"===
e||"lr"===e)c.style.writingMode="horizontal-tb";else if("rltb"===e||"rl"===e)c.style.writingMode="horizontal-tb";else if("tblr"===e)c.style.writingMode="vertical-lr";else if("tbrl"===e||"tb"===e)c.style.writingMode="vertical-rl"}),new k("http://www.w3.org/ns/ttml#styling zIndex",function(a,c,b,e){c.style.zIndex=e}),new k("http://www.w3.org/ns/ttml/profile/imsc1#styling forcedDisplay",function(a,c,b,e){a.displayForcedOnlyMode&&!1===e&&(c.style.visibility="hidden")})],r;for(r in B)B.hasOwnProperty(r);
var z="webkitRubyPosition"in window.getComputedStyle(document.documentElement),C=z?"webkitRubyPosition":"rubyPosition",J="webkitTextEmphasisStyle"in window.getComputedStyle(document.documentElement)?"webkitTextEmphasisStyle":"textEmphasisStyle",y="webkitTextEmphasisPosition"in window.getComputedStyle(document.documentElement)?"webkitTextEmphasisPosition":"textEmphasisPosition"})("undefined"===typeof p?this.imscHTML={}:p,"undefined"===typeof imscNames?g("./names"):imscNames,"undefined"===typeof imscStyles?
g("./styles"):imscStyles,"undefined"===typeof imscUtils?g("./utils"):imscUtils)},{"./names":5,"./styles":6,"./utils":7}],3:[function(g,r,p){(function(f,g,n,l){function p(k,f,g,F,r,J,y,d,m){if(f<y.begin||f>=y.end)return null;J="regionID"in y&&""!==y.regionID?y.regionID:J;if(null!==r&&J!==g.id&&(!("contents"in y)||"contents"in y&&0===y.contents.length||""!==J))return null;var b=new h(y);for(e in y.sets)!y.sets.hasOwnProperty(e)||f<y.sets[e].begin||f>=y.sets[e].end||(b.styleAttrs[y.sets[e].qname]=y.sets[e].value);
var e={};for(var v in b.styleAttrs)if(b.styleAttrs.hasOwnProperty(v)&&(e[v]=!0,"region"===b.kind&&v===n.byName.writingMode.qname&&!(n.byName.direction.qname in b.styleAttrs))){var B=b.styleAttrs[v];if("lrtb"===B||"lr"===B)b.styleAttrs[n.byName.direction.qname]="ltr";else if("rltb"===B||"rl"===B)b.styleAttrs[n.byName.direction.qname]="rtl"}if(null!==r)for(var z in n.all)if(n.all.hasOwnProperty(z))if(v=n.all[z],v.qname===n.byName.textDecoration.qname){B=r.styleAttrs[v.qname];var t=b.styleAttrs[v.qname],
u=[];void 0===t?u=B:-1===t.indexOf("none")?((-1===t.indexOf("noUnderline")&&-1!==B.indexOf("underline")||-1!==t.indexOf("underline"))&&u.push("underline"),(-1===t.indexOf("noLineThrough")&&-1!==B.indexOf("lineThrough")||-1!==t.indexOf("lineThrough"))&&u.push("lineThrough"),(-1===t.indexOf("noOverline")&&-1!==B.indexOf("overline")||-1!==t.indexOf("overline"))&&u.push("overline")):u.push("none");b.styleAttrs[v.qname]=u}else v.qname!==n.byName.fontSize.qname||v.qname in b.styleAttrs||"span"!==b.kind||
"textContainer"!==b.styleAttrs[n.byName.ruby.qname]?v.qname!==n.byName.fontSize.qname||v.qname in b.styleAttrs||"span"!==b.kind||"text"!==b.styleAttrs[n.byName.ruby.qname]?v.inherit&&v.qname in r.styleAttrs&&!(v.qname in b.styleAttrs)&&(b.styleAttrs[v.qname]=r.styleAttrs[v.qname]):(B=r.styleAttrs[n.byName.fontSize.qname],b.styleAttrs[v.qname]="textContainer"===r.styleAttrs[n.byName.ruby.qname]?B:new l.ComputedLength(.5*B.rw,.5*B.rh)):(B=r.styleAttrs[n.byName.fontSize.qname],b.styleAttrs[v.qname]=
new l.ComputedLength(.5*B.rw,.5*B.rh));for(var C in n.all)if(n.all.hasOwnProperty(C)&&(z=n.all[C],!(z.qname in b.styleAttrs||z.qname===n.byName.position.qname&&n.byName.origin.qname in b.styleAttrs||z.qname===n.byName.origin.qname&&n.byName.position.qname in b.styleAttrs)&&(v=k.head.styling.initials[z.qname]||z.initial,null!==v&&("region"===b.kind||!1===z.inherit&&null!==v))))if(v=z.parse(v),null!==v)b.styleAttrs[z.qname]=v,e[z.qname]=!0;else if(z="Invalid initial value for '"+z.qname+"' on element '"+
b.kind,d&&d.error&&d.error(z))throw z;for(var K in n.all)if(n.all.hasOwnProperty(K)&&(C=n.all[K],C.qname in e&&null!==C.compute))if(z=C.compute(k,r,b,b.styleAttrs[C.qname],m),null!==z)b.styleAttrs[C.qname]=z;else if(b.styleAttrs[C.qname]=C.compute(k,r,b,C.parse(C.initial),m),C="Style '"+C.qname+"' on element '"+b.kind+"' cannot be computed",d&&d.error&&d.error(C))throw C;if("none"===b.styleAttrs[n.byName.display.qname])return null;if(null===r)var I=null===F?[]:[F];else"contents"in y&&(I=y.contents);
for(var H in I)I.hasOwnProperty(H)&&(r=p(k,f,g,F,b,J,I[H],d,m),null!==r&&b.contents.push(r.element));for(var G in b.styleAttrs)b.styleAttrs.hasOwnProperty(G)&&(k=!1,"span"===b.kind&&(f=b.styleAttrs[n.byName.ruby.qname],(k=("container"===f||"textContainer"===f||"baseContainer"===f)&&-1!==M.indexOf(G))||(k="container"!==f&&G===n.byName.rubyAlign.qname),k||(k=!("textContainer"===f||"text"===f)&&G===n.byName.rubyPosition.qname)),k||(k=-1===n.byQName[G].applies.indexOf(b.kind)),k&&delete b.styleAttrs[G]);
G=b.styleAttrs[n.byName.ruby.qname];if("p"===b.kind||"span"===b.kind&&("textContainer"===G||"text"===G))G=[],a(b,G),A(G),c(b);return"div"===b.kind&&n.byName.backgroundImage.qname in b.styleAttrs||"br"===b.kind||"image"===b.kind||"contents"in b&&0<b.contents.length||"span"===b.kind&&null!==b.text||"region"===b.kind&&"always"===b.styleAttrs[n.byName.showBackground.qname]?{region_id:J,element:b}:null}function A(a){function c(a){return"br"===a.kind||/[\r\n\t ]$/.test(a.text)}function k(a){return"br"===
a.kind||"preserve"===a.space&&/^[\r\n]/.test(a.text)}for(var f,h=0;h<a.length;)if(f=a[h],"br"===f.kind||"preserve"===f.space)h++;else{var g=f.text.replace(/[\t\r\n ]+/g," ");/^[ ]/.test(g)&&(0===h||c(a[h-1]))&&(g=g.substring(1));f.text=g;0===g.length?a.splice(h,1):h++}for(h=0;h<a.length;h++)f=a[h],"br"===f.kind||"preserve"===f.space?h++:/[ ]$/.test(f.text)&&(h===a.length-1||k(a[h+1]))&&(f.text=f.text.slice(0,-1))}function a(c,f){for(var k in c.contents)if(c.contents.hasOwnProperty(k)){var h=c.contents[k],
g=h.styleAttrs[n.byName.ruby.qname];if("span"!==h.kind||"textContainer"!==g&&"text"!==g)"contents"in h?a(h,f):("span"===h.kind&&0!==h.text.length||"br"===h.kind)&&f.push(h)}}function c(a){if("br"===a.kind)return!1;if("text"in a)return 0===a.text.length;if("contents"in a){for(var f=a.contents.length;f--;)c(a.contents[f])&&a.contents.splice(f,1);return 0===a.contents.length}}function F(a){this.contents=[];this.aspectRatio=a.aspectRatio;this.lang=a.lang}function h(a){this.kind=a.kind||"region";this.lang=
a.lang;a.id&&(this.id=a.id);this.styleAttrs={};for(var c in a.styleAttrs)a.styleAttrs.hasOwnProperty(c)&&(this.styleAttrs[c]=a.styleAttrs[c]);"src"in a&&(this.src=a.src);"type"in a&&(this.type=a.type);if("text"in a)this.text=a.text;else if("region"===this.kind||"contents"in a)this.contents=[];"space"in a&&(this.space=a.space)}f.generateISD=function(a,c,f){function h(a,b){function c(b){return!(a<b.begin||a>=b.end)}if(b.contents){var e={},f;for(f in b)b.hasOwnProperty(f)&&(e[f]=b[f]);e.contents=[];
b.contents.filter(c).forEach(function(b){b=h(a,b);b.regionID&&(d[b.regionID]=!0);null!==b&&e.contents.push(b)});return e}return b}var k=new F(a),g={},l={},d={};l=a.head.styling.initials[n.byName.showBackground.qname];var m=a.head.styling.initials[n.byName.backgroundColor.qname];for(A in a.head.layout.regions)if(a.head.layout.regions.hasOwnProperty(A)){var b=a.head.layout.regions[A],e=b.styleAttrs[n.byName.showBackground.qname]||l,M=b.styleAttrs[n.byName.backgroundColor.qname]||m;d[b.id]=("always"===
e||void 0===e)&&void 0!==M&&!(c<b.begin||c>=b.end)}a.body&&a.body.regionID&&(d[a.body.regionID]=!0);l=null!==a.body?h(c,a.body):null;void 0!==d[""]&&(d[""]=!0);for(var r in d)if(d[r]){var A=p(a,c,a.head.layout.regions[r],l,null,"",a.head.layout.regions[r],f,g);null!==A&&k.contents.push(A.element)}return k};var M=[n.byName.color.qname,n.byName.textCombine.qname,n.byName.textDecoration.qname,n.byName.textEmphasis.qname,n.byName.textOutline.qname,n.byName.textShadow.qname]})("undefined"===typeof p?this.imscISD=
{}:p,"undefined"===typeof imscNames?g("./names"):imscNames,"undefined"===typeof imscStyles?g("./styles"):imscStyles,"undefined"===typeof imscUtils?g("./utils"):imscUtils)},{"./names":5,"./styles":6,"./utils":7}],4:[function(g,r,p){p.generateISD=g("./isd").generateISD;p.fromXML=g("./doc").fromXML;p.renderHTML=g("./html").render},{"./doc":1,"./html":2,"./isd":3}],5:[function(g,r,p){g="undefined"===typeof p?this.imscNames={}:p;g.ns_tt="http://www.w3.org/ns/ttml";g.ns_tts="http://www.w3.org/ns/ttml#styling";
g.ns_ttp="http://www.w3.org/ns/ttml#parameter";g.ns_xml="http://www.w3.org/XML/1998/namespace";g.ns_itts="http://www.w3.org/ns/ttml/profile/imsc1#styling";g.ns_ittp="http://www.w3.org/ns/ttml/profile/imsc1#parameter";g.ns_smpte="http://www.smpte-ra.org/schemas/2052-1/2010/smpte-tt";g.ns_ebutts="urn:ebu:tt:style";g.ttaf_map={"http://www.w3.org/2006/10/ttaf1":g.ns_tt,"http://www.w3.org/2006/10/ttaf1#style":g.ns_tts,"http://www.w3.org/2006/10/ttaf1#parameter":g.ns_ttp}},{}],6:[function(g,r,p){(function(f,
...
"false",["body","div","p","region","span"],!0,!0,function(a){return"true"===a?!0:!1},null),new l(g.ns_itts,"fillLineGap","true",["p"],!0,!0,function(a){return"true"===a?!0:!1},null)];f.byQName={};for(var p in f.all)f.all.hasOwnProperty(p)&&(f.byQName[f.all[p].qname]=f.all[p]);f.byName={};for(var r in f.all)f.all.hasOwnProperty(r)&&(f.byName[f.all[r].name]=f.all[r])})("undefined"===typeof p?this.imscStyles={}:p,"undefined"===typeof imscNames?g("./names"):imscNames,"undefined"===typeof imscUtils?g("./utils"):
imscUtils)},{"./names":5,"./utils":7}],7:[function(g,r,p){(function(f){var g=/#([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})?/,n=/rgb\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*\)/,l=/rgba\(\s*(\d+),\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*\)/,p={transparent:[0,0,0,0],black:[0,0,0,255],silver:[192,192,192,255],gray:[128,128,128,255],white:[255,255,255,255],maroon:[128,0,0,255],red:[255,0,0,255],purple:[128,0,128,255],fuchsia:[255,0,255,255],magenta:[255,0,255,255],green:[0,128,0,255],lime:[0,
...
return f};var r=/^((?:\+|\-)?\d*(?:\.\d+)?)(px|em|c|%|rh|rw)$/;f.parseLength=function(a){var c,f=null;null!==(c=r.exec(a))&&(f={value:parseFloat(c[1]),unit:c[2]});return f};f.parseTextShadow=function(a){a=a.split(",");for(var c=[],g=0;g<a.length;g++){var h=a[g].split(" ");if(1===h.length&&"none"===h[0])return"none";if(1<h.length&&5>h.length){var l=[null,null,null,null],k=f.parseLength(h.shift());if(null===k)return null;l[0]=k;k=f.parseLength(h.shift());if(null===k)return null;l[1]=k;if(0!==h.length&&
