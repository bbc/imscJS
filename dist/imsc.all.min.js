...
(function(c){"object"===typeof exports&&"undefined"!==typeof module?module.exports=c():"function"===typeof define&&define.amd?define([],c):("undefined"!==typeof window?window:"undefined"!==typeof global?global:"undefined"!==typeof self?self:this).imsc=c()})(function(){return function(){function c(p,l,b){function h(r,E){if(!l[r]){if(!p[r]){var a="function"==typeof require&&require;if(!E&&a)return a(r,!0);if(m)return m(r,!0);E=Error("Cannot find module '"+r+"'");throw E.code="MODULE_NOT_FOUND",E;}E=
l[r]={exports:{}};p[r][0].call(E.exports,function(a){return h(p[r][1][a]||a)},E,E.exports,c,p,l,b)}return l[r].exports}for(var m="function"==typeof require&&require,r=0;r<b.length;r++)h(b[r]);return h}return c}()({1:[function(c,p,l){function b(b){var a=b.length;if(0<a%4)throw Error("Invalid string. Length must be a multiple of 4");b=b.indexOf("=");-1===b&&(b=a);return[b,b===a?0:4-b%4]}function h(b,a,h){for(var c=[],w=a;w<h;w+=3)a=(b[w]<<16&16711680)+(b[w+1]<<8&65280)+(b[w+2]&255),c.push(m[a>>18&63]+
m[a>>12&63]+m[a>>6&63]+m[a&63]);return c.join("")}l.byteLength=function(h){h=b(h);var a=h[1];return 3*(h[0]+a)/4-a};l.toByteArray=function(h){var a=b(h);var c=a[0];a=a[1];var m=new v(3*(c+a)/4-a),y=0,q=0<a?c-4:c,x;for(x=0;x<q;x+=4)c=r[h.charCodeAt(x)]<<18|r[h.charCodeAt(x+1)]<<12|r[h.charCodeAt(x+2)]<<6|r[h.charCodeAt(x+3)],m[y++]=c>>16&255,m[y++]=c>>8&255,m[y++]=c&255;2===a&&(c=r[h.charCodeAt(x)]<<2|r[h.charCodeAt(x+1)]>>4,m[y++]=c&255);1===a&&(c=r[h.charCodeAt(x)]<<10|r[h.charCodeAt(x+1)]<<4|r[h.charCodeAt(x+
2)]>>2,m[y++]=c>>8&255,m[y++]=c&255);return m};l.fromByteArray=function(b){for(var a=b.length,c=a%3,B=[],y=0,r=a-c;y<r;y+=16383)B.push(h(b,y,y+16383>r?r:y+16383));1===c?(b=b[a-1],B.push(m[b>>2]+m[b<<4&63]+"==")):2===c&&(b=(b[a-2]<<8)+b[a-1],B.push(m[b>>10]+m[b>>4&63]+m[b<<2&63]+"="));return B.join("")};var m=[],r=[],v="undefined"!==typeof Uint8Array?Uint8Array:Array;for(c=0;64>c;++c)m[c]="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/"[c],r["ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charCodeAt(c)]=
...
typeof k);}function r(k){if("number"!==typeof k)throw new TypeError('"size" argument must be of type number');if(0>k)throw new RangeError('The value "'+k+'" is invalid for option "size"');}function v(k){r(k);return h(0>k?0:w(k)|0)}function E(k){for(var t=0>k.length?0:w(k.length)|0,e=h(t),g=0;g<t;g+=1)e[g]=k[g]&255;return e}function a(k){if(b.isBuffer(k)){var t=w(k.length)|0,e=h(t);if(0===e.length)return e;k.copy(e,0,0,t);return e}if(void 0!==k.length)return(t="number"!==typeof k.length)||(t=k.length,
t=t!==t),t?h(0):E(k);if("Buffer"===k.type&&Array.isArray(k.data))return E(k.data)}function w(k){if(2147483647<=k)throw new RangeError("Attempt to allocate Buffer larger than maximum size: 0x"+(2147483647).toString(16)+" bytes");return k|0}function B(k,t){if(b.isBuffer(k))return k.length;if(ArrayBuffer.isView(k)||J(k,ArrayBuffer))return k.byteLength;if("string"!==typeof k)throw new TypeError('The "string" argument must be one of type string, Buffer, or ArrayBuffer. Received type '+typeof k);var e=
k.length,g=2<arguments.length&&!0===arguments[2];if(!g&&0===e)return 0;for(var a=!1;;)switch(t){case "ascii":case "latin1":case "binary":return e;case "utf8":case "utf-8":return f(k).length;case "ucs2":case "ucs-2":case "utf16le":case "utf-16le":return 2*e;case "hex":return e>>>1;case "base64":return L.toByteArray(n(k)).length;default:if(a)return g?-1:f(k).length;t=(""+t).toLowerCase();a=!0}}function y(k,t,e){var g=!1;if(void 0===t||0>t)t=0;if(t>this.length)return"";if(void 0===e||e>this.length)e=
this.length;if(0>=e)return"";e>>>=0;t>>>=0;if(e<=t)return"";for(k||(k="utf8");;)switch(k){case "hex":k=t;t=e;e=this.length;if(!k||0>k)k=0;if(!t||0>t||t>e)t=e;g="";for(e=k;e<t;++e)k=g,g=this[e],g=16>g?"0"+g.toString(16):g.toString(16),g=k+g;return g;case "utf8":case "utf-8":return G(this,t,e);case "ascii":k="";for(e=Math.min(this.length,e);t<e;++t)k+=String.fromCharCode(this[t]&127);return k;case "latin1":case "binary":k="";for(e=Math.min(this.length,e);t<e;++t)k+=String.fromCharCode(this[t]);return k;
case "base64":return t=0===t&&e===this.length?L.fromByteArray(this):L.fromByteArray(this.slice(t,e)),t;case "ucs2":case "ucs-2":case "utf16le":case "utf-16le":t=this.slice(t,e);e="";for(k=0;k<t.length;k+=2)e+=String.fromCharCode(t[k]+256*t[k+1]);return e;default:if(g)throw new TypeError("Unknown encoding: "+k);k=(k+"").toLowerCase();g=!0}}function q(k,t,e){var g=k[t];k[t]=k[e];k[e]=g}function x(k,t,e,g,a){if(0===k.length)return-1;"string"===typeof e?(g=e,e=0):2147483647<e?e=2147483647:-2147483648>
...
65536,g.push(d>>>10&1023|55296),d=56320|d&1023);g.push(d);t+=b}k=g.length;if(k<=C)g=String.fromCharCode.apply(String,g);else{e="";for(t=0;t<k;)e+=String.fromCharCode.apply(String,g.slice(t,t+=C));g=e}return g}function A(k,a,e){if(0!==k%1||0>k)throw new RangeError("offset is not uint");if(k+a>e)throw new RangeError("Trying to access beyond buffer length");}function D(k,a,e,g,d,n){if(!b.isBuffer(k))throw new TypeError('"buffer" argument must be a Buffer instance');if(a>d||a<n)throw new RangeError('"value" argument is out of bounds');
if(e+g>k.length)throw new RangeError("Index out of range");}function H(k,a,e,g,d,b){if(e+g>k.length)throw new RangeError("Index out of range");if(0>e)throw new RangeError("Index out of range");}function d(k,a,e,g,d){a=+a;e>>>=0;d||H(k,a,e,4,3.4028234663852886E38,-3.4028234663852886E38);I.write(k,a,e,g,23,4);return e+4}function u(k,a,e,g,d){a=+a;e>>>=0;d||H(k,a,e,8,1.7976931348623157E308,-1.7976931348623157E308);I.write(k,a,e,g,52,8);return e+8}function n(k){k=k.split("=")[0];k=k.trim().replace(N,
...
t.push(e>>6|192,e&63|128)}else if(65536>e){if(0>(a-=3))break;t.push(e>>12|224,e>>6&63|128,e&63|128)}else if(1114112>e){if(0>(a-=4))break;t.push(e>>18|240,e>>12&63|128,e>>6&63|128,e&63|128)}else throw Error("Invalid code point");}return t}function z(k){for(var a=[],e=0;e<k.length;++e)a.push(k.charCodeAt(e)&255);return a}function K(k,a,e,g){for(var d=0;d<g&&!(d+e>=a.length||d>=k.length);++d)a[d+e]=k[d];return d}function J(k,a){return k instanceof a||null!=k&&null!=k.constructor&&null!=k.constructor.name&&
k.constructor.name===a.name}var L=c("base64-js"),I=c("ieee754");l.Buffer=b;l.SlowBuffer=function(k){+k!=k&&(k=0);return b.alloc(+k)};l.INSPECT_MAX_BYTES=50;l.kMaxLength=2147483647;b.TYPED_ARRAY_SUPPORT=function(){try{var k=new Uint8Array(1);k.__proto__={__proto__:Uint8Array.prototype,foo:function(){return 42}};return 42===k.foo()}catch(t){return!1}}();b.TYPED_ARRAY_SUPPORT||"undefined"===typeof console||"function"!==typeof console.error||console.error("This browser lacks typed array (Uint8Array) support which is required by `buffer` v5.x. Use `buffer` v4.x if you require old browser support.");
...
b.__proto__=Uint8Array;b.alloc=function(k,a,e){r(k);k=0>=k?h(k):void 0!==a?"string"===typeof e?h(k).fill(a,e):h(k).fill(a):h(k);return k};b.allocUnsafe=function(k){return v(k)};b.allocUnsafeSlow=function(k){return v(k)};b.isBuffer=function(k){return null!=k&&!0===k._isBuffer&&k!==b.prototype};b.compare=function(k,a){J(k,Uint8Array)&&(k=b.from(k,k.offset,k.byteLength));J(a,Uint8Array)&&(a=b.from(a,a.offset,a.byteLength));if(!b.isBuffer(k)||!b.isBuffer(a))throw new TypeError('The "buf1", "buf2" arguments must be one of type Buffer or Uint8Array');
...
32768?a|4294901760:a};b.prototype.readInt32LE=function(a,d){a>>>=0;d||A(a,4,this.length);return this[a]|this[a+1]<<8|this[a+2]<<16|this[a+3]<<24};b.prototype.readInt32BE=function(a,d){a>>>=0;d||A(a,4,this.length);return this[a]<<24|this[a+1]<<16|this[a+2]<<8|this[a+3]};b.prototype.readFloatLE=function(a,d){a>>>=0;d||A(a,4,this.length);return I.read(this,a,!0,23,4)};b.prototype.readFloatBE=function(a,d){a>>>=0;d||A(a,4,this.length);return I.read(this,a,!1,23,4)};b.prototype.readDoubleLE=function(a,
d){a>>>=0;d||A(a,8,this.length);return I.read(this,a,!0,52,8)};b.prototype.readDoubleBE=function(a,d){a>>>=0;d||A(a,8,this.length);return I.read(this,a,!1,52,8)};b.prototype.writeUIntLE=function(a,d,e,g){a=+a;d>>>=0;e>>>=0;g||D(this,a,d,e,Math.pow(2,8*e)-1,0);g=1;var k=0;for(this[d]=a&255;++k<e&&(g*=256);)this[d+k]=a/g&255;return d+e};b.prototype.writeUIntBE=function(a,d,e,g){a=+a;d>>>=0;e>>>=0;g||D(this,a,d,e,Math.pow(2,8*e)-1,0);g=e-1;var k=1;for(this[d+g]=a&255;0<=--g&&(k*=256);)this[d+g]=a/k&
255;return d+e};b.prototype.writeUInt8=function(a,d,e){a=+a;d>>>=0;e||D(this,a,d,1,255,0);this[d]=a&255;return d+1};b.prototype.writeUInt16LE=function(a,d,e){a=+a;d>>>=0;e||D(this,a,d,2,65535,0);this[d]=a&255;this[d+1]=a>>>8;return d+2};b.prototype.writeUInt16BE=function(a,d,e){a=+a;d>>>=0;e||D(this,a,d,2,65535,0);this[d]=a>>>8;this[d+1]=a&255;return d+2};b.prototype.writeUInt32LE=function(a,d,e){a=+a;d>>>=0;e||D(this,a,d,4,4294967295,0);this[d+3]=a>>>24;this[d+2]=a>>>16;this[d+1]=a>>>8;this[d]=a&
255;return d+4};b.prototype.writeUInt32BE=function(a,d,e){a=+a;d>>>=0;e||D(this,a,d,4,4294967295,0);this[d]=a>>>24;this[d+1]=a>>>16;this[d+2]=a>>>8;this[d+3]=a&255;return d+4};b.prototype.writeIntLE=function(a,d,e,g){a=+a;d>>>=0;g||(g=Math.pow(2,8*e-1),D(this,a,d,e,g-1,-g));g=0;var k=1,b=0;for(this[d]=a&255;++g<e&&(k*=256);)0>a&&0===b&&0!==this[d+g-1]&&(b=1),this[d+g]=(a/k>>0)-b&255;return d+e};b.prototype.writeIntBE=function(a,d,e,g){a=+a;d>>>=0;g||(g=Math.pow(2,8*e-1),D(this,a,d,e,g-1,-g));g=e-
1;var k=1,b=0;for(this[d+g]=a&255;0<=--g&&(k*=256);)0>a&&0===b&&0!==this[d+g+1]&&(b=1),this[d+g]=(a/k>>0)-b&255;return d+e};b.prototype.writeInt8=function(a,d,e){a=+a;d>>>=0;e||D(this,a,d,1,127,-128);0>a&&(a=255+a+1);this[d]=a&255;return d+1};b.prototype.writeInt16LE=function(a,d,e){a=+a;d>>>=0;e||D(this,a,d,2,32767,-32768);this[d]=a&255;this[d+1]=a>>>8;return d+2};b.prototype.writeInt16BE=function(a,d,e){a=+a;d>>>=0;e||D(this,a,d,2,32767,-32768);this[d]=a>>>8;this[d+1]=a&255;return d+2};b.prototype.writeInt32LE=
function(a,d,e){a=+a;d>>>=0;e||D(this,a,d,4,2147483647,-2147483648);this[d]=a&255;this[d+1]=a>>>8;this[d+2]=a>>>16;this[d+3]=a>>>24;return d+4};b.prototype.writeInt32BE=function(a,d,e){a=+a;d>>>=0;e||D(this,a,d,4,2147483647,-2147483648);0>a&&(a=4294967295+a+1);this[d]=a>>>24;this[d+1]=a>>>16;this[d+2]=a>>>8;this[d+3]=a&255;return d+4};b.prototype.writeFloatLE=function(a,b,e){return d(this,a,b,!0,e)};b.prototype.writeFloatBE=function(a,b,e){return d(this,a,b,!1,e)};b.prototype.writeDoubleLE=function(a,
...
arguments[1],arguments[2]);default:for(var a=Array(arguments.length),b=0;b<a.length;++b)a[b]=arguments[b];this.listener.apply(this.target,a)}}function r(a,b,d){a={fired:!1,wrapFn:void 0,target:a,type:b,listener:d};b=F.call(m,a);b.listener=d;return a.wrapFn=b}function v(b,c,d){b=b._events;if(!b)return[];c=b[c];if(!c)return[];if("function"===typeof c)return d?[c.listener||c]:[c];if(d)for(d=Array(c.length),b=0;b<d.length;++b)d[b]=c[b].listener||c[b];else d=a(c,c.length);return d}function E(a){var b=
this._events;if(b){a=b[a];if("function"===typeof a)return 1;if(a)return a.length}return 0}function a(a,b){for(var d=Array(b),c=0;c<b;++c)d[c]=a[c];return d}function w(a){var b=function(){};b.prototype=a;return new b}function B(a){var b=[],d;for(d in a)Object.prototype.hasOwnProperty.call(a,d)&&b.push(d);return d}function y(a){var b=this;return function(){return b.apply(a,arguments)}}var q=Object.create||w,x=Object.keys||B,F=Function.prototype.bind||y;p.exports=b;b.EventEmitter=b;b.prototype._events=
void 0;b.prototype._maxListeners=void 0;var G=10;try{c={};Object.defineProperty&&Object.defineProperty(c,"x",{value:0});var A=0===c.x}catch(D){A=!1}A?Object.defineProperty(b,"defaultMaxListeners",{enumerable:!0,get:function(){return G},set:function(a){if("number"!==typeof a||0>a||a!==a)throw new TypeError('"defaultMaxListeners" must be a positive number');G=a}}):b.defaultMaxListeners=G;b.prototype.setMaxListeners=function(a){if("number"!==typeof a||0>a||isNaN(a))throw new TypeError('"n" argument must be a positive number');
...
this.prependListener(a,r(this,a,b));return this};b.prototype.removeListener=function(a,b){var d;if("function"!==typeof b)throw new TypeError('"listener" argument must be a function');var c=this._events;if(!c)return this;var n=c[a];if(!n)return this;if(n===b||n.listener===b)0===--this._eventsCount?this._events=q(null):(delete c[a],c.removeListener&&this.emit("removeListener",a,n.listener||b));else if("function"!==typeof n){var f=-1;for(d=n.length-1;0<=d;d--)if(n[d]===b||n[d].listener===b){var m=n[d].listener;
f=d;break}if(0>f)return this;if(0===f)n.shift();else{d=f+1;for(var h=n.length;d<h;f+=1,d+=1)n[f]=n[d];n.pop()}1===n.length&&(c[a]=n[0]);c.removeListener&&this.emit("removeListener",a,m||b)}return this};b.prototype.removeAllListeners=function(a){var b=this._events;if(!b)return this;if(!b.removeListener)return 0===arguments.length?(this._events=q(null),this._eventsCount=0):b[a]&&(0===--this._eventsCount?this._events=q(null):delete b[a]),this;if(0===arguments.length){var d=x(b);for(b=0;b<d.length;++b){var c=
d[b];"removeListener"!==c&&this.removeAllListeners(c)}this.removeAllListeners("removeListener");this._events=q(null);this._eventsCount=0;return this}d=b[a];if("function"===typeof d)this.removeListener(a,d);else if(d)for(b=d.length-1;0<=b;b--)this.removeListener(a,d[b]);return this};b.prototype.listeners=function(a){return v(this,a,!0)};b.prototype.rawListeners=function(a){return v(this,a,!1)};b.listenerCount=function(a,b){return"function"===typeof a.listenerCount?a.listenerCount(b):E.call(a,b)};b.prototype.listenerCount=
E;b.prototype.eventNames=function(){return 0<this._eventsCount?Reflect.ownKeys(this._events):[]}},{}],6:[function(c,p,l){l.read=function(b,c,m,r,v){var h=8*v-r-1;var a=(1<<h)-1,w=a>>1,B=-7;v=m?v-1:0;var y=m?-1:1,q=b[c+v];v+=y;m=q&(1<<-B)-1;q>>=-B;for(B+=h;0<B;m=256*m+b[c+v],v+=y,B-=8);h=m&(1<<-B)-1;m>>=-B;for(B+=r;0<B;h=256*h+b[c+v],v+=y,B-=8);if(0===m)m=1-w;else{if(m===a)return h?NaN:Infinity*(q?-1:1);h+=Math.pow(2,r);m-=w}return(q?-1:1)*h*Math.pow(2,m-r)};l.write=function(b,c,m,r,v,l){var a,w=8*
l-v-1,h=(1<<w)-1,y=h>>1,q=23===v?Math.pow(2,-24)-Math.pow(2,-77):0;l=r?0:l-1;var x=r?1:-1,E=0>c||0===c&&0>1/c?1:0;c=Math.abs(c);isNaN(c)||Infinity===c?(c=isNaN(c)?1:0,r=h):(r=Math.floor(Math.log(c)/Math.LN2),1>c*(a=Math.pow(2,-r))&&(r--,a*=2),c=1<=r+y?c+q/a:c+q*Math.pow(2,1-y),2<=c*a&&(r++,a/=2),r+y>=h?(c=0,r=h):1<=r+y?(c=(c*a-1)*Math.pow(2,v),r+=y):(c=c*Math.pow(2,y-1)*Math.pow(2,v),r=0));for(;8<=v;b[m+l]=c&255,l+=x,c/=256,v-=8);r=r<<v|c;for(w+=v;0<w;b[m+l]=r&255,l+=x,r/=256,w-=8);b[m+l-x]|=128*
E}},{}],7:[function(c,p,l){p.exports="function"===typeof Object.create?function(b,c){c&&(b.super_=c,b.prototype=Object.create(c.prototype,{constructor:{value:b,enumerable:!1,writable:!0,configurable:!0}}))}:function(b,c){if(c){b.super_=c;var m=function(){};m.prototype=c.prototype;b.prototype=new m;b.prototype.constructor=b}}},{}],8:[function(c,p,l){function b(b){return!!b.constructor&&"function"===typeof b.constructor.isBuffer&&b.constructor.isBuffer(b)}p.exports=function(c){return null!=c&&(b(c)||
...
}function m(a){if(B===setTimeout)return setTimeout(a,0);if((B===b||!B)&&setTimeout)return B=setTimeout,setTimeout(a,0);try{return B(a,0)}catch(D){try{return B.call(null,a,0)}catch(H){return B.call(this,a,0)}}}function r(a){if(y===clearTimeout)return clearTimeout(a);if((y===h||!y)&&clearTimeout)return y=clearTimeout,clearTimeout(a);try{return y(a)}catch(D){try{return y.call(null,a)}catch(H){return y.call(this,a)}}}function v(){x&&F&&(x=!1,F.length?q=F.concat(q):G=-1,q.length&&E())}function E(){if(!x){var a=
m(v);x=!0;for(var b=q.length;b;){F=q;for(q=[];++G<b;)F&&F[G].run();G=-1;b=q.length}F=null;x=!1;r(a)}}function a(a,b){this.fun=a;this.array=b}function w(){}c=p.exports={};try{var B="function"===typeof setTimeout?setTimeout:b}catch(A){B=b}try{var y="function"===typeof clearTimeout?clearTimeout:h}catch(A){y=h}var q=[],x=!1,F,G=-1;c.nextTick=function(b){var c=Array(arguments.length-1);if(1<arguments.length)for(var w=1;w<arguments.length;w++)c[w-1]=arguments[w];q.push(new a(b,c));1!==q.length||x||m(E)};
...
{}],12:[function(c,p,l){p.exports=c("./lib/_stream_duplex.js")},{"./lib/_stream_duplex.js":13}],13:[function(c,p,l){function b(a){if(!(this instanceof b))return new b(a);v.call(this,a);E.call(this,a);a&&!1===a.readable&&(this.readable=!1);a&&!1===a.writable&&(this.writable=!1);this.allowHalfOpen=!0;a&&!1===a.allowHalfOpen&&(this.allowHalfOpen=!1);this.once("end",h)}function h(){this.allowHalfOpen||this._writableState.ended||r.nextTick(m,this)}function m(a){a.end()}var r=c("process-nextick-args");
l=Object.keys||function(a){var b=[],c;for(c in a)b.push(c);return b};p.exports=b;p=Object.create(c("core-util-is"));p.inherits=c("inherits");var v=c("./_stream_readable"),E=c("./_stream_writable");p.inherits(b,v);c=l(E.prototype);for(p=0;p<c.length;p++)l=c[p],b.prototype[l]||(b.prototype[l]=E.prototype[l]);Object.defineProperty(b.prototype,"writableHighWaterMark",{enumerable:!1,get:function(){return this._writableState.highWaterMark}});Object.defineProperty(b.prototype,"destroyed",{get:function(){return void 0===
...
a=a||{};d=d instanceof z;this.objectMode=!!a.objectMode;d&&(this.objectMode=this.objectMode||!!a.readableObjectMode);var g=a.highWaterMark,b=a.readableHighWaterMark,e=this.objectMode?16:16384;this.highWaterMark=g||0===g?g:d&&(b||0===b)?b:e;this.highWaterMark=Math.floor(this.highWaterMark);this.buffer=new N;this.length=0;this.pipes=null;this.pipesCount=0;this.flowing=null;this.reading=this.endEmitted=this.ended=!1;this.sync=!0;this.destroyed=this.resumeScheduled=this.readableListening=this.emittedReadable=
this.needReadable=!1;this.defaultEncoding=a.defaultEncoding||"utf8";this.awaitDrain=0;this.readingMore=!1;this.encoding=this.decoder=null;a.encoding&&(k||(k=c("string_decoder/").StringDecoder),this.decoder=new k(a.encoding),this.encoding=a.encoding)}function v(a){z=z||c("./_stream_duplex");if(!(this instanceof v))return new v(a);this._readableState=new r(a,this);this.readable=!0;a&&("function"===typeof a.read&&(this._read=a.read),"function"===typeof a.destroy&&(this._destroy=a.destroy));K.call(this)}
function l(d,g,b,c,k){var e=d._readableState;if(null===g)e.reading=!1,e.ended||(e.decoder&&(g=e.decoder.end())&&g.length&&(e.buffer.push(g),e.length+=e.objectMode?1:g.length),e.ended=!0,B(d));else{if(!k){k=g;var f;J.isBuffer(k)||k instanceof L||"string"===typeof k||void 0===k||e.objectMode||(f=new TypeError("Invalid non-string/buffer chunk"));var O=f}O?d.emit("error",O):e.objectMode||g&&0<g.length?("string"===typeof g||e.objectMode||Object.getPrototypeOf(g)===J.prototype||(g=J.from(g)),c?e.endEmitted?
...
(C("emitReadable",d.flowing),d.emittedReadable=!0,d.sync?n.nextTick(y,a):y(a))}function y(a){C("emit readable");a.emit("readable");A(a)}function q(a,d){for(var g=d.length;!d.reading&&!d.flowing&&!d.ended&&d.length<d.highWaterMark&&(C("maybeReadMore read 0"),a.read(0),g!==d.length);)g=d.length;d.readingMore=!1}function x(a){return function(){var d=a._readableState;C("pipeOnDrain",d.awaitDrain);d.awaitDrain&&d.awaitDrain--;0===d.awaitDrain&&a.listeners("data").length&&(d.flowing=!0,A(a))}}function F(a){C("readable nexttick read 0");
a.read(0)}function G(a,d){d.reading||(C("resume read 0"),a.read(0));d.resumeScheduled=!1;d.awaitDrain=0;a.emit("resume");A(a);d.flowing&&!d.reading&&a.read(0)}function A(a){var d=a._readableState;for(C("flow",d.flowing);d.flowing&&null!==a.read(););}function D(a,d){if(0===d.length)return null;if(d.objectMode)var b=d.buffer.shift();else if(!a||a>=d.length)b=d.decoder?d.buffer.join(""):1===d.buffer.length?d.buffer.head.data:d.buffer.concat(d.length),d.buffer.clear();else{b=d.buffer;d=d.decoder;if(a<
b.head.data.length)d=b.head.data.slice(0,a),b.head.data=b.head.data.slice(a);else{if(a===b.head.data.length)b=b.shift();else if(d){d=b.head;var g=1,e=d.data;for(a-=e.length;d=d.next;){var c=d.data,k=a>c.length?c.length:a;e=k===c.length?e+c:e+c.slice(0,a);a-=k;if(0===a){k===c.length?(++g,b.head=d.next?d.next:b.tail=null):(b.head=d,d.data=c.slice(k));break}++g}b.length-=g;b=e}else{d=J.allocUnsafe(a);g=b.head;e=1;g.data.copy(d);for(a-=g.data.length;g=g.next;){c=g.data;k=a>c.length?c.length:a;c.copy(d,
d.length-a,0,k);a-=k;if(0===a){k===c.length?(++e,b.head=g.next?g.next:b.tail=null):(b.head=g,g.data=c.slice(k));break}++e}b.length-=e;b=d}d=b}b=d}return b}function H(a){var b=a._readableState;if(0<b.length)throw Error('"endReadable()" called on non-empty stream');b.endEmitted||(b.ended=!0,n.nextTick(d,b,a))}function d(a,d){a.endEmitted||0!==a.length||(a.endEmitted=!0,d.readable=!1,d.emit("end"))}function u(a,d){for(var b=0,g=a.length;b<g;b++)if(a[b]===d)return b;return-1}var n=c("process-nextick-args");
p.exports=v;var f=c("isarray"),z;v.ReadableState=r;c("events");var K=c("./internal/streams/stream"),J=c("safe-buffer").Buffer,L=h.Uint8Array||function(){};h=Object.create(c("core-util-is"));h.inherits=c("inherits");var I=c("util"),C=void 0;C=I&&I.debuglog?I.debuglog("stream"):function(){};var N=c("./internal/streams/BufferList");I=c("./internal/streams/destroy");var k;h.inherits(v,K);var t=["error","close","destroy","pause","resume"];Object.defineProperty(v.prototype,"destroyed",{get:function(){return void 0===
this._readableState?!1:this._readableState.destroyed},set:function(a){this._readableState&&(this._readableState.destroyed=a)}});v.prototype.destroy=I.destroy;v.prototype._undestroy=I.undestroy;v.prototype._destroy=function(a,d){this.push(null);d(a)};v.prototype.push=function(a,d){var b=this._readableState;if(b.objectMode)var g=!0;else"string"===typeof a&&(d=d||b.defaultEncoding,d!==b.encoding&&(a=J.from(a,d),d=""),g=!0);return l(this,a,d,!1,g)};v.prototype.unshift=function(a){return l(this,a,null,
!0,!1)};v.prototype.isPaused=function(){return!1===this._readableState.flowing};v.prototype.setEncoding=function(a){k||(k=c("string_decoder/").StringDecoder);this._readableState.decoder=new k(a);this._readableState.encoding=a;return this};v.prototype.read=function(a){C("read",a);a=parseInt(a,10);var d=this._readableState,b=a;0!==a&&(d.emittedReadable=!1);if(0===a&&d.needReadable&&(d.length>=d.highWaterMark||d.ended))return C("read: emitReadable",d.length,d.ended),0===d.length&&d.ended?H(this):B(this),
null;a=w(a,d);if(0===a&&d.ended)return 0===d.length&&H(this),null;var e=d.needReadable;C("need readable",e);if(0===d.length||d.length-a<d.highWaterMark)e=!0,C("length less than watermark",e);d.ended||d.reading?C("reading or ended",!1):e&&(C("do read"),d.reading=!0,d.sync=!0,0===d.length&&(d.needReadable=!0),this._read(d.highWaterMark),d.sync=!1,d.reading||(a=w(b,d)));e=0<a?D(a,d):null;null===e?(d.needReadable=!0,a=0):d.length-=a;0===d.length&&(d.ended||(d.needReadable=!0),b!==a&&d.ended&&H(this));
null!==e&&this.emit("data",e);return e};v.prototype._read=function(a){this.emit("error",Error("_read() is not implemented"))};v.prototype.pipe=function(a,d){function g(d,b){C("onunpipe");d===h&&b&&!1===b.hasUnpiped&&(b.hasUnpiped=!0,C("cleanup"),a.removeListener("close",f),a.removeListener("finish",w),a.removeListener("drain",K),a.removeListener("error",k),a.removeListener("unpipe",g),h.removeListener("end",e),h.removeListener("end",z),h.removeListener("data",c),r=!0,!y.awaitDrain||a._writableState&&
!a._writableState.needDrain||K())}function e(){C("onend");a.end()}function c(d){C("ondata");R=!1;!1!==a.write(d)||R||((1===y.pipesCount&&y.pipes===a||1<y.pipesCount&&-1!==u(y.pipes,a))&&!r&&(C("false write response, pause",h._readableState.awaitDrain),h._readableState.awaitDrain++,R=!0),h.pause())}function k(d){C("onerror",d);z();a.removeListener("error",k);0===a.listeners("error").length&&a.emit("error",d)}function f(){a.removeListener("finish",w);z()}function w(){C("onfinish");a.removeListener("close",
f);z()}function z(){C("unpipe");h.unpipe(a)}var h=this,y=this._readableState;switch(y.pipesCount){case 0:y.pipes=a;break;case 1:y.pipes=[y.pipes,a];break;default:y.pipes.push(a)}y.pipesCount+=1;C("pipe count=%d opts=%j",y.pipesCount,d);d=d&&!1===d.end||a===b.stdout||a===b.stderr?z:e;if(y.endEmitted)n.nextTick(d);else h.once("end",d);a.on("unpipe",g);var K=x(h);a.on("drain",K);var r=!1,R=!1;h.on("data",c);m(a,"error",k);a.once("close",f);a.once("finish",w);a.emit("pipe",h);y.flowing||(C("pipe resume"),
h.resume());return a};v.prototype.unpipe=function(a){var d=this._readableState,b={hasUnpiped:!1};if(0===d.pipesCount)return this;if(1===d.pipesCount){if(a&&a!==d.pipes)return this;a||(a=d.pipes);d.pipes=null;d.pipesCount=0;d.flowing=!1;a&&a.emit("unpipe",this,b);return this}if(!a){a=d.pipes;var c=d.pipesCount;d.pipes=null;d.pipesCount=0;d.flowing=!1;for(d=0;d<c;d++)a[d].emit("unpipe",this,b);return this}c=u(d.pipes,a);if(-1===c)return this;d.pipes.splice(c,1);--d.pipesCount;1===d.pipesCount&&(d.pipes=
d.pipes[0]);a.emit("unpipe",this,b);return this};v.prototype.on=function(a,d){d=K.prototype.on.call(this,a,d);"data"===a?!1!==this._readableState.flowing&&this.resume():"readable"===a&&(a=this._readableState,a.endEmitted||a.readableListening||(a.readableListening=a.needReadable=!0,a.emittedReadable=!1,a.reading?a.length&&B(this):n.nextTick(F,this)));return d};v.prototype.addListener=v.prototype.on;v.prototype.resume=function(){var a=this._readableState;a.flowing||(C("resume"),a.flowing=!0,a.resumeScheduled||
(a.resumeScheduled=!0,n.nextTick(G,this,a)));return this};v.prototype.pause=function(){C("call pause flowing=%j",this._readableState.flowing);!1!==this._readableState.flowing&&(C("pause"),this._readableState.flowing=!1,this.emit("pause"));return this};v.prototype.wrap=function(a){var d=this,b=this._readableState,c=!1;a.on("end",function(){C("wrapped end");if(b.decoder&&!b.ended){var a=b.decoder.end();a&&a.length&&d.push(a)}d.push(null)});a.on("data",function(g){C("wrapped data");b.decoder&&(g=b.decoder.write(g));
b.objectMode&&(null===g||void 0===g)||!(b.objectMode||g&&g.length)||d.push(g)||(c=!0,a.pause())});for(var e in a)void 0===this[e]&&"function"===typeof a[e]&&(this[e]=function(d){return function(){return a[d].apply(a,arguments)}}(e));for(e=0;e<t.length;e++)a.on(t[e],this.emit.bind(this,t[e]));this._read=function(d){C("wrapped _read",d);c&&(c=!1,a.resume())};return this};Object.defineProperty(v.prototype,"readableHighWaterMark",{enumerable:!1,get:function(){return this._readableState.highWaterMark}});
v._fromList=D}).call(this,c("_process"),"undefined"!==typeof global?global:"undefined"!==typeof self?self:"undefined"!==typeof window?window:{})},{"./_stream_duplex":13,"./internal/streams/BufferList":18,"./internal/streams/destroy":19,"./internal/streams/stream":20,_process:11,"core-util-is":4,events:5,inherits:7,isarray:9,"process-nextick-args":10,"safe-buffer":21,"string_decoder/":22,util:2}],16:[function(c,p,l){function b(b,a){var c=this._transformState;c.transforming=!1;var m=c.writecb;if(!m)return this.emit("error",
...
function(){var b=d.entry;for(d.entry=null;b;){var c=b.callback;a.pendingcb--;c(void 0);b=b.next}a.corkedRequestsFree?a.corkedRequestsFree.next=d:a.corkedRequestsFree=d}}function v(){}function l(a,d){D=D||c("./_stream_duplex");a=a||{};var b=d instanceof D;this.objectMode=!!a.objectMode;b&&(this.objectMode=this.objectMode||!!a.writableObjectMode);var n=a.highWaterMark,f=a.writableHighWaterMark,m=this.objectMode?16:16384;this.highWaterMark=n||0===n?n:b&&(f||0===f)?f:m;this.highWaterMark=Math.floor(this.highWaterMark);
this.destroyed=this.finished=this.ended=this.ending=this.needDrain=this.finalCalled=!1;this.decodeStrings=!1!==a.decodeStrings;this.defaultEncoding=a.defaultEncoding||"utf8";this.length=0;this.writing=!1;this.corked=0;this.sync=!0;this.bufferProcessing=!1;this.onwrite=function(a){var b=d._writableState,c=b.sync,e=b.writecb;b.writing=!1;b.writecb=null;b.length-=b.writelen;b.writelen=0;a?(--b.pendingcb,c?(G.nextTick(e,a),G.nextTick(F,d,b),d._writableState.errorEmitted=!0,d.emit("error",a)):(e(a),d._writableState.errorEmitted=
!0,d.emit("error",a),F(d,b))):((a=q(b))||b.corked||b.bufferProcessing||!b.bufferedRequest||y(d,b),c?A(B,d,b,a,e):B(d,b,a,e))};this.writecb=null;this.writelen=0;this.lastBufferedRequest=this.bufferedRequest=null;this.pendingcb=0;this.errorEmitted=this.prefinished=!1;this.bufferedRequestCount=0;this.corkedRequestsFree=new r(this)}function a(b){D=D||c("./_stream_duplex");if(!(f.call(a,this)||this instanceof D))return new a(b);this._writableState=new l(b,this);this.writable=!0;b&&("function"===typeof b.write&&
(this._write=b.write),"function"===typeof b.writev&&(this._writev=b.writev),"function"===typeof b.destroy&&(this._destroy=b.destroy),"function"===typeof b.final&&(this._final=b.final));d.call(this)}function w(a,d,b,c,n,f,m){d.writelen=c;d.writecb=m;d.writing=!0;d.sync=!0;b?a._writev(n,d.onwrite):a._write(n,f,d.onwrite);d.sync=!1}function B(a,d,b,c){!b&&0===d.length&&d.needDrain&&(d.needDrain=!1,a.emit("drain"));d.pendingcb--;c();F(a,d)}function y(a,d){d.bufferProcessing=!0;var b=d.bufferedRequest;
...
null)}d.bufferedRequest=b;d.bufferProcessing=!1}function q(a){return a.ending&&0===a.length&&null===a.bufferedRequest&&!a.finished&&!a.writing}function x(a,d){a._final(function(b){d.pendingcb--;b&&a.emit("error",b);d.prefinished=!0;a.emit("prefinish");F(a,d)})}function F(a,d){var b=q(d);b&&(d.prefinished||d.finalCalled||("function"===typeof a._final?(d.pendingcb++,d.finalCalled=!0,G.nextTick(x,a,d)):(d.prefinished=!0,a.emit("prefinish"))),0===d.pendingcb&&(d.finished=!0,a.emit("finish")));return b}
var G=c("process-nextick-args");p.exports=a;var A=!b.browser&&-1<["v0.10","v0.9."].indexOf(b.version.slice(0,5))?m:G.nextTick,D;a.WritableState=l;b=Object.create(c("core-util-is"));b.inherits=c("inherits");var H={deprecate:c("util-deprecate")},d=c("./internal/streams/stream"),u=c("safe-buffer").Buffer,n=h.Uint8Array||function(){};h=c("./internal/streams/destroy");b.inherits(a,d);l.prototype.getBuffer=function(){for(var a=this.bufferedRequest,d=[];a;)d.push(a),a=a.next;return d};(function(){try{Object.defineProperty(l.prototype,
"buffer",{get:H.deprecate(function(){return this.getBuffer()},"_writableState.buffer is deprecated. Use _writableState.getBuffer instead.","DEP0003")})}catch(z){}})();if("function"===typeof Symbol&&Symbol.hasInstance&&"function"===typeof Function.prototype[Symbol.hasInstance]){var f=Function.prototype[Symbol.hasInstance];Object.defineProperty(a,Symbol.hasInstance,{value:function(d){return f.call(this,d)?!0:this!==a?!1:d&&d._writableState instanceof l}})}else f=function(a){return a instanceof this};
a.prototype.pipe=function(){this.emit("error",Error("Cannot pipe, not readable"))};a.prototype.write=function(a,d,b){var c=this._writableState,f=!1,m;if(m=!c.objectMode)m=a,m=u.isBuffer(m)||m instanceof n;m&&!u.isBuffer(a)&&(a=u.from(a));"function"===typeof d&&(b=d,d=null);m?d="buffer":d||(d=c.defaultEncoding);"function"!==typeof b&&(b=v);if(c.ended)c=b,b=Error("write after end"),this.emit("error",b),G.nextTick(c,b);else{var h;if(!(h=m)){h=a;var k=b,y=!0,e=!1;null===h?e=new TypeError("May not write null values to stream"):
"string"===typeof h||void 0===h||c.objectMode||(e=new TypeError("Invalid non-string/buffer chunk"));e&&(this.emit("error",e),G.nextTick(k,e),y=!1);h=y}h&&(c.pendingcb++,f=m,f||(m=a,c.objectMode||!1===c.decodeStrings||"string"!==typeof m||(m=u.from(m,d)),a!==m&&(f=!0,d="buffer",a=m)),h=c.objectMode?1:a.length,c.length+=h,m=c.length<c.highWaterMark,m||(c.needDrain=!0),c.writing||c.corked?(h=c.lastBufferedRequest,c.lastBufferedRequest={chunk:a,encoding:d,isBuf:f,callback:b,next:null},h?h.next=c.lastBufferedRequest:
c.bufferedRequest=c.lastBufferedRequest,c.bufferedRequestCount+=1):w(this,c,!1,h,a,d,b),f=m)}return f};a.prototype.cork=function(){this._writableState.corked++};a.prototype.uncork=function(){var a=this._writableState;a.corked&&(a.corked--,a.writing||a.corked||a.finished||a.bufferProcessing||!a.bufferedRequest||y(this,a))};a.prototype.setDefaultEncoding=function(a){"string"===typeof a&&(a=a.toLowerCase());if(!(-1<"hex utf8 utf-8 ascii binary base64 ucs2 ucs-2 utf16le utf-16le raw".split(" ").indexOf((a+
...
this.write(a,d);c.corked&&(c.corked=1,this.uncork());if(!c.ending&&!c.finished){a=b;c.ending=!0;F(this,c);if(a)if(c.finished)G.nextTick(a);else this.once("finish",a);c.ended=!0;this.writable=!1}};Object.defineProperty(a.prototype,"destroyed",{get:function(){return void 0===this._writableState?!1:this._writableState.destroyed},set:function(a){this._writableState&&(this._writableState.destroyed=a)}});a.prototype.destroy=h.destroy;a.prototype._undestroy=h.undestroy;a.prototype._destroy=function(a,d){this.end();
...
default:if(b)return;a=(""+a).toLowerCase();b=!0}}function h(c){var m=b(c);if("string"!==typeof m&&(x.isEncoding===F||!F(c)))throw Error("Unknown encoding: "+c);this.encoding=m||c;switch(this.encoding){case "utf16le":this.text=E;this.end=a;c=4;break;case "utf8":this.fillLast=v;c=4;break;case "base64":this.text=w;this.end=B;c=3;break;default:this.write=y;this.end=q;return}this.lastTotal=this.lastNeed=0;this.lastChar=x.allocUnsafe(c)}function m(a){return 127>=a?0:6===a>>5?2:14===a>>4?3:30===a>>3?4:2===
...
c)}function B(a){a=a&&a.length?this.write(a):"";return this.lastNeed?a+this.lastChar.toString("base64",0,3-this.lastNeed):a}function y(a){return a.toString(this.encoding)}function q(a){return a&&a.length?this.write(a):""}var x=c("safe-buffer").Buffer,F=x.isEncoding||function(a){a=""+a;switch(a&&a.toLowerCase()){case "hex":case "utf8":case "utf-8":case "ascii":case "binary":case "base64":case "ucs2":case "ucs-2":case "utf16le":case "utf-16le":case "raw":return!0;default:return!1}};l.StringDecoder=
...
configurable:!1})})}function l(a){return" "===a||"\n"===a||"\r"===a||"\t"===a}function p(a){return'"'===a||"'"===a}function a(a,d,b){a.textNode&&w(a);a[d]&&a[d](b)}function w(a){a.textNode=B(a.opt,a.textNode);a.textNode&&a.ontext&&a.ontext(a.textNode);a.textNode=""}function B(a,d){a.trim&&(d=d.trim());a.normalize&&(d=d.replace(/\s+/g," "));return d}function y(a,d){w(a);a.trackPosition&&(d+="\nLine: "+a.line+"\nColumn: "+a.column+"\nChar: "+a.c);d=Error(d);a.error=d;a.onerror&&a.onerror(d);return a}
function q(a){a.sawRoot&&!a.closedRoot&&x(a,"Unclosed root tag");a.state!==g.BEGIN&&a.state!==g.BEGIN_WHITESPACE&&a.state!==g.TEXT&&y(a,"Unexpected end");w(a);a.c="";a.closed=!0;a.onend&&a.onend(void 0);m.call(a,a.strict,a.opt);return a}function x(a,d){if("object"!==typeof a||!(a instanceof m))throw Error("bad call to strictFail");a.strict&&y(a,d)}function F(a,d){var b=0>a.indexOf(":")?["",a]:a.split(":"),c=b[0];b=b[1];d&&"xmlns"===a&&(c="xmlns",b="");return{prefix:c,local:b}}function G(d){d.strict||
(d.attribName=d.attribName[d.looseCase]());if(-1===d.attribList.indexOf(d.attribName)&&!d.tag.attributes.hasOwnProperty(d.attribName))if(d.opt.xmlns){var b=F(d.attribName,!0),c=b.local;if("xmlns"===b.prefix)if("xml"===c&&d.attribValue!==L)x(d,"xml: prefix must be bound to "+L+"\nActual: "+d.attribValue);else if("xmlns"===c&&d.attribValue!==I)x(d,"xmlns: prefix must be bound to "+I+"\nActual: "+d.attribValue);else{b=d.tag;var g=d.tags[d.tags.length-1]||d;b.ns===g.ns&&(b.ns=Object.create(g.ns));b.ns[c]=
d.attribValue}d.attribList.push([d.attribName,d.attribValue])}else d.tag.attributes[d.attribName]=d.attribValue,a(d,"onattribute",{name:d.attribName,value:d.attribValue});d.attribName=d.attribValue=""}function A(d,b){if(d.opt.xmlns){var c=d.tag,e=F(d.tagName);c.prefix=e.prefix;c.local=e.local;c.uri=c.ns[e.prefix]||"";c.prefix&&!c.uri&&(x(d,"Unbound namespace prefix: "+JSON.stringify(d.tagName)),c.uri=e.prefix);e=d.tags[d.tags.length-1]||d;c.ns&&e.ns!==c.ns&&Object.keys(c.ns).forEach(function(b){a(d,
"onopennamespace",{prefix:b,uri:c.ns[b]})});e=0;for(var k=d.attribList.length;e<k;e++){var n=d.attribList[e],f=n[0],m=n[1],h=F(f,!0);n=h.prefix;var u=""===n?"":c.ns[n]||"";m={name:f,value:m,prefix:n,local:h.local,uri:u};n&&"xmlns"!==n&&!u&&(x(d,"Unbound namespace prefix: "+JSON.stringify(n)),m.uri=n);d.tag.attributes[f]=m;a(d,"onattribute",m)}d.attribList.length=0}d.tag.isSelfClosing=!!b;d.sawRoot=!0;d.tags.push(d.tag);a(d,"onopentag",d.tag);b||(d.noscript||"script"!==d.tagName.toLowerCase()?d.state=
g.TEXT:d.state=g.SCRIPT,d.tag=null,d.tagName="");d.attribName=d.attribValue="";d.attribList.length=0}function D(d){if(d.tagName){if(d.script){if("script"!==d.tagName){d.script+="</"+d.tagName+">";d.tagName="";d.state=g.SCRIPT;return}a(d,"onscript",d.script);d.script=""}var b=d.tags.length,c=d.tagName;d.strict||(c=c[d.looseCase]());for(var e=c;b--;)if(d.tags[b].name!==e)x(d,"Unexpected close tag");else break;if(0>b)x(d,"Unmatched closing tag: "+d.tagName),d.textNode+="</"+d.tagName+">";else{d.tagName=
c;for(c=d.tags.length;c-- >b;){var n=d.tag=d.tags.pop();d.tagName=d.tag.name;a(d,"onclosetag",d.tagName);for(var k in n.ns);e=d.tags[d.tags.length-1]||d;d.opt.xmlns&&n.ns!==e.ns&&Object.keys(n.ns).forEach(function(b){a(d,"onclosenamespace",{prefix:b,uri:n.ns[b]})})}0===b&&(d.closedRoot=!0);d.tagName=d.attribValue=d.attribName="";d.attribList.length=0}}else x(d,"Weird empty close tag."),d.textNode+="</>";d.state=g.TEXT}function H(a){var d=a.entity,b=d.toLowerCase(),c="";if(a.ENTITIES[d])return a.ENTITIES[d];
if(a.ENTITIES[b])return a.ENTITIES[b];d=b;if("#"===d.charAt(0))if("x"===d.charAt(1)){d=d.slice(2);var g=parseInt(d,16);c=g.toString(16)}else d=d.slice(1),g=parseInt(d,10),c=g.toString(10);d=d.replace(/^0+/,"");return isNaN(g)||c.toLowerCase()!==d?(x(a,"Invalid character entity"),"&"+a.entity+";"):String.fromCodePoint(g)}function d(a,d){"<"===d?(a.state=g.OPEN_WAKA,a.startTagPosition=a.position):l(d)||(x(a,"Non-whitespace before first tag."),a.textNode=d,a.state=g.TEXT)}function u(a,d){var b="";d<
...
Object.create||(Object.create=function(a){function d(){}d.prototype=a;return new d});Object.keys||(Object.keys=function(a){var d=[],b;for(b in a)a.hasOwnProperty(b)&&d.push(b);return d});m.prototype={end:function(){q(this)},write:function(b){if(this.error)throw this.error;if(this.closed)return y(this,"Cannot write after close. Assign an onready handler.");if(null===b)return q(this);"object"===typeof b&&(b=b.toString());for(var c=0,f;;){this.c=f=u(b,c++);if(!f)break;this.trackPosition&&(this.position++,
...
x(this,"Text data outside of root node."),"&"===f?this.state=g.TEXT_ENTITY:this.textNode+=f):(this.state=g.OPEN_WAKA,this.startTagPosition=this.position);continue;case g.SCRIPT:"<"===f?this.state=g.SCRIPT_ENDING:this.script+=f;continue;case g.SCRIPT_ENDING:"/"===f?this.state=g.CLOSE_TAG:(this.script+="<"+f,this.state=g.SCRIPT);continue;case g.OPEN_WAKA:"!"===f?(this.state=g.SGML_DECL,this.sgmlDecl=""):l(f)||(N.test(f)?(this.state=g.OPEN_TAG,this.tagName=f):"/"===f?(this.state=g.CLOSE_TAG,this.tagName=
""):"?"===f?(this.state=g.PROC_INST,this.procInstName=this.procInstBody=""):(x(this,"Unencoded <"),this.startTagPosition+1<this.position&&(f=Array(this.position-this.startTagPosition).join(" ")+f),this.textNode+="<"+f,this.state=g.TEXT));continue;case g.SGML_DECL:(this.sgmlDecl+f).toUpperCase()===K?(a(this,"onopencdata"),this.state=g.CDATA,this.cdata=this.sgmlDecl=""):"--"===this.sgmlDecl+f?(this.state=g.COMMENT,this.sgmlDecl=this.comment=""):(this.sgmlDecl+f).toUpperCase()===J?(this.state=g.DOCTYPE,
(this.doctype||this.sawRoot)&&x(this,"Inappropriately located doctype declaration"),this.sgmlDecl=this.doctype=""):">"===f?(a(this,"onsgmldeclaration",this.sgmlDecl),this.sgmlDecl="",this.state=g.TEXT):(p(f)&&(this.state=g.SGML_DECL_QUOTED),this.sgmlDecl+=f);continue;case g.SGML_DECL_QUOTED:f===this.q&&(this.state=g.SGML_DECL,this.q="");this.sgmlDecl+=f;continue;case g.DOCTYPE:">"===f?(this.state=g.TEXT,a(this,"ondoctype",this.doctype),this.doctype=!0):(this.doctype+=f,"["===f?this.state=g.DOCTYPE_DTD:
...
(this.comment=B(this.opt,this.comment))&&a(this,"oncomment",this.comment),this.comment=""):(this.comment+="-"+f,this.state=g.COMMENT);continue;case g.COMMENT_ENDED:">"!==f?(x(this,"Malformed comment"),this.comment+="--"+f,this.state=g.COMMENT):this.state=g.TEXT;continue;case g.CDATA:"]"===f?this.state=g.CDATA_ENDING:this.cdata+=f;continue;case g.CDATA_ENDING:"]"===f?this.state=g.CDATA_ENDING_2:(this.cdata+="]"+f,this.state=g.CDATA);continue;case g.CDATA_ENDING_2:">"===f?(this.cdata&&a(this,"oncdata",
...
this.procInstName=this.procInstBody="",this.state=g.TEXT):(this.procInstBody+="?"+f,this.state=g.PROC_INST_BODY);continue;case g.OPEN_TAG:if(k.test(f))this.tagName+=f;else{this.strict||(this.tagName=this.tagName[this.looseCase]());m=this.tags[this.tags.length-1]||this;var r=this.tag={name:this.tagName,attributes:{}};this.opt.xmlns&&(r.ns=m.ns);this.attribList.length=0;a(this,"onopentagstart",r);">"===f?A(this):"/"===f?this.state=g.OPEN_TAG_SLASH:(l(f)||x(this,"Invalid character in tag name"),this.state=
g.ATTRIB)}continue;case g.OPEN_TAG_SLASH:">"===f?(A(this,!0),D(this)):(x(this,"Forward-slash in opening tag not followed by >"),this.state=g.ATTRIB);continue;case g.ATTRIB:if(l(f))continue;else">"===f?A(this):"/"===f?this.state=g.OPEN_TAG_SLASH:N.test(f)?(this.attribName=f,this.attribValue="",this.state=g.ATTRIB_NAME):x(this,"Invalid attribute name");continue;case g.ATTRIB_NAME:"="===f?this.state=g.ATTRIB_VALUE:">"===f?(x(this,"Attribute without value"),this.attribValue=this.attribName,G(this),A(this)):
l(f)?this.state=g.ATTRIB_NAME_SAW_WHITE:k.test(f)?this.attribName+=f:x(this,"Invalid attribute name");continue;case g.ATTRIB_NAME_SAW_WHITE:if("="===f)this.state=g.ATTRIB_VALUE;else if(l(f))continue;else x(this,"Attribute without value"),this.attribValue=this.tag.attributes[this.attribName]="",a(this,"onattribute",{name:this.attribName,value:""}),this.attribName="",">"===f?A(this):N.test(f)?(this.attribName=f,this.state=g.ATTRIB_NAME):(x(this,"Invalid attribute name"),this.state=g.ATTRIB);continue;
case g.ATTRIB_VALUE:if(l(f))continue;else p(f)?(this.q=f,this.state=g.ATTRIB_VALUE_QUOTED):(x(this,"Unquoted attribute value"),this.state=g.ATTRIB_VALUE_UNQUOTED,this.attribValue=f);continue;case g.ATTRIB_VALUE_QUOTED:if(f!==this.q){"&"===f?this.state=g.ATTRIB_VALUE_ENTITY_Q:this.attribValue+=f;continue}G(this);this.q="";this.state=g.ATTRIB_VALUE_CLOSED;continue;case g.ATTRIB_VALUE_CLOSED:l(f)?this.state=g.ATTRIB:">"===f?A(this):"/"===f?this.state=g.OPEN_TAG_SLASH:N.test(f)?(x(this,"No whitespace between attributes"),
this.attribName=f,this.attribValue="",this.state=g.ATTRIB_NAME):x(this,"Invalid attribute name");continue;case g.ATTRIB_VALUE_UNQUOTED:if(">"!==f&&!l(f)){"&"===f?this.state=g.ATTRIB_VALUE_ENTITY_U:this.attribValue+=f;continue}G(this);">"===f?A(this):this.state=g.ATTRIB;continue;case g.CLOSE_TAG:if(this.tagName)">"===f?D(this):k.test(f)?this.tagName+=f:this.script?(this.script+="</"+this.tagName,this.tagName="",this.state=g.SCRIPT):(l(f)||x(this,"Invalid tagname in closing tag"),this.state=g.CLOSE_TAG_SAW_WHITE);
else if(l(f))continue;else N.test(f)?this.tagName=f:this.script?(this.script+="</"+f,this.state=g.SCRIPT):x(this,"Invalid tagname in closing tag.");continue;case g.CLOSE_TAG_SAW_WHITE:if(l(f))continue;">"===f?D(this):x(this,"Invalid characters in closing tag");continue;case g.TEXT_ENTITY:case g.ATTRIB_VALUE_ENTITY_Q:case g.ATTRIB_VALUE_ENTITY_U:switch(this.state){case g.TEXT_ENTITY:var z=g.TEXT;var C="textNode";break;case g.ATTRIB_VALUE_ENTITY_Q:z=g.ATTRIB_VALUE_QUOTED;C="attribValue";break;case g.ATTRIB_VALUE_ENTITY_U:z=
g.ATTRIB_VALUE_UNQUOTED,C="attribValue"}";"===f?(this[C]+=H(this),this.entity="",this.state=z):(this.entity.length?e:t).test(f)?this.entity+=f:(x(this,"Invalid character in entity name"),this[C]+="&"+this.entity+f,this.entity="",this.state=z);continue;default:throw Error(this,"Unknown state: "+this.state);}}if(this.position>=this.bufferCheckPosition){b=Math.max(h.MAX_BUFFER_LENGTH,10);f=c=0;for(z=n.length;f<z;f++){C=this[n[f]].length;if(C>b)switch(n[f]){case "textNode":w(this);break;case "cdata":a(this,
"oncdata",this.cdata);this.cdata="";break;case "script":a(this,"onscript",this.script);this.script="";break;default:y(this,"Max buffer length exceeded: "+n[f])}c=Math.max(c,C)}this.bufferCheckPosition=h.MAX_BUFFER_LENGTH-c+this.position}return this},resume:function(){this.error=null;return this},close:function(){return this.write(null)},flush:function(){w(this);""!==this.cdata&&(a(this,"oncdata",this.cdata),this.cdata="");""!==this.script&&(a(this,"onscript",this.script),this.script="")}};try{var f=
...
return!0};r.prototype.on=function(a,d){var b=this;b._parser["on"+a]||-1===z.indexOf(a)||(b._parser["on"+a]=function(){var d=1===arguments.length?[arguments[0]]:Array.apply(null,arguments);d.splice(0,0,a);b.emit.apply(b,d)});return f.prototype.on.call(b,a,d)};var K="[CDATA[",J="DOCTYPE",L="http://www.w3.org/XML/1998/namespace",I="http://www.w3.org/2000/xmlns/",C={xml:L,xmlns:I},N=/[:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD]/,
...
r.resume&&r.resume()}function a(){x||(x=!0,b.end())}function w(){x||(x=!0,"function"===typeof b.destroy&&b.destroy())}function B(a){y();if(0===h.listenerCount(this,"error"))throw a;}function y(){r.removeListener("data",m);b.removeListener("drain",l);r.removeListener("end",a);r.removeListener("close",w);r.removeListener("error",B);b.removeListener("error",B);r.removeListener("end",y);r.removeListener("close",y);b.removeListener("close",y)}var r=this;r.on("data",m);b.on("drain",l);b._isStdio||c&&!1===
c.end||(r.on("end",a),r.on("close",w));var x=!1;r.on("error",B);b.on("error",B);r.on("end",y);r.on("close",y);b.on("close",y);b.emit("pipe",r);return b}},{events:5,inherits:7,"readable-stream/duplex.js":12,"readable-stream/passthrough.js":23,"readable-stream/readable.js":24,"readable-stream/transform.js":25,"readable-stream/writable.js":26}],30:[function(c,p,l){arguments[4][22][0].apply(l,arguments)},{dup:22,"safe-buffer":27}],31:[function(c,p,l){(function(b,h){function m(a,b){this._id=a;this._clearFn=
b}var r=c("process/browser.js").nextTick,p=Function.prototype.apply,E=Array.prototype.slice,a={},w=0;l.setTimeout=function(){return new m(p.call(setTimeout,window,arguments),clearTimeout)};l.setInterval=function(){return new m(p.call(setInterval,window,arguments),clearInterval)};l.clearTimeout=l.clearInterval=function(a){a.close()};m.prototype.unref=m.prototype.ref=function(){};m.prototype.close=function(){this._clearFn.call(window,this._id)};l.enroll=function(a,b){clearTimeout(a._idleTimeoutId);
a._idleTimeout=b};l.unenroll=function(a){clearTimeout(a._idleTimeoutId);a._idleTimeout=-1};l._unrefActive=l.active=function(a){clearTimeout(a._idleTimeoutId);var b=a._idleTimeout;0<=b&&(a._idleTimeoutId=setTimeout(function(){a._onTimeout&&a._onTimeout()},b))};l.setImmediate="function"===typeof b?b:function(b){var c=w++,m=2>arguments.length?!1:E.call(arguments,1);a[c]=!0;r(function(){a[c]&&(m?b.apply(null,m):b.call(null),l.clearImmediate(c))});return c};l.clearImmediate="function"===typeof h?h:function(b){delete a[b]}}).call(this,
...
(w(a,d.sets[e],c,d),b="seq"===d.timeContainer?d.sets[e].end:Math.max(b,d.sets[e].end),c=d.sets[e]);if("contents"in d)for(var n in d.contents)d.contents.hasOwnProperty(n)&&(w(a,d.contents[n],c,d),b="seq"===d.timeContainer?d.contents[n].end:Math.max(b,d.contents[n].end),c=d.contents[n]);else b=f?d.begin:Number.POSITIVE_INFINITY;d.end=null!==d.explicit_end&&null!==d.explicit_dur?Math.min(d.begin+d.explicit_dur,g+d.explicit_end):null===d.explicit_end&&null!==d.explicit_dur?d.begin+d.explicit_dur:null!==
d.explicit_end&&null===d.explicit_dur?g+d.explicit_end:b;delete d.explicit_begin;delete d.explicit_dur;delete d.explicit_end;a._registerEvent(d)}function B(a){this.node=a}function y(){this.events=[];this.head=new q;this.body=null}function q(){this.styling=new x;this.layout=new A}function x(){this.styles={};this.initials={}}function p(){this.styleRefs=this.styleAttrs=this.id=null}function v(){this.styleAttrs=null}function A(){this.regions={}}function D(a,d){this.kind="image";this.src=a;this.type=d}
function H(a){this.id=a}function d(a){this.regionID=a}function u(a){this.styleAttrs=a}function n(a){this.sets=a}function f(a){this.contents=a}function z(a,d,b){this.explicit_begin=a;this.explicit_end=d;this.explicit_dur=b}function K(){this.kind="body"}function J(){this.kind="div"}function L(){this.kind="p"}function I(){this.kind="span"}function C(){this.kind="span"}function N(){this.kind="br"}function k(){}function t(){}function e(a){var d=null;a&&(a=a.attributes["xml:id"]||a.attributes.id)&&(d=a.value||
...
g=/^(\d+(?:\.\d+)?)t$/,e=/^(\d+(?:\.\d+)?)ms$/,n=/^(\d+(?:\.\d+)?)s$/,k=/^(\d+(?:\.\d+)?)h$/,m=/^(\d+(?:\.\d+)?)m$/,h,u=null;null!==(h=/^(\d+(?:\.\d+)?)f$/.exec(b))?null!==d&&(u=parseFloat(h[1])/d):null!==(h=g.exec(b))?null!==a&&(u=parseFloat(h[1])/a):null!==(h=e.exec(b))?u=parseFloat(h[1])/1E3:null!==(h=n.exec(b))?u=parseFloat(h[1]):null!==(h=k.exec(b))?u=3600*parseFloat(h[1]):null!==(h=m.exec(b))?u=60*parseFloat(h[1]):null!==(h=c.exec(b))?u=3600*parseInt(h[1])+60*parseInt(h[2])+parseFloat(h[3]):
...
V(z.head.styling,e[0].styleRefs,e[0].styleAttrs,b),delete e[0].styleRefs;else if(e[0]instanceof x)for(var d in e[0].styles)e[0].styles.hasOwnProperty(d)&&W(e[0],e[0].styles[d],b);else if(e[0]instanceof L||e[0]instanceof I){if(1<e[0].contents.length){a=[e[0].contents[0]];for(d=1;d<e[0].contents.length;d++)e[0].contents[d]instanceof C&&a[a.length-1]instanceof C?a[a.length-1].text+=e[0].contents[d].text:a.push(e[0].contents[d]);e[0].contents=a}e[0]instanceof I&&1===e[0].contents.length&&e[0].contents[0]instanceof
C&&(e[0].text=e[0].contents[0].text,delete e[0].contents)}else if(e[0]instanceof B)if(e[0].node.uri===m.ns_tt&&"metadata"===e[0].node.local)l--;else if(0<l&&f&&"onCloseTag"in f)f.onCloseTag();u.shift();n.shift();e.shift()};g.ontext=function(a){if(void 0!==e[0])if(e[0]instanceof I||e[0]instanceof L){if(e[0]instanceof I){var d=e[0].styleAttrs[r.byName.ruby.qname];if("container"===d||"textContainer"===d||"baseContainer"===d)return}d=new C;d.initFromText(z,e[0],a,n[0],u[0],b);e[0].contents.push(d)}else if(e[0]instanceof
...
y||M(b,"Parent of <body> element is not <tt> at "+this.line+","+this.column+")"),null!==z.body&&M(b,"Second <body> element at "+this.line+","+this.column+")"),h=new K,h.initFromNode(z,a,n[0],b),z.body=h,e.unshift(h);else if("div"===a.local){e[0]instanceof J||e[0]instanceof K||M(b,"Parent of <div> element is not <body> or <div> at "+this.line+","+this.column+")");h=new J;h.initFromNode(z,e[0],a,n[0],b);if(g=h.styleAttrs[r.byName.backgroundImage.qname])h.contents.push(new D(g)),delete h.styleAttrs[r.byName.backgroundImage.qname];
e[0].contents.push(h);e.unshift(h)}else"image"===a.local?(e[0]instanceof J||M(b,"Parent of <image> element is not <div> at "+this.line+","+this.column+")"),h=new D,h.initFromNode(z,e[0],a,n[0],b),e[0].contents.push(h),e.unshift(h)):"p"===a.local?(e[0]instanceof J||M(b,"Parent of <p> element is not <div> at "+this.line+","+this.column+")"),h=new L,h.initFromNode(z,e[0],a,n[0],b),e[0].contents.push(h),e.unshift(h)):"span"===a.local?(e[0]instanceof I||e[0]instanceof L||M(b,"Parent of <span> element is not <span> or <p> at "+
this.line+","+this.column+")"),h=new I,h.initFromNode(z,e[0],a,n[0],u[0],b),e[0].contents.push(h),e.unshift(h)):"br"===a.local?(e[0]instanceof I||e[0]instanceof L||M(b,"Parent of <br> element is not <span> or <p> at "+this.line+","+this.column+")"),h=new N,h.initFromNode(z,e[0],a,n[0],b),e[0].contents.push(h),e.unshift(h)):"set"===a.local?(e[0]instanceof I||e[0]instanceof L||e[0]instanceof J||e[0]instanceof K||e[0]instanceof k||e[0]instanceof N||M(b,"Parent of <set> element is not a content element or a region at "+
...
e;e=O(a,m.ns_ttp,"timeBase");null!==e&&"media"!==e&&M(b,"Unsupported time base");a=Z(a,b);null===a?this.pxLength={h:null,w:null}:("px"===a.h.unit&&"px"===a.w.unit||M(b,"Extent on TT must be in px or absent"),this.pxLength={h:new l.ComputedLength(0,1/a.h.value),w:new l.ComputedLength(1/a.w.value,0)});this.dimensions={h:new l.ComputedLength(0,1),w:new l.ComputedLength(1,0)};this.lang=d};y.prototype._registerEvent=function(a){if(!(a.end<=a.begin)){var d=Y(this.events,a.begin);d.found||this.events.splice(d.index,
0,a.begin);a.end!==Number.POSITIVE_INFINITY&&(d=Y(this.events,a.end),d.found||this.events.splice(d.index,0,a.end))}};y.prototype.getMediaTimeRange=function(){return[this.events[0],this.events[this.events.length-1]]};y.prototype.getMediaTimeEvents=function(){return this.events};p.prototype.initFromNode=function(a,d){this.id=e(a);this.styleAttrs=S(a,d);this.styleRefs=g(a)};v.prototype.initFromNode=function(a,d){this.styleAttrs={};for(var b in a.attributes)!a.attributes.hasOwnProperty(b)||a.attributes[b].uri!==
m.ns_itts&&a.attributes[b].uri!==m.ns_ebutts&&a.attributes[b].uri!==m.ns_tts||(this.styleAttrs[a.attributes[b].uri+" "+a.attributes[b].local]=a.attributes[b].value)};D.prototype.initFromNode=function(a,b,c,e,f){(this.src="src"in c.attributes?c.attributes.src.value:null)||P(f,"Invalid image@src attribute");(this.type="type"in c.attributes?c.attributes.type.value:null)||P(f,"Invalid image@type attribute");u.prototype.initFromNode.call(this,a,b,c,f);z.prototype.initFromNode.call(this,a,b,c,f);n.prototype.initFromNode.call(this,
a,b,c,f);d.prototype.initFromNode.call(this,a,b,c,f);this.lang=e};H.prototype.initFromNode=function(a,d,b,c){this.id=e(b)};d.prototype.initFromNode=function(a,d,b,c){this.regionID=b&&"region"in b.attributes?b.attributes.region.value:""};u.prototype.initFromNode=function(a,d,b,c){this.styleAttrs=S(b,c);null!==a.head&&null!==a.head.styling&&V(a.head.styling,g(b),this.styleAttrs,c)};n.prototype.initFromNode=function(a,d,b,c){this.sets=[]};f.prototype.initFromNode=function(a,d,b,c){this.contents=[]};
z.prototype.initFromNode=function(a,d,b,c){d=null;b&&"begin"in b.attributes&&(d=U(a.tickRate,a.effectiveFrameRate,b.attributes.begin.value),null===d&&Q(c,"Malformed begin value "+b.attributes.begin.value+" (using 0)"));var f=null;b&&"dur"in b.attributes&&(f=U(a.tickRate,a.effectiveFrameRate,b.attributes.dur.value),null===f&&Q(c,"Malformed dur value "+b.attributes.dur.value+" (ignoring)"));var e=null;b&&"end"in b.attributes&&(e=U(a.tickRate,a.effectiveFrameRate,b.attributes.end.value),null===e&&Q(c,
"Malformed end value (ignoring)"));this.explicit_begin=d;this.explicit_end=e;this.explicit_dur=f;(a=b&&"timeContainer"in b.attributes?b.attributes.timeContainer.value:null)&&"par"!==a?"seq"===a?c="seq":(P(c,"Illegal value of timeContainer (assuming 'par')"),c="par"):c="par";this.timeContainer=c};K.prototype.initFromNode=function(a,b,c,e){u.prototype.initFromNode.call(this,a,null,b,e);z.prototype.initFromNode.call(this,a,null,b,e);n.prototype.initFromNode.call(this,a,null,b,e);d.prototype.initFromNode.call(this,
a,null,b,e);f.prototype.initFromNode.call(this,a,null,b,e);this.lang=c};J.prototype.initFromNode=function(a,b,c,e,g){u.prototype.initFromNode.call(this,a,b,c,g);z.prototype.initFromNode.call(this,a,b,c,g);n.prototype.initFromNode.call(this,a,b,c,g);d.prototype.initFromNode.call(this,a,b,c,g);f.prototype.initFromNode.call(this,a,b,c,g);this.lang=e};L.prototype.initFromNode=function(a,b,c,e,g){u.prototype.initFromNode.call(this,a,b,c,g);z.prototype.initFromNode.call(this,a,b,c,g);n.prototype.initFromNode.call(this,
a,b,c,g);d.prototype.initFromNode.call(this,a,b,c,g);f.prototype.initFromNode.call(this,a,b,c,g);this.lang=e};I.prototype.initFromNode=function(a,b,c,e,g,k){u.prototype.initFromNode.call(this,a,b,c,k);z.prototype.initFromNode.call(this,a,b,c,k);n.prototype.initFromNode.call(this,a,b,c,k);d.prototype.initFromNode.call(this,a,b,c,k);f.prototype.initFromNode.call(this,a,b,c,k);this.space=g;this.lang=e};C.prototype.initFromText=function(a,d,b,c,e,f){z.prototype.initFromNode.call(this,a,d,null,f);this.text=
...
ttp:"http://www.w3.org/ns/ttml#parameter",tts:"http://www.w3.org/ns/ttml#styling",xml:"http://www.w3.org/XML/1998/namespace"},prefix:"",local:"region",uri:"http://www.w3.org/ns/ttml",isSelfClosing:!0},d);b.sets=[];z.call(b,0,Number.POSITIVE_INFINITY,null);this.lang=a.xmllang;return b};k.prototype.initFromNode=function(a,d,b,c){H.prototype.initFromNode.call(this,a,null,d,c);z.prototype.initFromNode.call(this,a,null,d,c);n.prototype.initFromNode.call(this,a,null,d,c);this.styleAttrs=S(d,c);this.styleRefs=
...
"none"!==b.style&&(d.textEmphasis=!0),m.byName.textCombine.qname in c.styleAttrs&&"all"===c.styleAttrs[m.byName.textCombine.qname])h.textContent=c.text,b&&y(d,h,c,b);else for(f="",n=0;n<c.text.length;n++){f+=c.text.charAt(n);var u=c.text.charCodeAt(n);if(55296>u||56319<u||n===c.text.length-1)u=document.createElement("span"),u.textContent=f,b&&y(d,u,c,b),h.appendChild(u),f="",u._isd_element=c}for(var q in c.contents)c.contents.hasOwnProperty(q)&&r(d,l,c.contents[q],c);q=[];if((d.lp||d.mra||d.flg||
d.ruby||d.textEmphasis||d.rubyReserve)&&"p"===c.kind){B(d,l,q,null);if(d.rubyReserve){for(b=0;b<q.length;b++){f=document.createElement("ruby");n=document.createElement("rb");n.textContent="\u200b";f.appendChild(n);var p=d.rubyReserve[1].toUsedLength(d.w,d.h)+"px";"both"===d.rubyReserve[0]||"outside"===d.rubyReserve[0]&&1==q.length?(n=document.createElement("rtc"),n.style[A]=G?"after":"under",n.textContent="\u200b",n.style.fontSize=p,u=document.createElement("rtc"),u.style[A]=G?"before":"over",u.textContent=
"\u200b",u.style.fontSize=p,f.appendChild(n),f.appendChild(u)):(n=document.createElement("rtc"),n.textContent="\u200b",n.style.fontSize=p,n.style[A]="after"===d.rubyReserve[0]||"outside"===d.rubyReserve[0]&&0<b?G?"after":"tb"===d.bpd||"rl"===d.bpd?"under":"over":G?"before":"tb"===d.bpd||"rl"===d.bpd?"over":"under",f.appendChild(n));n=null;for(u=0;u<q[b].rbc.length;u++)if("ruby"===q[b].rbc[u].localName){n=q[b].rbc[u];for(u=0;u<n.style.length;u++)f.style.setProperty(n.style.item(u),n.style.getPropertyValue(n.style.item(u)));
break}n=n||q[b].elements[0].node;n.parentElement.insertBefore(f,n)}d.rubyReserve=null}if(d.ruby||d.rubyReserve){for(b=0;b<q.length;b++)for(f=0;f<q[b].rbc.length;f++)q[b].rbc[f].style[A]||(q[b].rbc[f].style[A]=G?0===b?"before":"after":"tb"===d.bpd?0===b?"over":"under":"rl"===d.bpd?0===b?"over":"under":0===b?"under":"over");d.ruby=null}if(d.textEmphasis){for(b=0;b<q.length;b++)for(f=0;f<q[b].te.length;f++)q[b].te[f].style[H]&&"none"!==q[b].te[f].style[H]||(q[b].te[f].style[H]="tb"===d.bpd?0===b?"left over":
...
b.localName?0<c.length&&c[c.length-1].rbc.push(b):"span"===b.localName&&b.style[D]&&"none"!==b.style[D]&&0<c.length&&c[c.length-1].te.push(b)),b=b.nextSibling}function y(a,b,c,f){"none"!==f.style&&(b.style[D]="auto"===f.style?"filled":f.style+" "+f.symbol,"before"===f.position||"after"===f.position)&&(b.style[H]="tb"===a.bpd?"before"===f.position?"left over":"left under":"rl"===a.bpd?"before"===f.position?"right under":"left under":"before"===f.position?"left under":"right under")}function q(a,b){this.qname=
a;this.map=b}b.render=function(a,b,c,f,m,w,l,y,q,x){f=f||b.clientHeight;var d=m||b.clientWidth;null!==a.aspectRatio&&(m=f*a.aspectRatio,m>d?f=Math.round(d/a.aspectRatio):d=m);m=document.createElement("div");m.style.position="relative";m.style.width=d+"px";m.style.height=f+"px";m.style.margin="auto";m.style.top=0;m.style.bottom=0;m.style.left=0;m.style.right=0;m.style.zIndex=0;c={h:f,w:d,regionH:null,regionW:null,imgResolver:c,displayForcedOnlyMode:w||!1,isd:a,errorHandler:l,previousISDState:y,enableRollUp:q||
!1,currentISDState:{},flg:null,lp:null,mra:null,ipd:null,bpd:null,ruby:null,textEmphasis:null,rubyReserve:null,options:Object.assign({},x)||{}};c.options.colorAdjust&&(c.options.colorAdjust=h(c.options.colorAdjust));w=["region","body","div","p","span"];for(var k in w)w.hasOwnProperty(k)&&(l=w[k]+"BackgroundColorAdjust",c.options[l]&&(c.options[l]=h(c.options[l])));b.appendChild(m);for(var n in a.contents)a.contents.hasOwnProperty(n)&&r(c,m,a.contents[n],a);return c.currentISDState};var x=[new q("http://www.w3.org/ns/ttml#styling backgroundColor",
...
new q("http://www.w3.org/ns/ttml#styling position",function(a,b,c,f){b.style.top=f.h.toUsedLength(a.w,a.h)+"px";b.style.left=f.w.toUsedLength(a.w,a.h)+"px"}),new q("http://www.w3.org/ns/ttml#styling rubyAlign",function(a,b,c,f){b.style.rubyAlign="spaceAround"===f?"space-around":"center"}),new q("http://www.w3.org/ns/ttml#styling rubyPosition",function(a,b,c,f){if("before"===f||"after"===f)b.parentElement.style[A]=G?f:"tb"===a.bpd?"before"===f?"over":"under":"rl"===a.bpd?"before"===f?"over":"under":
...
h.push("-1px 1px 1px "+c),h.push("1px -1px 1px "+c),h.push("-1px -1px 1px "+c));if("none"!==f)for(var n in f)f.hasOwnProperty(n)&&h.push(f[n].x_off.toUsedLength(a.w,a.h)+"px "+f[n].y_off.toUsedLength(a.w,a.h)+"px "+f[n].b_radius.toUsedLength(a.w,a.h)+"px rgba("+f[n].color[0].toString()+","+f[n].color[1].toString()+","+f[n].color[2].toString()+","+(f[n].color[3]/255).toString()+")");b.style.textShadow=h.join(",")}}),new q("http://www.w3.org/ns/ttml#styling textCombine",function(a,b,c,f){b.style.textCombineUpright=
...
p;for(p in x)x.hasOwnProperty(p);var G="webkitRubyPosition"in window.getComputedStyle(document.documentElement),A=G?"webkitRubyPosition":"rubyPosition",D="webkitTextEmphasisStyle"in window.getComputedStyle(document.documentElement)?"webkitTextEmphasisStyle":"textEmphasisStyle",H="webkitTextEmphasisPosition"in window.getComputedStyle(document.documentElement)?"webkitTextEmphasisPosition":"textEmphasisPosition"})("undefined"===typeof l?this.imscHTML={}:l,"undefined"===typeof imscNames?c("./names"):
imscNames,"undefined"===typeof imscStyles?c("./styles"):imscStyles,"undefined"===typeof imscUtils?c("./utils"):imscUtils)},{"./names":37,"./styles":38,"./utils":39}],35:[function(c,p,l){(function(b,c,m,l){function h(b,c,p,B,v,H,d,u,n){if(c<d.begin||c>=d.end)return null;H="regionID"in d&&""!==d.regionID?d.regionID:H;if(null!==v&&H!==p.id&&(!("contents"in d)||"contents"in d&&0===d.contents.length||""!==H))return null;var f=new y(d);for(x in d.sets)!d.sets.hasOwnProperty(x)||c<d.sets[x].begin||c>=d.sets[x].end||
(f.styleAttrs[d.sets[x].qname]=d.sets[x].value);var x={};for(var A in f.styleAttrs)if(f.styleAttrs.hasOwnProperty(A)&&(x[A]=!0,"region"===f.kind&&A===m.byName.writingMode.qname&&!(m.byName.direction.qname in f.styleAttrs))){var D=f.styleAttrs[A];if("lrtb"===D||"lr"===D)f.styleAttrs[m.byName.direction.qname]="ltr";else if("rltb"===D||"rl"===D)f.styleAttrs[m.byName.direction.qname]="rtl"}if(null!==v)for(var F in m.all)if(m.all.hasOwnProperty(F))if(A=m.all[F],A.qname===m.byName.textDecoration.qname){D=
v.styleAttrs[A.qname];var G=f.styleAttrs[A.qname],C=[];void 0===G?C=D:-1===G.indexOf("none")?((-1===G.indexOf("noUnderline")&&-1!==D.indexOf("underline")||-1!==G.indexOf("underline"))&&C.push("underline"),(-1===G.indexOf("noLineThrough")&&-1!==D.indexOf("lineThrough")||-1!==G.indexOf("lineThrough"))&&C.push("lineThrough"),(-1===G.indexOf("noOverline")&&-1!==D.indexOf("overline")||-1!==G.indexOf("overline"))&&C.push("overline")):C.push("none");f.styleAttrs[A.qname]=C}else A.qname!==m.byName.fontSize.qname||
A.qname in f.styleAttrs||"span"!==f.kind||"textContainer"!==f.styleAttrs[m.byName.ruby.qname]?A.qname!==m.byName.fontSize.qname||A.qname in f.styleAttrs||"span"!==f.kind||"text"!==f.styleAttrs[m.byName.ruby.qname]?A.inherit&&A.qname in v.styleAttrs&&!(A.qname in f.styleAttrs)&&(f.styleAttrs[A.qname]=v.styleAttrs[A.qname]):(D=v.styleAttrs[m.byName.fontSize.qname],f.styleAttrs[A.qname]="textContainer"===v.styleAttrs[m.byName.ruby.qname]?D:new l.ComputedLength(.5*D.rw,.5*D.rh)):(D=v.styleAttrs[m.byName.fontSize.qname],
f.styleAttrs[A.qname]=new l.ComputedLength(.5*D.rw,.5*D.rh));for(var E in m.all)if(m.all.hasOwnProperty(E)&&(F=m.all[E],!(F.qname in f.styleAttrs||F.qname===m.byName.position.qname&&m.byName.origin.qname in f.styleAttrs||F.qname===m.byName.origin.qname&&m.byName.position.qname in f.styleAttrs)&&(A=b.head.styling.initials[F.qname]||F.initial,null!==A&&("region"===f.kind||!1===F.inherit&&null!==A))))if(A=F.parse(A),null!==A)f.styleAttrs[F.qname]=A,x[F.qname]=!0;else if(F="Invalid initial value for '"+
F.qname+"' on element '"+f.kind,u&&u.error&&u.error(F))throw F;for(var k in m.all)if(m.all.hasOwnProperty(k)&&(E=m.all[k],E.qname in x&&null!==E.compute))if(F=E.compute(b,v,f,f.styleAttrs[E.qname],n),null!==F)f.styleAttrs[E.qname]=F;else if(f.styleAttrs[E.qname]=E.compute(b,v,f,E.parse(E.initial),n),E="Style '"+E.qname+"' on element '"+f.kind+"' cannot be computed",u&&u.error&&u.error(E))throw E;if("none"===f.styleAttrs[m.byName.display.qname])return null;if(null===v)var t=null===B?[]:[B];else"contents"in
d&&(t=d.contents);for(var e in t)t.hasOwnProperty(e)&&(v=h(b,c,p,B,f,H,t[e],u,n),null!==v&&f.contents.push(v.element));for(var g in f.styleAttrs)f.styleAttrs.hasOwnProperty(g)&&(b=!1,"span"===f.kind&&(c=f.styleAttrs[m.byName.ruby.qname],(b=("container"===c||"textContainer"===c||"baseContainer"===c)&&-1!==q.indexOf(g))||(b="container"!==c&&g===m.byName.rubyAlign.qname),b||(b=!("textContainer"===c||"text"===c)&&g===m.byName.rubyPosition.qname)),b||(b=-1===m.byQName[g].applies.indexOf(f.kind)),b&&delete f.styleAttrs[g]);
g=f.styleAttrs[m.byName.ruby.qname];if("p"===f.kind||"span"===f.kind&&("textContainer"===g||"text"===g))g=[],a(f,g),r(g),w(f);return"div"===f.kind&&m.byName.backgroundImage.qname in f.styleAttrs||"br"===f.kind||"image"===f.kind||"contents"in f&&0<f.contents.length||"span"===f.kind&&null!==f.text||"region"===f.kind&&"always"===f.styleAttrs[m.byName.showBackground.qname]?{region_id:H,element:f}:null}function r(a){function b(a){return"br"===a.kind||/[\r\n\t ]$/.test(a.text)}function c(a){return"br"===
...
b.contents.filter(d).forEach(function(b){b=w(a,b);b.regionID&&(q[b.regionID]=!0);null!==b&&c.contents.push(b)});return c}return b}var l=new p(a),y={},d={},q={};initialShowBackground=a.head.styling.initials[m.byName.showBackground.qname];initialbackgroundColor=a.head.styling.initials[m.byName.backgroundColor.qname];initialbackgroundImage=a.head.styling.initials[m.byName.backgroundImage.qname];for(var n in a.head.layout.regions)a.head.layout.regions.hasOwnProperty(n)&&(region=a.head.layout.regions[n],
showBackground=region.styleAttrs[m.byName.showBackground.qname]||initialShowBackground,backgroundColor=region.styleAttrs[m.byName.backgroundColor.qname]||initialbackgroundColor,backgroundImage=region.styleAttrs[m.byName.backgroundImage.qname]||initialbackgroundImage,q[region.id]=("always"===showBackground||void 0===showBackground)&&(void 0!==backgroundColor||void 0!==backgroundImage)&&!(b<region.begin||b>=region.end));a.body&&a.body.regionID&&(q[a.body.regionID]=!0);d=null!==a.body?w(b,a.body):null;
1===Object.getOwnPropertyNames(q).length&&void 0!==q[""]&&(q[""]=!0);for(var f in q)q[f]&&(n=h(a,b,a.head.layout.regions[f],d,null,"",a.head.layout.regions[f],c,y),null!==n&&l.contents.push(n.element));return l};var q=[m.byName.color.qname,m.byName.textCombine.qname,m.byName.textDecoration.qname,m.byName.textEmphasis.qname,m.byName.textOutline.qname,m.byName.textShadow.qname]})("undefined"===typeof l?this.imscISD={}:l,"undefined"===typeof imscNames?c("./names"):imscNames,"undefined"===typeof imscStyles?
c("./styles"):imscStyles,"undefined"===typeof imscUtils?c("./utils"):imscUtils)},{"./names":37,"./styles":38,"./utils":39}],36:[function(c,p,l){l.generateISD=c("./isd").generateISD;l.fromXML=c("./doc").fromXML;l.renderHTML=c("./html").render},{"./doc":33,"./html":34,"./isd":35}],37:[function(c,p,l){c="undefined"===typeof l?this.imscNames={}:l;c.ns_tt="http://www.w3.org/ns/ttml";c.ns_tts="http://www.w3.org/ns/ttml#styling";c.ns_ttp="http://www.w3.org/ns/ttml#parameter";c.ns_xml="http://www.w3.org/XML/1998/namespace";
c.ns_itts="http://www.w3.org/ns/ttml/profile/imsc1#styling";c.ns_ittp="http://www.w3.org/ns/ttml/profile/imsc1#parameter";c.ns_smpte="http://www.smpte-ra.org/schemas/2052-1/2010/smpte-tt";c.ns_ebutts="urn:ebu:tt:style";c.ttaf_map={"http://www.w3.org/2006/10/ttaf1":c.ns_tt,"http://www.w3.org/2006/10/ttaf1#style":c.ns_tts,"http://www.w3.org/2006/10/ttaf1#parameter":c.ns_ttp}},{}],38:[function(c,p,l){(function(b,c,m){function h(a,b,c,h,m,l,p,r){this.name=b;this.ns=a;this.qname=a+" "+b;this.inherit=m;
this.animatable=l;this.initial=c;this.applies=h;this.parse=p;this.compute=r}b.all=[new h(c.ns_tts,"backgroundColor","transparent",["body","div","p","region","span"],!1,!0,m.parseColor,null),new h(c.ns_tts,"color","white",["span"],!0,!0,m.parseColor,null),new h(c.ns_tts,"direction","ltr",["p","span"],!0,!0,function(a){return a},null),new h(c.ns_tts,"display","auto",["body","div","p","region","span"],!1,!0,function(a){return a},null),new h(c.ns_tts,"displayAlign","before",["region"],!1,!0,function(a){return a},
null),new h(c.ns_tts,"extent","auto",["tt","region"],!1,!0,function(a){if("auto"===a)return a;var b=a.split(" ");if(2!==b.length)return null;a=m.parseLength(b[0]);return(b=m.parseLength(b[1]))&&a?{h:b,w:a}:null},function(a,b,c,h,l){if("auto"===h)b=new m.ComputedLength(0,1);else if(b=m.toComputedLength(h.h.value,h.h.unit,null,a.dimensions.h,null,a.pxLength.h),null===b)return null;if("auto"===h)a=new m.ComputedLength(1,0);else if(a=m.toComputedLength(h.w.value,h.w.unit,null,a.dimensions.w,null,a.pxLength.w),
null===a)return null;return{h:b,w:a}}),new h(c.ns_tts,"fontFamily","default",["span","p"],!0,!0,function(a){a=a.split(",");for(var b=[],c=0;c<a.length;c++)"'"!==a[c].charAt(0)&&'"'!==a[c].charAt(0)?"default"===a[c]?b.push("monospaceSerif"):b.push(a[c]):b.push(a[c]);return b},null),new h(c.ns_tts,"shear","0%",["p"],!0,!0,m.parseLength,function(a,b,c,h){if("%"===h.unit)a=100<Math.abs(h.value)?100*Math.sign(h.value):h.value;else return null;return a}),new h(c.ns_tts,"fontSize","1c",["span","p"],!0,!0,
m.parseLength,function(a,c,h,l,q){return m.toComputedLength(l.value,l.unit,null!==c?c.styleAttrs[b.byName.fontSize.qname]:a.cellLength.h,null!==c?c.styleAttrs[b.byName.fontSize.qname]:a.cellLength.h,a.cellLength.h,a.pxLength.h)}),new h(c.ns_tts,"fontStyle","normal",["span","p"],!0,!0,function(a){return a},null),new h(c.ns_tts,"fontWeight","normal",["span","p"],!0,!0,function(a){return a},null),new h(c.ns_tts,"lineHeight","normal",["p"],!0,!0,function(a){return"normal"===a?a:m.parseLength(a)},function(a,
c,h,l,q){if("normal"===l)a=l;else if(a=m.toComputedLength(l.value,l.unit,h.styleAttrs[b.byName.fontSize.qname],h.styleAttrs[b.byName.fontSize.qname],a.cellLength.h,a.pxLength.h),null===a)return null;return a}),new h(c.ns_tts,"opacity",1,["region"],!1,!0,parseFloat,null),new h(c.ns_tts,"origin","auto",["region"],!1,!0,function(a){if("auto"===a)return a;var b=a.split(" ");if(2!==b.length)return null;a=m.parseLength(b[0]);return(b=m.parseLength(b[1]))&&a?{h:b,w:a}:null},function(a,b,c,h,l){if("auto"===
h)b=new m.ComputedLength(0,0);else if(b=m.toComputedLength(h.h.value,h.h.unit,null,a.dimensions.h,null,a.pxLength.h),null===b)return null;if("auto"===h)a=new m.ComputedLength(0,0);else if(a=m.toComputedLength(h.w.value,h.w.unit,null,a.dimensions.w,null,a.pxLength.w),null===a)return null;return{h:b,w:a}}),new h(c.ns_tts,"overflow","hidden",["region"],!1,!0,function(a){return a},null),new h(c.ns_tts,"padding","0px",["region"],!1,!0,function(a){a=a.split(" ");if(4<a.length)return null;for(var b=[],c=
0;c<a.length;c++){var h=m.parseLength(a[c]);if(!h)return null;b.push(h)}return b},function(a,c,h,l,q){if(1===l.length)c=[l[0],l[0],l[0],l[0]];else if(2===l.length)c=[l[0],l[1],l[0],l[1]];else if(3===l.length)c=[l[0],l[1],l[2],l[1]];else if(4===l.length)c=[l[0],l[1],l[2],l[3]];else return null;l=h.styleAttrs[b.byName.writingMode.qname];if("lrtb"===l||"lr"===l)c=[c[0],c[3],c[2],c[1]];else if("rltb"===l||"rl"===l)c=[c[0],c[1],c[2],c[3]];else if("tblr"===l)c=[c[3],c[0],c[1],c[2]];else if("tbrl"===l||
"tb"===l)c=[c[3],c[2],c[1],c[0]];else return null;l=[];for(q=0;q<c.length;q++)if(0===c[q].value)l[q]=new m.ComputedLength(0,0);else if(l[q]=m.toComputedLength(c[q].value,c[q].unit,h.styleAttrs[b.byName.fontSize.qname],"0"===q||"2"===q?h.styleAttrs[b.byName.extent.qname].h:h.styleAttrs[b.byName.extent.qname].w,"0"===q||"2"===q?a.cellLength.h:a.cellLength.w,"0"===q||"2"===q?a.pxLength.h:a.pxLength.w),null===l[q])return null;return l}),new h(c.ns_tts,"position","top left",["region"],!1,!0,function(a){return m.parsePosition(a)},
function(a,c,h,l){c=m.toComputedLength(l.v.offset.value,l.v.offset.unit,null,new m.ComputedLength(-h.styleAttrs[b.byName.extent.qname].h.rw,a.dimensions.h.rh-h.styleAttrs[b.byName.extent.qname].h.rh),null,a.pxLength.h);if(null===c)return null;"bottom"===l.v.edge&&(c=new m.ComputedLength(-c.rw-h.styleAttrs[b.byName.extent.qname].h.rw,a.dimensions.h.rh-c.rh-h.styleAttrs[b.byName.extent.qname].h.rh));var q=m.toComputedLength(l.h.offset.value,l.h.offset.unit,null,new m.ComputedLength(a.dimensions.w.rw-
h.styleAttrs[b.byName.extent.qname].w.rw,-h.styleAttrs[b.byName.extent.qname].w.rh),null,a.pxLength.w);if(null===c)return null;"right"===l.h.edge&&(q=new m.ComputedLength(a.dimensions.w.rw-q.rw-h.styleAttrs[b.byName.extent.qname].w.rw,-q.rh-h.styleAttrs[b.byName.extent.qname].w.rh));return{h:c,w:q}}),new h(c.ns_tts,"ruby","none",["span"],!1,!0,function(a){return a},null),new h(c.ns_tts,"rubyAlign","center",["span"],!0,!0,function(a){return"center"!==a&&"spaceAround"!==a?null:a},null),new h(c.ns_tts,
"rubyPosition","outside",["span"],!0,!0,function(a){return a},null),new h(c.ns_tts,"rubyReserve","none",["p"],!0,!0,function(a){var b=a.split(" ");a=[null,null];if(0===b.length||2<b.length||"none"!==b[0]&&"both"!==b[0]&&"after"!==b[0]&&"before"!==b[0]&&"outside"!==b[0])return null;a[0]=b[0];if(2===b.length&&"none"!==b[0])if(b=m.parseLength(b[1]))a[1]=b;else return null;return a},function(a,c,h,l,q){if("none"===l[0])return l;a=null===l[1]?new m.ComputedLength(.5*h.styleAttrs[b.byName.fontSize.qname].rw,
.5*h.styleAttrs[b.byName.fontSize.qname].rh):m.toComputedLength(l[1].value,l[1].unit,h.styleAttrs[b.byName.fontSize.qname],h.styleAttrs[b.byName.fontSize.qname],a.cellLength.h,a.pxLength.h);return null===a?null:[l[0],a]}),new h(c.ns_tts,"showBackground","whenActive",["region"],!1,!0,function(a){return a},null),new h(c.ns_tts,"textAlign","start",["p"],!0,!0,function(a){return a},function(a,b,c,h,m){return"left"===h?"start":"right"===h?"end":h}),new h(c.ns_tts,"textCombine","none",["span"],!0,!0,function(a){return"none"===
a||"all"===a?a:null},null),new h(c.ns_tts,"textDecoration","none",["span"],!0,!0,function(a){return a.split(" ")},null),new h(c.ns_tts,"textEmphasis","none",["span"],!0,!0,function(a){a=a.split(" ");for(var b={style:null,symbol:null,color:null,position:null},c=0;c<a.length;c++)if("none"===a[c]||"auto"===a[c])b.style=a[c];else if("filled"===a[c]||"open"===a[c])b.style=a[c];else if("circle"===a[c]||"dot"===a[c]||"sesame"===a[c])b.symbol=a[c];else if("current"===a[c])b.color=a[c];else if("outside"===
a[c]||"before"===a[c]||"after"===a[c])b.position=a[c];else if(b.color=m.parseColor(a[c]),null===b.color)return null;null==b.style&&null==b.symbol?b.style="auto":(b.symbol=b.symbol||"circle",b.style=b.style||"filled");b.position=b.position||"outside";b.color=b.color||"current";return b},null),new h(c.ns_tts,"textOutline","none",["span"],!0,!0,function(a){if("none"===a)return a;var b={};a=a.split(" ");if(0===a.length||2<a.length)return null;var c=m.parseColor(a[0]);b.color=c;null!==c&&a.shift();if(1!==
a.length)return null;a=m.parseLength(a[0]);if(!a)return null;b.thickness=a;return b},function(a,c,h,l,q){if("none"===l)return l;c={};c.color=null===l.color?h.styleAttrs[b.byName.color.qname]:l.color;c.thickness=m.toComputedLength(l.thickness.value,l.thickness.unit,h.styleAttrs[b.byName.fontSize.qname],h.styleAttrs[b.byName.fontSize.qname],a.cellLength.h,a.pxLength.h);return null===c.thickness?null:c}),new h(c.ns_tts,"textShadow","none",["span"],!0,!0,m.parseTextShadow,function(a,c,h,l){if("none"===
l)return l;c=[];for(var q in l)if(q.hasOwnProperty(l)){var p={};p.x_off=m.toComputedLength(l[q][0].value,l[q][0].unit,null,h.styleAttrs[b.byName.fontSize.qname],null,a.pxLength.w);if(null===p.x_off)return null;p.y_off=m.toComputedLength(l[q][1].value,l[q][1].unit,null,h.styleAttrs[b.byName.fontSize.qname],null,a.pxLength.h);if(null===p.y_off)return null;if(null===l[q][2])p.b_radius=0;else if(p.b_radius=m.toComputedLength(l[q][2].value,l[q][2].unit,null,h.styleAttrs[b.byName.fontSize.qname],null,a.pxLength.h),
null===p.b_radius)return null;p.color=null===l[q][3]?h.styleAttrs[b.byName.color.qname]:l[q][3];c.push(p)}return c}),new h(c.ns_tts,"unicodeBidi","normal",["span","p"],!1,!0,function(a){return a},null),new h(c.ns_tts,"visibility","visible",["body","div","p","region","span"],!0,!0,function(a){return a},null),new h(c.ns_tts,"wrapOption","wrap",["span"],!0,!0,function(a){return a},null),new h(c.ns_tts,"writingMode","lrtb",["region"],!1,!0,function(a){return a},null),new h(c.ns_tts,"zIndex","auto",["region"],
!1,!0,function(a){"auto"!==a&&(a=parseInt(a),isNaN(a)&&(a=null));return a},null),new h(c.ns_ebutts,"linePadding","0c",["p"],!0,!1,m.parseLength,function(a,b,c,h,l){return m.toComputedLength(h.value,h.unit,null,null,a.cellLength.w,null)}),new h(c.ns_ebutts,"multiRowAlign","auto",["p"],!0,!1,function(a){return a},null),new h(c.ns_smpte,"backgroundImage",null,["div"],!1,!1,function(a){return a},null),new h(c.ns_itts,"forcedDisplay","false",["body","div","p","region","span"],!0,!0,function(a){return"true"===
a?!0:!1},null),new h(c.ns_itts,"fillLineGap","true",["p"],!0,!0,function(a){return"true"===a?!0:!1},null)];b.byQName={};for(var l in b.all)b.all.hasOwnProperty(l)&&(b.byQName[b.all[l].qname]=b.all[l]);b.byName={};for(var p in b.all)b.all.hasOwnProperty(p)&&(b.byName[b.all[p].name]=b.all[p])})("undefined"===typeof l?this.imscStyles={}:l,"undefined"===typeof imscNames?c("./names"):imscNames,"undefined"===typeof imscUtils?c("./utils"):imscUtils)},{"./names":37,"./utils":39}],39:[function(c,p,l){(function(b){var c=
/#([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})?/,l=/rgb\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*\)/,p=/rgba\(\s*(\d+),\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*\)/,v={transparent:[0,0,0,0],black:[0,0,0,255],silver:[192,192,192,255],gray:[128,128,128,255],white:[255,255,255,255],maroon:[128,0,0,255],red:[255,0,0,255],purple:[128,0,128,255],fuchsia:[255,0,255,255],magenta:[255,0,255,255],green:[0,128,0,255],lime:[0,255,0,255],olive:[128,128,0,255],yellow:[255,255,0,255],navy:[0,0,128,255],
blue:[0,0,255,255],teal:[0,128,128,255],aqua:[0,255,255,255],cyan:[0,255,255,255]};b.parseColor=function(a){var b,h=null,m=v[a.toLowerCase()];void 0!==m?h=m:null!==(b=c.exec(a))?h=[parseInt(b[1],16),parseInt(b[2],16),parseInt(b[3],16),void 0!==b[4]?parseInt(b[4],16):255]:null!==(b=l.exec(a))?h=[parseInt(b[1]),parseInt(b[2]),parseInt(b[3]),255]:null!==(b=p.exec(a))&&(h=[parseInt(b[1]),parseInt(b[2]),parseInt(b[3]),parseInt(b[4])]);return h};var E=/^((?:\+|\-)?\d*(?:\.\d+)?)(px|em|c|%|rh|rw)$/;b.parseLength=
function(a){var b,c=null;null!==(b=E.exec(a))&&(c={value:parseFloat(b[1]),unit:b[2]});return c};b.parseTextShadow=function(a){a=a.split(",");for(var c=[],h=0;h<a.length;h++){var l=a[h].split(" ");if(1===l.length&&"none"===l[0])return"none";if(1<l.length&&5>l.length){var m=[null,null,null,null],p=b.parseLength(l.shift());if(null===p)return null;m[0]=p;p=b.parseLength(l.shift());if(null===p)return null;m[1]=p;if(0!==l.length&&(p=b.parseLength(l[0]),null!==p&&(m[2]=p,l.shift()),0!==l.length)){l=b.parseColor(l[0]);
if(null===l)return null;m[3]=l}c.push(m)}}return c};b.parsePosition=function(a){a=a.split(" ");var c=function(a){return"center"===a||"left"===a||"top"===a||"bottom"===a||"right"===a};if(4<a.length)return null;for(var h in a)if(a.hasOwnProperty(h)&&!c(a[h])){var l=b.parseLength(a[h]);if(null===l)return null;a[h]=l}h={h:{edge:"left",offset:{value:50,unit:"%"}},v:{edge:"top",offset:{value:50,unit:"%"}}};for(l=0;l<a.length;){var m=a[l++];if(c(m)){var p={value:0,unit:"%"};2!==a.length&&l<a.length&&!c(a[l])&&
(p=a[l++]);"right"===m?(h.h.edge=m,h.h.offset=p):"bottom"===m?(h.v.edge=m,h.v.offset=p):"left"===m?h.h.offset=p:"top"===m&&(h.v.offset=p)}else if(1===a.length||2===a.length)1===l?h.h.offset=m:h.v.offset=m;else return null}return h};b.ComputedLength=function(a,b){this.rw=a;this.rh=b};b.ComputedLength.prototype.toUsedLength=function(a,b){return a*this.rw+b*this.rh};b.ComputedLength.prototype.multiply=function(a,b){return b?a*b:a};b.ComputedLength.prototype.isZero=function(){return 0===this.rw&&0===
this.rh};b.toComputedLength=function(a,c,h,l,m,p){return"%"===c&&l?new b.ComputedLength(l.rw*a/100,l.rh*a/100):"em"===c&&h?new b.ComputedLength(h.rw*a,h.rh*a):"c"===c&&m?new b.ComputedLength(a*m.rw,a*m.rh):"px"===c&&p?new b.ComputedLength(a*p.rw,a*p.rh):"rh"===c?new b.ComputedLength(0,a/100):"rw"===c?new b.ComputedLength(a/100,0):null}})("undefined"===typeof l?this.imscUtils={}:l)},{}]},{},[36])(36)});
