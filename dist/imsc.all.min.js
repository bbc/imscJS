...
0;d>>>=0;if(a<=d)return"";for(f||(f="utf8");;)switch(f){case "hex":f=d;d=a;a=this.length;if(!f||0>f)f=0;if(!d||0>d||d>a)d=a;n="";for(a=f;a<d;++a)f=n,n=this[a],n=16>n?"0"+n.toString(16):n.toString(16),n=f+n;return n;case "utf8":case "utf-8":return C(this,d,a);case "ascii":f="";for(a=Math.min(this.length,a);d<a;++d)f+=String.fromCharCode(this[d]&127);return f;case "latin1":case "binary":f="";for(a=Math.min(this.length,a);d<a;++d)f+=String.fromCharCode(this[d]);return f;case "base64":return d=0===d&&
a===this.length?H.fromByteArray(this):H.fromByteArray(this.slice(d,a)),d;case "ucs2":case "ucs-2":case "utf16le":case "utf-16le":d=this.slice(d,a);a="";for(f=0;f<d.length;f+=2)a+=String.fromCharCode(d[f]+256*d[f+1]);return a;default:if(n)throw new TypeError("Unknown encoding: "+f);f=(f+"").toLowerCase();n=!0}}function t(f,d,a){var n=f[d];f[d]=f[a];f[a]=n}function D(f,d,b,n,l){if(0===f.length)return-1;"string"===typeof b?(n=b,b=0):2147483647<b?b=2147483647:-2147483648>b&&(b=-2147483648);b=+b;b!==b&&
...
k?d[f]:d.readUInt16BE(f*k)}var k=1,h=f.length,e=d.length;if(void 0!==n&&(n=String(n).toLowerCase(),"ucs2"===n||"ucs-2"===n||"utf16le"===n||"utf-16le"===n)){if(2>f.length||2>d.length)return-1;k=2;h/=2;e/=2;a/=2}if(b)for(n=-1;a<h;a++)if(l(f,a)===l(d,-1===n?0:a-n)){if(-1===n&&(n=a),a-n+1===e)return n*k}else-1!==n&&(a-=a-n),n=-1;else for(a+e>h&&(a=h-e);0<=a;a--){h=!0;for(n=0;n<e;n++)if(l(f,a+n)!==l(d,n)){h=!1;break}if(h)return a}return-1}function C(f,d,a){a=Math.min(f.length,a);for(var n=[];d<a;){var b=
...
function(f,d,a){return D(this,f,d,a,!0)};a.prototype.lastIndexOf=function(f,d,a){return D(this,f,d,a,!1)};a.prototype.write=function(f,d,a,n){if(void 0===d)n="utf8",a=this.length,d=0;else if(void 0===a&&"string"===typeof d)n=d,a=this.length,d=0;else if(isFinite(d))d>>>=0,isFinite(a)?(a>>>=0,void 0===n&&(n="utf8")):(n=a,a=void 0);else throw Error("Buffer.write(string, encoding, offset[, length]) is no longer supported");var b=this.length-d;if(void 0===a||a>b)a=b;if(0<f.length&&(0>a||0>d)||d>this.length)throw new RangeError("Attempt to write outside buffer bounds");
...
var D=Number.isNaN||function(a){return a!==a};u.exports=q;u.exports.once=function(a,b){return new Promise(function(e,c){function l(l){a.removeListener(b,g);c(l)}function g(){"function"===typeof a.removeListener&&a.removeListener("error",l);e([].slice.call(arguments))}k(a,b,g,{once:!0});"error"!==b&&r(a,l,{once:!0})})};q.EventEmitter=q;q.prototype._events=void 0;q.prototype._eventsCount=0;q.prototype._maxListeners=void 0;var F=10;Object.defineProperty(q,"defaultMaxListeners",{enumerable:!0,get:function(){return F},
set:function(a){if("number"!==typeof a||0>a||D(a))throw new RangeError('The value of "defaultMaxListeners" is out of range. It must be a non-negative number. Received '+a+".");F=a}});q.init=function(){if(void 0===this._events||this._events===Object.getPrototypeOf(this)._events)this._events=Object.create(null),this._eventsCount=0;this._maxListeners=this._maxListeners||void 0};q.prototype.setMaxListeners=function(a){if("number"!==typeof a||0>a||D(a))throw new RangeError('The value of "n" is out of range. It must be a non-negative number. Received '+
...
a.resume()}function C(a){A("readable nexttick read 0");a.read(0)}function z(a,b){A("resume",b.reading);b.reading||a.read(0);b.resumeScheduled=!1;a.emit("resume");E(a);b.flowing&&!b.reading&&a.read(0)}function E(a){var b=a._readableState;for(A("flow",b.flowing);b.flowing&&null!==a.read(););}function G(a,b){if(0===b.length)return null;b.objectMode?a=b.buffer.shift():!a||a>=b.length?(a=b.decoder?b.buffer.join(""):1===b.buffer.length?b.buffer.first():b.buffer.concat(b.length),b.buffer.clear()):a=b.buffer.consume(a,
...
this.resume()):"readable"!==a||d.endEmitted||d.readableListening||(d.readableListening=d.needReadable=!0,d.flowing=!1,d.emittedReadable=!1,A("on readable",d.length,d.reading),d.length?r(this):d.reading||q.nextTick(C,this));return b};e.prototype.addListener=e.prototype.on;e.prototype.removeListener=function(a,b){b=N.prototype.removeListener.call(this,a,b);"readable"===a&&q.nextTick(F,this);return b};e.prototype.removeAllListeners=function(a){var b=N.prototype.removeAllListeners.apply(this,arguments);
...
inherits:21,"util-deprecate":26}],12:[function(c,u,m){(function(q){(function(){function g(a,b,k){b in a?Object.defineProperty(a,b,{value:k,enumerable:!0,configurable:!0,writable:!0}):a[b]=k;return a}function a(a,b){return{value:a,done:b}}function w(b){var l=b[r];if(null!==l){var e=b[C].read();null!==e&&(b[m]=null,b[r]=null,b[k]=null,l(a(e,!1)))}}function e(a){q.nextTick(w,a)}function x(b,l){return function(k,e){b.then(function(){if(l[t])k(a(void 0,!0));else l[F](k,e)},e)}}var b,p=c("./end-of-stream"),
r=Symbol("lastResolve"),k=Symbol("lastReject"),y=Symbol("error"),t=Symbol("ended"),m=Symbol("lastPromise"),F=Symbol("handlePromise"),C=Symbol("stream"),z=Object.getPrototypeOf(function(){}),E=Object.setPrototypeOf((b={get stream(){return this[C]},next:function(){var b=this,l=this[y];if(null!==l)return Promise.reject(l);if(this[t])return Promise.resolve(a(void 0,!0));if(this[C].destroyed)return new Promise(function(l,k){q.nextTick(function(){b[y]?k(b[y]):l(a(void 0,!0))})});if(l=this[m])l=new Promise(x(l,
this));else{l=this[C].read();if(null!==l)return Promise.resolve(a(l,!1));l=new Promise(this[F])}return this[m]=l}},g(b,Symbol.asyncIterator,function(){return this}),g(b,"return",function(){var b=this;return new Promise(function(l,k){b[C].destroy(null,function(b){b?k(b):l(a(void 0,!0))})})}),b),z);u.exports=function(b){var l,c=Object.create(E,(l={},g(l,C,{value:b,writable:!0}),g(l,r,{value:null,writable:!0}),g(l,k,{value:null,writable:!0}),g(l,y,{value:null,writable:!0}),g(l,t,{value:b._readableState.endEmitted,
writable:!0}),g(l,F,{value:function(b,l){var e=c[C].read();e?(c[m]=null,c[r]=null,c[k]=null,b(a(e,!1))):(c[r]=b,c[k]=l)},writable:!0}),l));c[m]=null;p(b,function(b){if(b&&"ERR_STREAM_PREMATURE_CLOSE"!==b.code){var l=c[k];null!==l&&(c[m]=null,c[r]=null,c[k]=null,l(b));c[y]=b}else b=c[r],null!==b&&(c[m]=null,c[r]=null,c[k]=null,b(a(void 0,!0))),c[t]=!0});b.on("readable",e.bind(null,c));return c}}).call(this)}).call(this,c("_process"))},{"./end-of-stream":15,_process:22}],13:[function(c,u,m){function q(a,
...
typeof c)return a(e,null,c);c||(c={});b=q(b||g);var p=c.readable||!1!==c.readable&&e.readable,r=c.writable||!1!==c.writable&&e.writable,k=function(){e.writable||t()},m=e._writableState&&e._writableState.finished,t=function(){r=!1;m=!0;p||b.call(e)},x=e._readableState&&e._readableState.endEmitted,F=function(){p=!1;x=!0;r||b.call(e)},C=function(a){b.call(e,a)},z=function(){var a;if(p&&!x)return e._readableState&&e._readableState.ended||(a=new w),b.call(e,a);if(r&&!m)return e._writableState&&e._writableState.ended||
(a=new w),b.call(e,a)},u=function(){e.req.on("finish",t)};if(e.setHeader&&"function"===typeof e.abort)if(e.on("complete",t),e.on("abort",z),e.req)u();else e.on("request",u);else r&&!e._writableState&&(e.on("end",k),e.on("close",k));e.on("end",F);e.on("finish",t);if(!1!==c.error)e.on("error",C);e.on("close",z);return function(){e.removeListener("complete",t);e.removeListener("abort",z);e.removeListener("request",u);e.req&&e.req.removeListener("finish",t);e.removeListener("end",k);e.removeListener("close",
k);e.removeListener("finish",t);e.removeListener("end",F);e.removeListener("error",C);e.removeListener("close",z)}}var w=c("../../../errors").codes.ERR_STREAM_PREMATURE_CLOSE;u.exports=a},{"../../../errors":6}],16:[function(c,u,m){u.exports=function(){throw Error("Readable.from is not available in the browser");}},{}],17:[function(c,u,m){function q(a){var b=!1;return function(){b||(b=!0,a.apply(void 0,arguments))}}function g(a){if(a)throw a;}function a(a,b,e,g){g=q(g);var k=!1;a.on("close",function(){k=
...
}function g(){throw Error("clearTimeout has not been defined");}function a(a){if(r===setTimeout)return setTimeout(a,0);if((r===q||!r)&&setTimeout)return r=setTimeout,setTimeout(a,0);try{return r(a,0)}catch(z){try{return r.call(null,a,0)}catch(E){return r.call(this,a,0)}}}function w(a){if(k===clearTimeout)return clearTimeout(a);if((k===g||!k)&&clearTimeout)return k=clearTimeout,clearTimeout(a);try{return k(a)}catch(z){try{return k.call(null,a)}catch(E){return k.call(this,a)}}}function e(){t&&D&&(t=
!1,D.length?y=D.concat(y):F=-1,y.length&&x())}function x(){if(!t){var b=a(e);t=!0;for(var c=y.length;c;){D=y;for(y=[];++F<c;)D&&D[F].run();F=-1;c=y.length}D=null;t=!1;w(b)}}function b(a,b){this.fun=a;this.array=b}function p(){}c=u.exports={};try{var r="function"===typeof setTimeout?setTimeout:q}catch(C){r=q}try{var k="function"===typeof clearTimeout?clearTimeout:g}catch(C){k=g}var y=[],t=!1,D,F=-1;c.nextTick=function(c){var k=Array(arguments.length-1);if(1<arguments.length)for(var e=1;e<arguments.length;e++)k[e-
...
a.line+"\nColumn: "+a.column+"\nChar: "+a.c);b=Error(b);a.error=b;a.onerror&&a.onerror(b);return a}function y(b){b.sawRoot&&!b.closedRoot&&t(b,"Unclosed root tag");b.state!==d.BEGIN&&b.state!==d.BEGIN_WHITESPACE&&b.state!==d.TEXT&&k(b,"Unexpected end");p(b);b.c="";b.closed=!0;b.onend&&b.onend(void 0);a.call(b,b.strict,b.opt);return b}function t(b,d){if("object"!==typeof b||!(b instanceof a))throw Error("bad call to strictFail");b.strict&&k(b,d)}function D(a,b){var d=0>a.indexOf(":")?["",a]:a.split(":"),
f=d[0];d=d[1];b&&"xmlns"===a&&(f="xmlns",d="");return{prefix:f,local:d}}function F(a){a.strict||(a.attribName=a.attribName[a.looseCase]());if(-1===a.attribList.indexOf(a.attribName)&&!a.tag.attributes.hasOwnProperty(a.attribName))if(a.opt.xmlns){var d=D(a.attribName,!0),f=d.local;if("xmlns"===d.prefix)if("xml"===f&&a.attribValue!==P)t(a,"xml: prefix must be bound to "+P+"\nActual: "+a.attribValue);else if("xmlns"===f&&a.attribValue!==H)t(a,"xmlns: prefix must be bound to "+H+"\nActual: "+a.attribValue);
else{d=a.tag;var l=a.tags[a.tags.length-1]||a;d.ns===l.ns&&(d.ns=Object.create(l.ns));d.ns[f]=a.attribValue}a.attribList.push([a.attribName,a.attribValue])}else a.tag.attributes[a.attribName]=a.attribValue,b(a,"onattribute",{name:a.attribName,value:a.attribValue});a.attribName=a.attribValue=""}function C(a,f){if(a.opt.xmlns){var l=a.tag,c=D(a.tagName);l.prefix=c.prefix;l.local=c.local;l.uri=l.ns[c.prefix]||"";l.prefix&&!l.uri&&(t(a,"Unbound namespace prefix: "+JSON.stringify(a.tagName)),l.uri=c.prefix);
c=a.tags[a.tags.length-1]||a;l.ns&&c.ns!==l.ns&&Object.keys(l.ns).forEach(function(d){b(a,"onopennamespace",{prefix:d,uri:l.ns[d]})});c=0;for(var k=a.attribList.length;c<k;c++){var e=a.attribList[c],g=e[0],h=e[1],n=D(g,!0);e=n.prefix;var p=""===e?"":l.ns[e]||"";h={name:g,value:h,prefix:e,local:n.local,uri:p};e&&"xmlns"!==e&&!p&&(t(a,"Unbound namespace prefix: "+JSON.stringify(e)),h.uri=e);a.tag.attributes[g]=h;b(a,"onattribute",h)}a.attribList.length=0}a.tag.isSelfClosing=!!f;a.sawRoot=!0;a.tags.push(a.tag);
...
c("buffer").Buffer)},{buffer:3,stream:5,string_decoder:25}],25:[function(c,u,m){function q(a){if(!a)return"utf8";for(var b;;)switch(a){case "utf8":case "utf-8":return"utf8";case "ucs2":case "ucs-2":case "utf16le":case "utf-16le":return"utf16le";case "latin1":case "binary":return"latin1";case "base64":case "ascii":case "hex":return a;default:if(b)return;a=(""+a).toLowerCase();b=!0}}function g(a){var c=q(a);if("string"!==typeof c&&(t.isEncoding===D||!D(a)))throw Error("Unknown encoding: "+a);this.encoding=
...
b.explicit_end&&null===b.explicit_dur?c+b.explicit_end:d;delete b.explicit_begin;delete b.explicit_dur;delete b.explicit_end;a._registerEvent(b)}function r(a){this.node=a}function k(){this.events=[];this.head=new w;this.body=null}function w(){this.styling=new t;this.layout=new C}function t(){this.styles={};this.initials={}}function u(){this.styleRefs=this.styleAttrs=this.id=null}function F(){this.styleAttrs=null}function C(){this.regions={}}function z(a,b){this.kind="image";this.src=a;this.type=b}
...
B.prototype.initFromNode=function(a,b,d,f){b=null;d&&"begin"in d.attributes&&(b=U(a.tickRate,a.effectiveFrameRate,d.attributes.begin.value),null===b&&R(f,"Malformed begin value "+d.attributes.begin.value+" (using 0)"));var h=null;d&&"dur"in d.attributes&&(h=U(a.tickRate,a.effectiveFrameRate,d.attributes.dur.value),null===h&&R(f,"Malformed dur value "+d.attributes.dur.value+" (ignoring)"));var l=null;d&&"end"in d.attributes&&(l=U(a.tickRate,a.effectiveFrameRate,d.attributes.end.value),null===l&&R(f,
"Malformed end value (ignoring)"));this.explicit_begin=b;this.explicit_end=l;this.explicit_dur=h;(a=d&&"timeContainer"in d.attributes?d.attributes.timeContainer.value:null)&&"par"!==a?"seq"===a?f="seq":(Q(f,"Illegal value of timeContainer (assuming 'par')"),f="par"):f="par";this.timeContainer=f};N.prototype.initFromNode=function(a,b,d,f){l.prototype.initFromNode.call(this,a,null,b,f);B.prototype.initFromNode.call(this,a,null,b,f);v.prototype.initFromNode.call(this,a,null,b,f);G.prototype.initFromNode.call(this,
...
null);if(c.rubyReserve){for(e=0;e<v.length;e++){g=document.createElement("ruby");t=document.createElement("rb");t.textContent="\u200b";g.appendChild(t);var y=c.rubyReserve[1].toUsedLength(c.w,c.h)+"px";"both"===c.rubyReserve[0]||"outside"===c.rubyReserve[0]&&1==v.length?(t=document.createElement("rtc"),t.style[z]=C?"after":"under",t.textContent="\u200b",t.style.fontSize=y,m=document.createElement("rtc"),m.style[z]=C?"before":"over",m.textContent="\u200b",m.style.fontSize=y,g.appendChild(t),g.appendChild(m)):
(t=document.createElement("rtc"),t.textContent="\u200b",t.style.fontSize=y,t.style[z]="after"===c.rubyReserve[0]||"outside"===c.rubyReserve[0]&&0<e?C?"after":"tb"===c.bpd||"rl"===c.bpd?"under":"over":C?"before":"tb"===c.bpd||"rl"===c.bpd?"over":"under",g.appendChild(t));t=null;for(m=0;m<v[e].rbc.length;m++)if("ruby"===v[e].rbc[m].localName){t=v[e].rbc[m];for(m=0;m<t.style.length;m++)g.style.setProperty(t.style.item(m),t.style.getPropertyValue(t.style.item(m)));break}t=t||v[e].elements[0].node;t.parentElement.insertBefore(g,
t)}c.rubyReserve=null}if(c.ruby||c.rubyReserve){for(e=0;e<v.length;e++)for(g=0;g<v[e].rbc.length;g++)v[e].rbc[g].style[z]||(v[e].rbc[g].style[z]=C?0===e?"before":"after":"tb"===c.bpd?0===e?"over":"under":"rl"===c.bpd?0===e?"over":"under":0===e?"under":"over");c.ruby=null}if(c.textEmphasis){for(e=0;e<v.length;e++)for(g=0;g<v[e].te.length;g++)v[e].te[g].style[G]&&"none"!==v[e].te[g].style[G]||(v[e].te[g].style[G]="tb"===c.bpd?0===e?"left over":"left under":"rl"===c.bpd?0===e?"right under":"left under":
...
m)}"tb"===c.bpd?(c.removePaddingElement.style.paddingLeft=0,c.removePaddingElement.style.paddingRight=0):(c.removePaddingElement.style.paddingTop=0,c.removePaddingElement.style.paddingBottom=0);c.lp=null}for(e=0;e<v.length;e++)for(g=v[e],t=1;t<g.elements.length;){m=g.elements[t-1].node;y=g.elements[t].node;if("SPAN"===m.tagName&&"SPAN"===y.tagName&&m._isd_element===y._isd_element){m.textContent+=y.textContent;for(x=0;x<y.style.length;x++){var D=y.style[x];if(0<=D.indexOf("border")||0<=D.indexOf("padding"))m.style[D]=
y.style[D]}y.parentElement.removeChild(y);m=!0}else m=!1;m?g.elements.splice(t,1):t++}e=[];for(m=0;m<v.length;m++)for(y=0;y<v[m].elements.length;y++)if(g=v[m].elements[y].node,t=b(g,e,!1))g.style.backgroundColor=t;for(g=0;g<e.length;g++)e[g].style.backgroundColor="";if(c.flg){g=r(B.getBoundingClientRect(),c);e=g.before;g=g.after;t=Math.sign(g-e);for(m=0;m<=v.length;m++){y=0===m?Math.round(e):m===v.length?Math.round(g):Math.round((v[m-1].after+v[m].before)/2);if(0<m&&v[m-1])for(D=0;D<v[m-1].elements.length;D++){var f=
v[m-1].elements[D];x=t*(y-f.after)+"px";"lr"===c.bpd?f.node.style.paddingRight=x:"rl"===c.bpd?f.node.style.paddingLeft=x:"tb"===c.bpd&&(f.node.style.paddingBottom=x)}if(m<v.length)for(D=0;D<v[m].elements.length;D++)f=v[m].elements[D],x=t*(f.before-y)+"px","lr"===c.bpd?f.node.style.paddingLeft=x:"rl"===c.bpd?f.node.style.paddingRight=x:"tb"===c.bpd&&(f.node.style.paddingTop=x)}c.flg=null}}"region"===h.kind&&"tb"===c.bpd&&c.enableRollUp&&0<h.contents.length&&"after"===h.styleAttrs[a.byName.displayAlign.qname]&&
(k(c,B,v,null),h=new p(""===h.id?"_":h.id,v),c.currentISDState[h.id]=h,c.previousISDState&&h.id in c.previousISDState&&0<c.previousISDState[h.id].plist.length&&1<h.plist.length&&h.plist[h.plist.length-2].text===c.previousISDState[h.id].plist[c.previousISDState[h.id].plist.length-1].text&&(c=l.firstElementChild,h=h.plist[h.plist.length-1].after-h.plist[h.plist.length-1].before,c.style.bottom="-"+h+"px",c.style.transition="transform 0.4s",c.style.position="relative",c.style.transform="translateY(-"+
h+"px)"))}else if(c=c.errorHandler,h="Error processing ISD element kind: "+h.kind,c&&c.error&&c.error(h))throw h;}function b(a,c,h){if(a.style.backgroundColor)return h&&!c.includes(a)&&c.push(a),a.style.backgroundColor;if("SPAN"===a.parentElement.nodeName)return b(a.parentElement,c,!0)}function p(a,b){this.id=a;this.plist=b}function r(a,b){var c={before:null,after:null,start:null,end:null};"tb"===b.bpd?(c.before=a.top,c.after=a.bottom,"lr"===b.ipd?(c.start=a.left,c.end=a.right):(c.start=a.right,c.end=
a.left)):"lr"===b.bpd?(c.before=a.left,c.after=a.right,c.start=a.top,c.end=a.bottom):"rl"===b.bpd&&(c.before=a.right,c.after=a.left,c.start=a.top,c.end=a.bottom);return c}function k(a,b,c,e){if("rt"!==b.localName&&"rtc"!==b.localName)if(e=b.style.backgroundColor||e,0===b.childElementCount)if("span"===b.localName||"rb"===b.localName){var h=b.getBoundingClientRect();a=r(h,a);if(!(h=0===c.length)){h=a.before;var l=a.after,g=c[c.length-1].before,p=c[c.length-1].after;h=!(l<p&&h>g||p<=l&&g>=h)}h?c.push({before:a.before,
after:a.after,start:a.start,end:a.end,start_elem:0,end_elem:0,elements:[],rbc:[],te:[],text:"",br:!1}):(h=Math.sign(a.after-a.before),l=Math.sign(a.end-a.start),0>h*(a.before-c[c.length-1].before)&&(c[c.length-1].before=a.before),0<h*(a.after-c[c.length-1].after)&&(c[c.length-1].after=a.after),0>l*(a.start-c[c.length-1].start)&&(c[c.length-1].start=a.start,c[c.length-1].start_elem=c[c.length-1].elements.length),0<l*(a.end-c[c.length-1].end)&&(c[c.length-1].end=a.end,c[c.length-1].end_elem=c[c.length-
1].elements.length));c[c.length-1].text+=b.textContent;c[c.length-1].elements.push({node:b,bgcolor:e,before:a.before,after:a.after})}else"br"===b.localName&&0!==c.length&&(c[c.length-1].br=!0);else for(b=b.firstChild;b;)b.nodeType===Node.ELEMENT_NODE&&(k(a,b,c,e),"ruby"===b.localName||"rtc"===b.localName?0<c.length&&c[c.length-1].rbc.push(b):"span"===b.localName&&b.style[E]&&"none"!==b.style[E]&&0<c.length&&c[c.length-1].te.push(b)),b=b.nextSibling}function w(a,b,c,e){"none"!==e.style&&(b.style[E]=
"auto"===e.style?"filled":e.style+" "+e.symbol,"before"===e.position||"after"===e.position)&&(b.style[G]="tb"===a.bpd?"before"===e.position?"left over":"left under":"rl"===a.bpd?"before"===e.position?"right under":"left under":"before"===e.position?"left under":"right under")}function t(a,b){this.qname=a;this.map=b}c.render=function(a,b,c,g,k,p,r,t,m,y){g=g||b.clientHeight;var h=k||b.clientWidth;null!==a.aspectRatio&&(k=g*a.aspectRatio,k>h?g=Math.round(h/a.aspectRatio):h=k);k=document.createElement("div");
k.style.position="relative";k.style.width=h+"px";k.style.height=g+"px";k.style.margin="auto";k.style.top=0;k.style.bottom=0;k.style.left=0;k.style.right=0;k.style.zIndex=0;c={h:g,w:h,regionH:null,regionW:null,imgResolver:c,displayForcedOnlyMode:p||!1,isd:a,errorHandler:r,previousISDState:t,enableRollUp:m||!1,currentISDState:{},flg:null,lp:null,mra:null,ipd:null,bpd:null,ruby:null,textEmphasis:null,rubyReserve:null,options:Object.assign({},y)||{}};c.options.colorAdjust&&(c.options.colorAdjust=e(c.options.colorAdjust));
p=["region","body","div","p","span"];for(var l in p)p.hasOwnProperty(l)&&(r=p[l]+"BackgroundColorAdjust",c.options[r]&&(c.options[r]=e(c.options[r])));b.appendChild(k);for(var f in a.contents)a.contents.hasOwnProperty(f)&&q(c,k,a.contents[f],a);return c.currentISDState};var u=[new t("http://www.w3.org/ns/ttml#styling backgroundColor",function(a,b,c,e){(c=(c=a.options[c.kind+"BackgroundColorAdjust"])&&c[e.toString()])&&(e=c);c=e[3];0!==c&&(void 0!=a.options.backgroundOpacityScale&&(c*=a.options.backgroundOpacityScale),
b.style.backgroundColor="rgba("+e[0].toString()+","+e[1].toString()+","+e[2].toString()+","+(c/255).toString()+")")}),new t("http://www.w3.org/ns/ttml#styling color",function(a,b,c,e){c=a.options.colorOpacityScale||1;a=a.options.colorAdjust;void 0!=a&&(a=a[e.toString()])&&(e=a);b.style.color="rgba("+e[0].toString()+","+e[1].toString()+","+e[2].toString()+","+(c*e[3]/255).toString()+")"}),new t("http://www.w3.org/ns/ttml#styling direction",function(a,b,c,e){b.style.direction=e}),new t("http://www.w3.org/ns/ttml#styling display",
function(a,b,c,e){}),new t("http://www.w3.org/ns/ttml#styling displayAlign",function(a,b,c,e){b.style.display="flex";b.style.flexDirection="column";"before"===e?b.style.justifyContent="flex-start":"center"===e?b.style.justifyContent="center":"after"===e&&(b.style.justifyContent="flex-end")}),new t("http://www.w3.org/ns/ttml#styling extent",function(a,b,c,e){a.regionH=e.h.toUsedLength(a.w,a.h);a.regionW=e.w.toUsedLength(a.w,a.h);var h=e=0;if(c=c.styleAttrs["http://www.w3.org/ns/ttml#styling padding"])e=
c[0].toUsedLength(a.w,a.h)+c[2].toUsedLength(a.w,a.h),h=c[1].toUsedLength(a.w,a.h)+c[3].toUsedLength(a.w,a.h);b.style.height=a.regionH-e+"px";b.style.width=a.regionW-h+"px"}),new t("http://www.w3.org/ns/ttml#styling fontFamily",function(a,b,c,e){c=[];a.options.fontFamily&&(e=a.options.fontFamily.split(","));for(var h in e)e[h].hasOwnProperty(h)&&(e[h]=e[h].trim(),"monospaceSerif"===e[h]?(c.push("Courier New"),c.push('"Liberation Mono"'),c.push("Courier"),c.push("monospace")):"proportionalSansSerif"===
e[h]||"default"===e[h]?(c.push("Arial"),c.push("Helvetica"),c.push('"Liberation Sans"'),c.push("sans-serif")):"monospace"===e[h]?c.push("monospace"):"sansSerif"===e[h]?c.push("sans-serif"):"serif"===e[h]?c.push("serif"):"monospaceSansSerif"===e[h]?(c.push("Consolas"),c.push("monospace")):"proportionalSerif"===e[h]?c.push("serif"):c.push(e[h]));if(0<c.length){a=[c[0]];for(e=1;e<c.length;e++)-1==a.indexOf(c[e])&&a.push(c[e]);c=a}b.style.fontFamily=c.join(",")}),new t("http://www.w3.org/ns/ttml#styling shear",
function(a,b,c,e){0!==e&&(c=-.9*e,b.style.transform="tb"===a.bpd?"skewX("+c+"deg)":"skewY("+c+"deg)")}),new t("http://www.w3.org/ns/ttml#styling fontSize",function(a,b,c,e){b.style.fontSize=e.multiply(e.toUsedLength(a.w,a.h),a.options.sizeAdjust)+"px"}),new t("http://www.w3.org/ns/ttml#styling fontStyle",function(a,b,c,e){b.style.fontStyle=e}),new t("http://www.w3.org/ns/ttml#styling fontWeight",function(a,b,c,e){b.style.fontWeight=e}),new t("http://www.w3.org/ns/ttml#styling lineHeight",function(a,
b,c,e){b.style.lineHeight="normal"===e?"normal":e.multiply(e.multiply(e.toUsedLength(a.w,a.h),a.options.sizeAdjust),a.options.lineHeightAdjust)+"px"}),new t("http://www.w3.org/ns/ttml#styling opacity",function(a,b,c,e){c=e;void 0!=a.options.regionOpacityScale&&(c*=a.options.regionOpacityScale);b.style.opacity=c}),new t("http://www.w3.org/ns/ttml#styling origin",function(a,b,c,e){b.style.top=e.h.toUsedLength(a.w,a.h)+"px";b.style.left=e.w.toUsedLength(a.w,a.h)+"px"}),new t("http://www.w3.org/ns/ttml#styling overflow",
function(a,b,c,e){b.style.overflow=e}),new t("http://www.w3.org/ns/ttml#styling padding",function(a,b,c,e){c=[];c[0]=e[0].toUsedLength(a.w,a.h)+"px";c[1]=e[3].toUsedLength(a.w,a.h)+"px";c[2]=e[2].toUsedLength(a.w,a.h)+"px";c[3]=e[1].toUsedLength(a.w,a.h)+"px";b.style.padding=c.join(" ")}),new t("http://www.w3.org/ns/ttml#styling position",function(a,b,c,e){b.style.top=e.h.toUsedLength(a.w,a.h)+"px";b.style.left=e.w.toUsedLength(a.w,a.h)+"px"}),new t("http://www.w3.org/ns/ttml#styling rubyAlign",function(a,
b,c,e){b.style.rubyAlign="spaceAround"===e?"space-around":"center"}),new t("http://www.w3.org/ns/ttml#styling rubyPosition",function(a,b,c,e){if("before"===e||"after"===e)b.parentElement.style[z]=C?e:"tb"===a.bpd?"before"===e?"over":"under":"rl"===a.bpd?"before"===e?"over":"under":"before"===e?"under":"over"}),new t("http://www.w3.org/ns/ttml#styling showBackground",null),new t("http://www.w3.org/ns/ttml#styling textAlign",function(a,b,c,e){b.style.textAlign="start"===e?"rl"===a.ipd?"right":"left":
"end"===e?"rl"===a.ipd?"left":"right":e}),new t("http://www.w3.org/ns/ttml#styling textDecoration",function(a,b,c,e){b.style.textDecoration=e.join(" ").replace("lineThrough","line-through")}),new t("http://www.w3.org/ns/ttml#styling textOutline",function(a,b,c,e){}),new t("http://www.w3.org/ns/ttml#styling textShadow",function(b,c,e,g){e=e.styleAttrs[a.byName.textOutline.qname];var h=b.options.textOutline;if(h)if("none"===h)e=h;else{var k={};h=h.split(" ");if(0!==h.length&&2>=h.length){var l=m.parseColor(h[0]);
k.color=l;null!==l&&h.shift();1===h.length&&(h=m.parseLength(h[0]))&&(k.thickness=h,e=k)}}if("none"===g&&"none"===e)c.style.textShadow="";else{k=[];"none"!==e&&(e="rgba("+e.color[0].toString()+","+e.color[1].toString()+","+e.color[2].toString()+","+(e.color[3]/255).toString()+")",k.push("1px 1px 1px "+e),k.push("-1px 1px 1px "+e),k.push("1px -1px 1px "+e),k.push("-1px -1px 1px "+e));if("none"!==g)for(var p in g)g.hasOwnProperty(p)&&k.push(g[p].x_off.toUsedLength(b.w,b.h)+"px "+g[p].y_off.toUsedLength(b.w,
b.h)+"px "+g[p].b_radius.toUsedLength(b.w,b.h)+"px rgba("+g[p].color[0].toString()+","+g[p].color[1].toString()+","+g[p].color[2].toString()+","+(g[p].color[3]/255).toString()+")");c.style.textShadow=k.join(",")}}),new t("http://www.w3.org/ns/ttml#styling textCombine",function(a,b,c,e){b.style.textCombineUpright=e}),new t("http://www.w3.org/ns/ttml#styling textEmphasis",function(a,b,c,e){}),new t("http://www.w3.org/ns/ttml#styling unicodeBidi",function(a,b,c,e){b.style.unicodeBidi="bidiOverride"===
e?"bidi-override":e}),new t("http://www.w3.org/ns/ttml#styling visibility",function(a,b,c,e){b.style.visibility=e}),new t("http://www.w3.org/ns/ttml#styling wrapOption",function(a,b,c,e){b.style.whiteSpace="wrap"===e?"preserve"===c.space?"pre-wrap":"normal":"preserve"===c.space?"pre":"noWrap"}),new t("http://www.w3.org/ns/ttml#styling writingMode",function(a,b,c,e){if("lrtb"===e||"lr"===e)b.style.writingMode="horizontal-tb";else if("rltb"===e||"rl"===e)b.style.writingMode="horizontal-tb";else if("tblr"===
e)b.style.writingMode="vertical-lr";else if("tbrl"===e||"tb"===e)b.style.writingMode="vertical-rl"}),new t("http://www.w3.org/ns/ttml#styling zIndex",function(a,b,c,e){b.style.zIndex=e}),new t("http://www.w3.org/ns/ttml/profile/imsc1#styling forcedDisplay",function(a,b,c,e){a.displayForcedOnlyMode&&!1===e&&(b.style.visibility="hidden")})],F;for(F in u)u.hasOwnProperty(F);var C="webkitRubyPosition"in window.getComputedStyle(document.documentElement),z=C?"webkitRubyPosition":"rubyPosition",E="webkitTextEmphasisStyle"in
window.getComputedStyle(document.documentElement)?"webkitTextEmphasisStyle":"textEmphasisStyle",G="webkitTextEmphasisPosition"in window.getComputedStyle(document.documentElement)?"webkitTextEmphasisPosition":"textEmphasisPosition"})("undefined"===typeof m?this.imscHTML={}:m,"undefined"===typeof imscNames?c("./names"):imscNames,"undefined"===typeof imscStyles?c("./styles"):imscStyles,"undefined"===typeof imscUtils?c("./utils"):imscUtils)},{"./names":31,"./styles":32,"./utils":33}],29:[function(c,u,
m){(function(c,g,a,m){function e(c,g,r,w,u,x,G,l,v){if(g<G.begin||g>=G.end)return null;x="regionID"in G&&""!==G.regionID?G.regionID:x;if(null!==u&&x!==r.id&&(!("contents"in G)||"contents"in G&&0===G.contents.length||""!==x))return null;var h=new k(G);for(t in G.sets)!G.sets.hasOwnProperty(t)||g<G.sets[t].begin||g>=G.sets[t].end||(h.styleAttrs[G.sets[t].qname]=G.sets[t].value);var t={};for(var z in h.styleAttrs)if(h.styleAttrs.hasOwnProperty(z)&&(t[z]=!0,"region"===h.kind&&z===a.byName.writingMode.qname&&
!(a.byName.direction.qname in h.styleAttrs))){var C=h.styleAttrs[z];if("lrtb"===C||"lr"===C)h.styleAttrs[a.byName.direction.qname]="ltr";else if("rltb"===C||"rl"===C)h.styleAttrs[a.byName.direction.qname]="rtl"}if(null!==u)for(var D in a.all)if(a.all.hasOwnProperty(D))if(z=a.all[D],z.qname===a.byName.textDecoration.qname){C=u.styleAttrs[z.qname];var F=h.styleAttrs[z.qname],A=[];void 0===F?A=C:-1===F.indexOf("none")?((-1===F.indexOf("noUnderline")&&-1!==C.indexOf("underline")||-1!==F.indexOf("underline"))&&
A.push("underline"),(-1===F.indexOf("noLineThrough")&&-1!==C.indexOf("lineThrough")||-1!==F.indexOf("lineThrough"))&&A.push("lineThrough"),(-1===F.indexOf("noOverline")&&-1!==C.indexOf("overline")||-1!==F.indexOf("overline"))&&A.push("overline")):A.push("none");h.styleAttrs[z.qname]=A}else z.qname!==a.byName.fontSize.qname||z.qname in h.styleAttrs||"span"!==h.kind||"textContainer"!==h.styleAttrs[a.byName.ruby.qname]?z.qname!==a.byName.fontSize.qname||z.qname in h.styleAttrs||"span"!==h.kind||"text"!==
h.styleAttrs[a.byName.ruby.qname]?z.inherit&&z.qname in u.styleAttrs&&!(z.qname in h.styleAttrs)&&(h.styleAttrs[z.qname]=u.styleAttrs[z.qname]):(C=u.styleAttrs[a.byName.fontSize.qname],h.styleAttrs[z.qname]="textContainer"===u.styleAttrs[a.byName.ruby.qname]?C:new m.ComputedLength(.5*C.rw,.5*C.rh)):(C=u.styleAttrs[a.byName.fontSize.qname],h.styleAttrs[z.qname]=new m.ComputedLength(.5*C.rw,.5*C.rh));for(var E in a.all)if(a.all.hasOwnProperty(E)&&(D=a.all[E],!(D.qname in h.styleAttrs||D.qname===a.byName.position.qname&&
a.byName.origin.qname in h.styleAttrs||D.qname===a.byName.origin.qname&&a.byName.position.qname in h.styleAttrs)&&(z=c.head.styling.initials[D.qname]||D.initial,null!==z&&("region"===h.kind||!1===D.inherit&&null!==z))))if(z=D.parse(z),null!==z)h.styleAttrs[D.qname]=z,t[D.qname]=!0;else if(D="Invalid initial value for '"+D.qname+"' on element '"+h.kind,l&&l.error&&l.error(D))throw D;for(var I in a.all)if(a.all.hasOwnProperty(I)&&(E=a.all[I],E.qname in t&&null!==E.compute))if(D=E.compute(c,u,h,h.styleAttrs[E.qname],
v),null!==D)h.styleAttrs[E.qname]=D;else if(h.styleAttrs[E.qname]=E.compute(c,u,h,E.parse(E.initial),v),E="Style '"+E.qname+"' on element '"+h.kind+"' cannot be computed",l&&l.error&&l.error(E))throw E;if("none"===h.styleAttrs[a.byName.display.qname])return null;if(null===u)var L=null===w?[]:[w];else"contents"in G&&(L=G.contents);for(var f in L)L.hasOwnProperty(f)&&(u=e(c,g,r,w,h,x,L[f],l,v),null!==u&&h.contents.push(u.element));for(var d in h.styleAttrs)h.styleAttrs.hasOwnProperty(d)&&(c=!1,"span"===
h.kind&&(g=h.styleAttrs[a.byName.ruby.qname],(c=("container"===g||"textContainer"===g||"baseContainer"===g)&&-1!==y.indexOf(d))||(c="container"!==g&&d===a.byName.rubyAlign.qname),c||(c=!("textContainer"===g||"text"===g)&&d===a.byName.rubyPosition.qname)),c||(c=-1===a.byQName[d].applies.indexOf(h.kind)),c&&delete h.styleAttrs[d]);d=h.styleAttrs[a.byName.ruby.qname];if("p"===h.kind||"span"===h.kind&&("textContainer"===d||"text"===d))d=[],b(h,d),q(d),p(h);return"div"===h.kind&&a.byName.backgroundImage.qname in
h.styleAttrs||"br"===h.kind||"image"===h.kind||"contents"in h&&0<h.contents.length||"span"===h.kind&&null!==h.text||"region"===h.kind&&"always"===h.styleAttrs[a.byName.showBackground.qname]?{region_id:x,element:h}:null}function q(a){function b(a){return"br"===a.kind||/[\r\n\t ]$/.test(a.text)}function c(a){return"br"===a.kind||"preserve"===a.space&&/^[\r\n]/.test(a.text)}for(var e,g=0;g<a.length;)if(e=a[g],"br"===e.kind||"preserve"===e.space)g++;else{var k=e.text.replace(/[\t\r\n ]+/g," ");/^[ ]/.test(k)&&
(0===g||b(a[g-1]))&&(k=k.substring(1));e.text=k;0===k.length?a.splice(g,1):g++}for(g=0;g<a.length;g++)e=a[g],"br"===e.kind||"preserve"===e.space?g++:/[ ]$/.test(e.text)&&(g===a.length-1||c(a[g+1]))&&(e.text=e.text.slice(0,-1))}function b(c,e){for(var g in c.contents)if(c.contents.hasOwnProperty(g)){var k=c.contents[g],p=k.styleAttrs[a.byName.ruby.qname];if("span"!==k.kind||"textContainer"!==p&&"text"!==p)"contents"in k?b(k,e):("span"===k.kind&&0!==k.text.length||"br"===k.kind)&&e.push(k)}}function p(a){if("br"===
a.kind)return!1;if("text"in a)return 0===a.text.length;if("contents"in a){for(var b=a.contents.length;b--;)p(a.contents[b])&&a.contents.splice(b,1);return 0===a.contents.length}}function r(a){this.contents=[];this.aspectRatio=a.aspectRatio;this.lang=a.lang}function k(a){this.kind=a.kind||"region";this.lang=a.lang;a.id&&(this.id=a.id);this.styleAttrs={};for(var b in a.styleAttrs)a.styleAttrs.hasOwnProperty(b)&&(this.styleAttrs[b]=a.styleAttrs[b]);"src"in a&&(this.src=a.src);"type"in a&&(this.type=
a.type);if("text"in a)this.text=a.text;else if("region"===this.kind||"contents"in a)this.contents=[];"space"in a&&(this.space=a.space)}c.generateISD=function(b,c,g){function k(a,b){function c(b){return!(a<b.begin||a>=b.end)}if(b.contents){var e={},g;for(g in b)b.hasOwnProperty(g)&&(e[g]=b[g]);e.contents=[];b.contents.filter(c).forEach(function(b){b=k(a,b);b.regionID&&(l[b.regionID]=!0);null!==b&&e.contents.push(b)});return e}return b}var p=new r(b),m={},q={},l={};q=b.head.styling.initials[a.byName.showBackground.qname];
var t=b.head.styling.initials[a.byName.backgroundColor.qname];for(x in b.head.layout.regions)if(b.head.layout.regions.hasOwnProperty(x)){var h=b.head.layout.regions[x],y=h.styleAttrs[a.byName.showBackground.qname]||q,u=h.styleAttrs[a.byName.backgroundColor.qname]||t;l[h.id]=("always"===y||void 0===y)&&void 0!==u&&!(c<h.begin||c>=h.end)}b.body&&b.body.regionID&&(l[b.body.regionID]=!0);q=null!==b.body?k(c,b.body):null;void 0!==l[""]&&(l[""]=!0);for(var w in l)if(l[w]){var x=e(b,c,b.head.layout.regions[w],
q,null,"",b.head.layout.regions[w],g,m);null!==x&&p.contents.push(x.element)}return p};var y=[a.byName.color.qname,a.byName.textCombine.qname,a.byName.textDecoration.qname,a.byName.textEmphasis.qname,a.byName.textOutline.qname,a.byName.textShadow.qname]})("undefined"===typeof m?this.imscISD={}:m,"undefined"===typeof imscNames?c("./names"):imscNames,"undefined"===typeof imscStyles?c("./styles"):imscStyles,"undefined"===typeof imscUtils?c("./utils"):imscUtils)},{"./names":31,"./styles":32,"./utils":33}],
30:[function(c,u,m){m.generateISD=c("./isd").generateISD;m.fromXML=c("./doc").fromXML;m.renderHTML=c("./html").render},{"./doc":27,"./html":28,"./isd":29}],31:[function(c,u,m){c="undefined"===typeof m?this.imscNames={}:m;c.ns_tt="http://www.w3.org/ns/ttml";c.ns_tts="http://www.w3.org/ns/ttml#styling";c.ns_ttp="http://www.w3.org/ns/ttml#parameter";c.ns_xml="http://www.w3.org/XML/1998/namespace";c.ns_itts="http://www.w3.org/ns/ttml/profile/imsc1#styling";c.ns_ittp="http://www.w3.org/ns/ttml/profile/imsc1#parameter";
c.ns_smpte="http://www.smpte-ra.org/schemas/2052-1/2010/smpte-tt";c.ns_ebutts="urn:ebu:tt:style";c.ttaf_map={"http://www.w3.org/2006/10/ttaf1":c.ns_tt,"http://www.w3.org/2006/10/ttaf1#style":c.ns_tts,"http://www.w3.org/2006/10/ttaf1#parameter":c.ns_ttp}},{}],32:[function(c,u,m){(function(c,g,a){function m(a,c,e,g,m,q,u,w){this.name=c;this.ns=a;this.qname=a+" "+c;this.inherit=m;this.animatable=q;this.initial=e;this.applies=g;this.parse=u;this.compute=w}c.all=[new m(g.ns_tts,"backgroundColor","transparent",
["body","div","p","region","span"],!1,!0,a.parseColor,null),new m(g.ns_tts,"color","white",["span"],!0,!0,a.parseColor,null),new m(g.ns_tts,"direction","ltr",["p","span"],!0,!0,function(a){return a},null),new m(g.ns_tts,"display","auto",["body","div","p","region","span"],!1,!0,function(a){return a},null),new m(g.ns_tts,"displayAlign","before",["region"],!1,!0,function(a){return a},null),new m(g.ns_tts,"extent","auto",["tt","region"],!1,!0,function(b){if("auto"===b)return b;var c=b.split(" ");if(2!==
c.length)return null;b=a.parseLength(c[0]);return(c=a.parseLength(c[1]))&&b?{h:c,w:b}:null},function(b,c,e,g,m){if("auto"===g)c=new a.ComputedLength(0,1);else if(c=a.toComputedLength(g.h.value,g.h.unit,null,b.dimensions.h,null,b.pxLength.h),null===c)return null;if("auto"===g)b=new a.ComputedLength(1,0);else if(b=a.toComputedLength(g.w.value,g.w.unit,null,b.dimensions.w,null,b.pxLength.w),null===b)return null;return{h:c,w:b}}),new m(g.ns_tts,"fontFamily","default",["span","p"],!0,!0,function(a){a=
a.split(",");for(var b=[],c=0;c<a.length;c++)"'"!==a[c].charAt(0)&&'"'!==a[c].charAt(0)?"default"===a[c]?b.push("monospaceSerif"):b.push(a[c]):b.push(a[c]);return b},null),new m(g.ns_tts,"shear","0%",["p"],!0,!0,a.parseLength,function(a,c,e,g){if("%"===g.unit)a=100<Math.abs(g.value)?100*Math.sign(g.value):g.value;else return null;return a}),new m(g.ns_tts,"fontSize","1c",["span","p"],!0,!0,a.parseLength,function(b,e,g,k,m){return a.toComputedLength(k.value,k.unit,null!==e?e.styleAttrs[c.byName.fontSize.qname]:
b.cellLength.h,null!==e?e.styleAttrs[c.byName.fontSize.qname]:b.cellLength.h,b.cellLength.h,b.pxLength.h)}),new m(g.ns_tts,"fontStyle","normal",["span","p"],!0,!0,function(a){return a},null),new m(g.ns_tts,"fontWeight","normal",["span","p"],!0,!0,function(a){return a},null),new m(g.ns_tts,"lineHeight","normal",["p"],!0,!0,function(b){return"normal"===b?b:a.parseLength(b)},function(b,e,g,k,m){if("normal"===k)b=k;else if(b=a.toComputedLength(k.value,k.unit,g.styleAttrs[c.byName.fontSize.qname],g.styleAttrs[c.byName.fontSize.qname],
b.cellLength.h,b.pxLength.h),null===b)return null;return b}),new m(g.ns_tts,"opacity",1,["region"],!1,!0,parseFloat,null),new m(g.ns_tts,"origin","auto",["region"],!1,!0,function(b){if("auto"===b)return b;var c=b.split(" ");if(2!==c.length)return null;b=a.parseLength(c[0]);return(c=a.parseLength(c[1]))&&b?{h:c,w:b}:null},function(b,c,e,g,m){if("auto"===g)c=new a.ComputedLength(0,0);else if(c=a.toComputedLength(g.h.value,g.h.unit,null,b.dimensions.h,null,b.pxLength.h),null===c)return null;if("auto"===
g)b=new a.ComputedLength(0,0);else if(b=a.toComputedLength(g.w.value,g.w.unit,null,b.dimensions.w,null,b.pxLength.w),null===b)return null;return{h:c,w:b}}),new m(g.ns_tts,"overflow","hidden",["region"],!1,!0,function(a){return a},null),new m(g.ns_tts,"padding","0px",["region"],!1,!0,function(b){b=b.split(" ");if(4<b.length)return null;for(var c=[],e=0;e<b.length;e++){var g=a.parseLength(b[e]);if(!g)return null;c.push(g)}return c},function(b,e,g,k,m){if(1===k.length)e=[k[0],k[0],k[0],k[0]];else if(2===
k.length)e=[k[0],k[1],k[0],k[1]];else if(3===k.length)e=[k[0],k[1],k[2],k[1]];else if(4===k.length)e=[k[0],k[1],k[2],k[3]];else return null;k=g.styleAttrs[c.byName.writingMode.qname];if("lrtb"===k||"lr"===k)e=[e[0],e[3],e[2],e[1]];else if("rltb"===k||"rl"===k)e=[e[0],e[1],e[2],e[3]];else if("tblr"===k)e=[e[3],e[0],e[1],e[2]];else if("tbrl"===k||"tb"===k)e=[e[3],e[2],e[1],e[0]];else return null;k=[];for(m=0;m<e.length;m++)if(0===e[m].value)k[m]=new a.ComputedLength(0,0);else if(k[m]=a.toComputedLength(e[m].value,
e[m].unit,g.styleAttrs[c.byName.fontSize.qname],"0"===m||"2"===m?g.styleAttrs[c.byName.extent.qname].h:g.styleAttrs[c.byName.extent.qname].w,"0"===m||"2"===m?b.cellLength.h:b.cellLength.w,"0"===m||"2"===m?b.pxLength.h:b.pxLength.w),null===k[m])return null;return k}),new m(g.ns_tts,"position","top left",["region"],!1,!0,function(b){return a.parsePosition(b)},function(b,e,g,k){e=a.toComputedLength(k.v.offset.value,k.v.offset.unit,null,new a.ComputedLength(-g.styleAttrs[c.byName.extent.qname].h.rw,b.dimensions.h.rh-
g.styleAttrs[c.byName.extent.qname].h.rh),null,b.pxLength.h);if(null===e)return null;"bottom"===k.v.edge&&(e=new a.ComputedLength(-e.rw-g.styleAttrs[c.byName.extent.qname].h.rw,b.dimensions.h.rh-e.rh-g.styleAttrs[c.byName.extent.qname].h.rh));var m=a.toComputedLength(k.h.offset.value,k.h.offset.unit,null,new a.ComputedLength(b.dimensions.w.rw-g.styleAttrs[c.byName.extent.qname].w.rw,-g.styleAttrs[c.byName.extent.qname].w.rh),null,b.pxLength.w);if(null===e)return null;"right"===k.h.edge&&(m=new a.ComputedLength(b.dimensions.w.rw-
m.rw-g.styleAttrs[c.byName.extent.qname].w.rw,-m.rh-g.styleAttrs[c.byName.extent.qname].w.rh));return{h:e,w:m}}),new m(g.ns_tts,"ruby","none",["span"],!1,!0,function(a){return a},null),new m(g.ns_tts,"rubyAlign","center",["span"],!0,!0,function(a){return"center"!==a&&"spaceAround"!==a?null:a},null),new m(g.ns_tts,"rubyPosition","outside",["span"],!0,!0,function(a){return a},null),new m(g.ns_tts,"rubyReserve","none",["p"],!0,!0,function(b){var c=b.split(" ");b=[null,null];if(0===c.length||2<c.length||
"none"!==c[0]&&"both"!==c[0]&&"after"!==c[0]&&"before"!==c[0]&&"outside"!==c[0])return null;b[0]=c[0];if(2===c.length&&"none"!==c[0])if(c=a.parseLength(c[1]))b[1]=c;else return null;return b},function(b,e,g,k,m){if("none"===k[0])return k;b=null===k[1]?new a.ComputedLength(.5*g.styleAttrs[c.byName.fontSize.qname].rw,.5*g.styleAttrs[c.byName.fontSize.qname].rh):a.toComputedLength(k[1].value,k[1].unit,g.styleAttrs[c.byName.fontSize.qname],g.styleAttrs[c.byName.fontSize.qname],b.cellLength.h,b.pxLength.h);
return null===b?null:[k[0],b]}),new m(g.ns_tts,"showBackground","whenActive",["region"],!1,!0,function(a){return a},null),new m(g.ns_tts,"textAlign","start",["p"],!0,!0,function(a){return a},function(a,c,e,g,m){return"left"===g?"start":"right"===g?"end":g}),new m(g.ns_tts,"textCombine","none",["span"],!0,!0,function(a){return"none"===a||"all"===a?a:null},null),new m(g.ns_tts,"textDecoration","none",["span"],!0,!0,function(a){return a.split(" ")},null),new m(g.ns_tts,"textEmphasis","none",["span"],
!0,!0,function(b){b=b.split(" ");for(var c={style:null,symbol:null,color:null,position:null},e=0;e<b.length;e++)if("none"===b[e]||"auto"===b[e])c.style=b[e];else if("filled"===b[e]||"open"===b[e])c.style=b[e];else if("circle"===b[e]||"dot"===b[e]||"sesame"===b[e])c.symbol=b[e];else if("current"===b[e])c.color=b[e];else if("outside"===b[e]||"before"===b[e]||"after"===b[e])c.position=b[e];else if(c.color=a.parseColor(b[e]),null===c.color)return null;null==c.style&&null==c.symbol?c.style="auto":(c.symbol=
c.symbol||"circle",c.style=c.style||"filled");c.position=c.position||"outside";c.color=c.color||"current";return c},null),new m(g.ns_tts,"textOutline","none",["span"],!0,!0,function(b){if("none"===b)return b;var c={};b=b.split(" ");if(0===b.length||2<b.length)return null;var e=a.parseColor(b[0]);c.color=e;null!==e&&b.shift();if(1!==b.length)return null;b=a.parseLength(b[0]);if(!b)return null;c.thickness=b;return c},function(b,e,g,k,m){if("none"===k)return k;e={};e.color=null===k.color?g.styleAttrs[c.byName.color.qname]:
k.color;e.thickness=a.toComputedLength(k.thickness.value,k.thickness.unit,g.styleAttrs[c.byName.fontSize.qname],g.styleAttrs[c.byName.fontSize.qname],b.cellLength.h,b.pxLength.h);return null===e.thickness?null:e}),new m(g.ns_tts,"textShadow","none",["span"],!0,!0,a.parseTextShadow,function(b,e,g,k){if("none"===k)return k;e=[];for(var m in k)if(m.hasOwnProperty(k)){var p={};p.x_off=a.toComputedLength(k[m][0].value,k[m][0].unit,null,g.styleAttrs[c.byName.fontSize.qname],null,b.pxLength.w);if(null===
p.x_off)return null;p.y_off=a.toComputedLength(k[m][1].value,k[m][1].unit,null,g.styleAttrs[c.byName.fontSize.qname],null,b.pxLength.h);if(null===p.y_off)return null;if(null===k[m][2])p.b_radius=0;else if(p.b_radius=a.toComputedLength(k[m][2].value,k[m][2].unit,null,g.styleAttrs[c.byName.fontSize.qname],null,b.pxLength.h),null===p.b_radius)return null;p.color=null===k[m][3]?g.styleAttrs[c.byName.color.qname]:k[m][3];e.push(p)}return e}),new m(g.ns_tts,"unicodeBidi","normal",["span","p"],!1,!0,function(a){return a},
null),new m(g.ns_tts,"visibility","visible",["body","div","p","region","span"],!0,!0,function(a){return a},null),new m(g.ns_tts,"wrapOption","wrap",["span"],!0,!0,function(a){return a},null),new m(g.ns_tts,"writingMode","lrtb",["region"],!1,!0,function(a){return a},null),new m(g.ns_tts,"zIndex","auto",["region"],!1,!0,function(a){"auto"!==a&&(a=parseInt(a),isNaN(a)&&(a=null));return a},null),new m(g.ns_ebutts,"linePadding","0c",["p"],!0,!1,a.parseLength,function(b,c,e,g,m){return a.toComputedLength(g.value,
g.unit,null,null,b.cellLength.w,null)}),new m(g.ns_ebutts,"multiRowAlign","auto",["p"],!0,!1,function(a){return a},null),new m(g.ns_smpte,"backgroundImage",null,["div"],!1,!1,function(a){return a},null),new m(g.ns_itts,"forcedDisplay","false",["body","div","p","region","span"],!0,!0,function(a){return"true"===a?!0:!1},null),new m(g.ns_itts,"fillLineGap","true",["p"],!0,!0,function(a){return"true"===a?!0:!1},null)];c.byQName={};for(var e in c.all)c.all.hasOwnProperty(e)&&(c.byQName[c.all[e].qname]=
c.all[e]);c.byName={};for(var q in c.all)c.all.hasOwnProperty(q)&&(c.byName[c.all[q].name]=c.all[q])})("undefined"===typeof m?this.imscStyles={}:m,"undefined"===typeof imscNames?c("./names"):imscNames,"undefined"===typeof imscUtils?c("./utils"):imscUtils)},{"./names":31,"./utils":33}],33:[function(c,u,m){(function(c){var g=/#([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})?/,a=/rgb\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*\)/,m=/rgba\(\s*(\d+),\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*\)/,e={transparent:[0,
0,0,0],black:[0,0,0,255],silver:[192,192,192,255],gray:[128,128,128,255],white:[255,255,255,255],maroon:[128,0,0,255],red:[255,0,0,255],purple:[128,0,128,255],fuchsia:[255,0,255,255],magenta:[255,0,255,255],green:[0,128,0,255],lime:[0,255,0,255],olive:[128,128,0,255],yellow:[255,255,0,255],navy:[0,0,128,255],blue:[0,0,255,255],teal:[0,128,128,255],aqua:[0,255,255,255],cyan:[0,255,255,255]};c.parseColor=function(b){var c,r=null,k=e[b.toLowerCase()];void 0!==k?r=k:null!==(c=g.exec(b))?r=[parseInt(c[1],
16),parseInt(c[2],16),parseInt(c[3],16),void 0!==c[4]?parseInt(c[4],16):255]:null!==(c=a.exec(b))?r=[parseInt(c[1]),parseInt(c[2]),parseInt(c[3]),255]:null!==(c=m.exec(b))&&(r=[parseInt(c[1]),parseInt(c[2]),parseInt(c[3]),parseInt(c[4])]);return r};var q=/^((?:\+|\-)?\d*(?:\.\d+)?)(px|em|c|%|rh|rw)$/;c.parseLength=function(a){var b,c=null;null!==(b=q.exec(a))&&(c={value:parseFloat(b[1]),unit:b[2]});return c};c.parseTextShadow=function(a){a=a.split(",");for(var b=[],e=0;e<a.length;e++){var g=a[e].split(" ");
if(1===g.length&&"none"===g[0])return"none";if(1<g.length&&5>g.length){var m=[null,null,null,null],q=c.parseLength(g.shift());if(null===q)return null;m[0]=q;q=c.parseLength(g.shift());if(null===q)return null;m[1]=q;if(0!==g.length&&(q=c.parseLength(g[0]),null!==q&&(m[2]=q,g.shift()),0!==g.length)){g=c.parseColor(g[0]);if(null===g)return null;m[3]=g}b.push(m)}}return b};c.parsePosition=function(a){a=a.split(" ");var b=function(a){return"center"===a||"left"===a||"top"===a||"bottom"===a||"right"===a};
if(4<a.length)return null;for(var e in a)if(a.hasOwnProperty(e)&&!b(a[e])){var g=c.parseLength(a[e]);if(null===g)return null;a[e]=g}e={h:{edge:"left",offset:{value:50,unit:"%"}},v:{edge:"top",offset:{value:50,unit:"%"}}};for(g=0;g<a.length;){var m=a[g++];if(b(m)){var q={value:0,unit:"%"};2!==a.length&&g<a.length&&!b(a[g])&&(q=a[g++]);"right"===m?(e.h.edge=m,e.h.offset=q):"bottom"===m?(e.v.edge=m,e.v.offset=q):"left"===m?e.h.offset=q:"top"===m&&(e.v.offset=q)}else if(1===a.length||2===a.length)1===
g?e.h.offset=m:e.v.offset=m;else return null}return e};c.ComputedLength=function(a,c){this.rw=a;this.rh=c};c.ComputedLength.prototype.toUsedLength=function(a,c){return a*this.rw+c*this.rh};c.ComputedLength.prototype.multiply=function(a,c){return c?a*c:a};c.ComputedLength.prototype.isZero=function(){return 0===this.rw&&0===this.rh};c.toComputedLength=function(a,e,g,k,m,q){return"%"===e&&k?new c.ComputedLength(k.rw*a/100,k.rh*a/100):"em"===e&&g?new c.ComputedLength(g.rw*a,g.rh*a):"c"===e&&m?new c.ComputedLength(a*
m.rw,a*m.rh):"px"===e&&q?new c.ComputedLength(a*q.rw,a*q.rh):"rh"===e?new c.ComputedLength(0,a/100):"rw"===e?new c.ComputedLength(a/100,0):null}})("undefined"===typeof m?this.imscUtils={}:m)},{}]},{},[30])(30)});
