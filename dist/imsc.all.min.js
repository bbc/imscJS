...
c.ns_ttp="http://www.w3.org/ns/ttml#parameter";c.ns_xml="http://www.w3.org/XML/1998/namespace";c.ns_itts="http://www.w3.org/ns/ttml/profile/imsc1#styling";c.ns_ittp="http://www.w3.org/ns/ttml/profile/imsc1#parameter";c.ns_smpte="http://www.smpte-ra.org/schemas/2052-1/2010/smpte-tt";c.ns_ebutts="urn:ebu:tt:style";c.ttaf_map={"http://www.w3.org/2006/10/ttaf1":c.ns_tt,"http://www.w3.org/2006/10/ttaf1#style":c.ns_tts,"http://www.w3.org/2006/10/ttaf1#parameter":c.ns_ttp}},{}],38:[function(c,p,l){(function(b,
c,m){function h(a,b,c,h,m,l,p,r){this.name=b;this.ns=a;this.qname=a+" "+b;this.inherit=m;this.animatable=l;this.initial=c;this.applies=h;this.parse=p;this.compute=r}b.all=[new h(c.ns_tts,"backgroundColor","transparent",["body","div","p","region","span"],!1,!0,m.parseColor,null),new h(c.ns_tts,"color","white",["span"],!0,!0,m.parseColor,null),new h(c.ns_tts,"direction","ltr",["p","span"],!0,!0,function(a){return a},null),new h(c.ns_tts,"display","auto",["body","div","p","region","span"],!1,!0,function(a){return a},
null),new h(c.ns_tts,"displayAlign","before",["region"],!1,!0,function(a){return a},null),new h(c.ns_tts,"extent","auto",["tt","region"],!1,!0,function(a){if("auto"===a)return a;var b=a.split(" ");if(2!==b.length)return null;a=m.parseLength(b[0]);return(b=m.parseLength(b[1]))&&a?{h:b,w:a}:null},function(a,b,c,h,l){if("auto"===h)b=new m.ComputedLength(0,1);else if(b=m.toComputedLength(h.h.value,h.h.unit,null,a.dimensions.h,null,a.pxLength.h),null===b)return null;if("auto"===h)a=new m.ComputedLength(1,
0);else if(a=m.toComputedLength(h.w.value,h.w.unit,null,a.dimensions.w,null,a.pxLength.w),null===a)return null;return{h:b,w:a}}),new h(c.ns_tts,"fontFamily","default",["span","p"],!0,!0,function(a){a=a.split(",");for(var b=[],c=0;c<a.length;c++)"'"!==a[c].charAt(0)&&'"'!==a[c].charAt(0)?"default"===a[c]?b.push("monospaceSerif"):b.push(a[c]):b.push(a[c]);return b},null),new h(c.ns_tts,"shear","0%",["p"],!0,!0,m.parseLength,function(a,b,c,h){if("%"===h.unit)a=100<Math.abs(h.value)?100*Math.sign(h.value):
h.value;else return null;return a}),new h(c.ns_tts,"fontSize","1c",["span","p"],!0,!0,m.parseLength,function(a,c,h,l,q){return m.toComputedLength(l.value,l.unit,null!==c?c.styleAttrs[b.byName.fontSize.qname]:a.cellLength.h,null!==c?c.styleAttrs[b.byName.fontSize.qname]:a.cellLength.h,a.cellLength.h,a.pxLength.h)}),new h(c.ns_tts,"fontStyle","normal",["span","p"],!0,!0,function(a){return a},null),new h(c.ns_tts,"fontWeight","normal",["span","p"],!0,!0,function(a){return a},null),new h(c.ns_tts,"lineHeight",
"normal",["p"],!0,!0,function(a){return"normal"===a?a:m.parseLength(a)},function(a,c,h,l,q){if("normal"===l)a=l;else if(a=m.toComputedLength(l.value,l.unit,h.styleAttrs[b.byName.fontSize.qname],h.styleAttrs[b.byName.fontSize.qname],a.cellLength.h,a.pxLength.h),null===a)return null;return a}),new h(c.ns_tts,"opacity",1,["region"],!1,!0,parseFloat,null),new h(c.ns_tts,"origin","auto",["region"],!1,!0,function(a){if("auto"===a)return a;var b=a.split(" ");if(2!==b.length)return null;a=m.parseLength(b[0]);
return(b=m.parseLength(b[1]))&&a?{h:b,w:a}:null},function(a,b,c,h,l){if("auto"===h)b=new m.ComputedLength(0,0);else if(b=m.toComputedLength(h.h.value,h.h.unit,null,a.dimensions.h,null,a.pxLength.h),null===b)return null;if("auto"===h)a=new m.ComputedLength(0,0);else if(a=m.toComputedLength(h.w.value,h.w.unit,null,a.dimensions.w,null,a.pxLength.w),null===a)return null;return{h:b,w:a}}),new h(c.ns_tts,"overflow","hidden",["region"],!1,!0,function(a){return a},null),new h(c.ns_tts,"padding","0px",["region"],
!1,!0,function(a){a=a.split(" ");if(4<a.length)return null;for(var b=[],c=0;c<a.length;c++){var h=m.parseLength(a[c]);if(!h)return null;b.push(h)}return b},function(a,c,h,l,q){if(1===l.length)c=[l[0],l[0],l[0],l[0]];else if(2===l.length)c=[l[0],l[1],l[0],l[1]];else if(3===l.length)c=[l[0],l[1],l[2],l[1]];else if(4===l.length)c=[l[0],l[1],l[2],l[3]];else return null;l=h.styleAttrs[b.byName.writingMode.qname];if("lrtb"===l||"lr"===l)c=[c[0],c[3],c[2],c[1]];else if("rltb"===l||"rl"===l)c=[c[0],c[1],
c[2],c[3]];else if("tblr"===l)c=[c[3],c[0],c[1],c[2]];else if("tbrl"===l||"tb"===l)c=[c[3],c[2],c[1],c[0]];else return null;l=[];for(q=0;q<c.length;q++)if(0===c[q].value)l[q]=new m.ComputedLength(0,0);else if(l[q]=m.toComputedLength(c[q].value,c[q].unit,h.styleAttrs[b.byName.fontSize.qname],"0"===q||"2"===q?h.styleAttrs[b.byName.extent.qname].h:h.styleAttrs[b.byName.extent.qname].w,"0"===q||"2"===q?a.cellLength.h:a.cellLength.w,"0"===q||"2"===q?a.pxLength.h:a.pxLength.w),null===l[q])return null;return l}),
new h(c.ns_tts,"position","top left",["region"],!1,!0,function(a){return m.parsePosition(a)},function(a,c,h,l){c=m.toComputedLength(l.v.offset.value,l.v.offset.unit,null,new m.ComputedLength(-h.styleAttrs[b.byName.extent.qname].h.rw,a.dimensions.h.rh-h.styleAttrs[b.byName.extent.qname].h.rh),null,a.pxLength.h);if(null===c)return null;"bottom"===l.v.edge&&(c=new m.ComputedLength(-c.rw-h.styleAttrs[b.byName.extent.qname].h.rw,a.dimensions.h.rh-c.rh-h.styleAttrs[b.byName.extent.qname].h.rh));var q=m.toComputedLength(l.h.offset.value,
l.h.offset.unit,null,new m.ComputedLength(a.dimensions.w.rw-h.styleAttrs[b.byName.extent.qname].w.rw,-h.styleAttrs[b.byName.extent.qname].w.rh),null,a.pxLength.w);if(null===c)return null;"right"===l.h.edge&&(q=new m.ComputedLength(a.dimensions.w.rw-q.rw-h.styleAttrs[b.byName.extent.qname].w.rw,-q.rh-h.styleAttrs[b.byName.extent.qname].w.rh));return{h:c,w:q}}),new h(c.ns_tts,"ruby","none",["span"],!1,!0,function(a){return a},null),new h(c.ns_tts,"rubyAlign","center",["span"],!0,!0,function(a){return"center"!==
a&&"spaceAround"!==a?null:a},null),new h(c.ns_tts,"rubyPosition","outside",["span"],!0,!0,function(a){return a},null),new h(c.ns_tts,"rubyReserve","none",["p"],!0,!0,function(a){var b=a.split(" ");a=[null,null];if(0===b.length||2<b.length||"none"!==b[0]&&"both"!==b[0]&&"after"!==b[0]&&"before"!==b[0]&&"outside"!==b[0])return null;a[0]=b[0];if(2===b.length&&"none"!==b[0])if(b=m.parseLength(b[1]))a[1]=b;else return null;return a},function(a,c,h,l,q){if("none"===l[0])return l;a=null===l[1]?new m.ComputedLength(.5*
h.styleAttrs[b.byName.fontSize.qname].rw,.5*h.styleAttrs[b.byName.fontSize.qname].rh):m.toComputedLength(l[1].value,l[1].unit,h.styleAttrs[b.byName.fontSize.qname],h.styleAttrs[b.byName.fontSize.qname],a.cellLength.h,a.pxLength.h);return null===a?null:[l[0],a]}),new h(c.ns_tts,"showBackground","whenActive",["region"],!1,!0,function(a){return a},null),new h(c.ns_tts,"textAlign","start",["p"],!0,!0,function(a){return a},function(a,b,c,h,m){return"left"===h?"start":"right"===h?"end":h}),new h(c.ns_tts,
"textCombine","none",["span"],!0,!0,function(a){return"none"===a||"all"===a?a:null},null),new h(c.ns_tts,"textDecoration","none",["span"],!0,!0,function(a){return a.split(" ")},null),new h(c.ns_tts,"textEmphasis","none",["span"],!0,!0,function(a){a=a.split(" ");for(var b={style:null,symbol:null,color:null,position:null},c=0;c<a.length;c++)if("none"===a[c]||"auto"===a[c])b.style=a[c];else if("filled"===a[c]||"open"===a[c])b.style=a[c];else if("circle"===a[c]||"dot"===a[c]||"sesame"===a[c])b.symbol=
a[c];else if("current"===a[c])b.color=a[c];else if("outside"===a[c]||"before"===a[c]||"after"===a[c])b.position=a[c];else if(b.color=m.parseColor(a[c]),null===b.color)return null;null==b.style&&null==b.symbol?b.style="auto":(b.symbol=b.symbol||"circle",b.style=b.style||"filled");b.position=b.position||"outside";b.color=b.color||"current";return b},null),new h(c.ns_tts,"textOutline","none",["span"],!0,!0,function(a){if("none"===a)return a;var b={};a=a.split(" ");if(0===a.length||2<a.length)return null;
var c=m.parseColor(a[0]);b.color=c;null!==c&&a.shift();if(1!==a.length)return null;a=m.parseLength(a[0]);if(!a)return null;b.thickness=a;return b},function(a,c,h,l,q){if("none"===l)return l;c={};c.color=null===l.color?h.styleAttrs[b.byName.color.qname]:l.color;c.thickness=m.toComputedLength(l.thickness.value,l.thickness.unit,h.styleAttrs[b.byName.fontSize.qname],h.styleAttrs[b.byName.fontSize.qname],a.cellLength.h,a.pxLength.h);return null===c.thickness?null:c}),new h(c.ns_tts,"textShadow","none",
["span"],!0,!0,m.parseTextShadow,function(a,c,h,l){if("none"===l)return l;c=[];for(var q in l)if(q.hasOwnProperty(l)){var p={};p.x_off=m.toComputedLength(l[q][0].value,l[q][0].unit,null,h.styleAttrs[b.byName.fontSize.qname],null,a.pxLength.w);if(null===p.x_off)return null;p.y_off=m.toComputedLength(l[q][1].value,l[q][1].unit,null,h.styleAttrs[b.byName.fontSize.qname],null,a.pxLength.h);if(null===p.y_off)return null;if(null===l[q][2])p.b_radius=0;else if(p.b_radius=m.toComputedLength(l[q][2].value,
l[q][2].unit,null,h.styleAttrs[b.byName.fontSize.qname],null,a.pxLength.h),null===p.b_radius)return null;p.color=null===l[q][3]?h.styleAttrs[b.byName.color.qname]:l[q][3];c.push(p)}return c}),new h(c.ns_tts,"unicodeBidi","normal",["span","p"],!1,!0,function(a){return a},null),new h(c.ns_tts,"visibility","visible",["body","div","p","region","span"],!0,!0,function(a){return a},null),new h(c.ns_tts,"wrapOption","wrap",["span"],!0,!0,function(a){return a},null),new h(c.ns_tts,"writingMode","lrtb",["region"],
!1,!0,function(a){return a},null),new h(c.ns_tts,"zIndex","auto",["region"],!1,!0,function(a){"auto"!==a&&(a=parseInt(a),isNaN(a)&&(a=null));return a},null),new h(c.ns_ebutts,"linePadding","0c",["p"],!0,!1,m.parseLength,function(a,b,c,h,l){return m.toComputedLength(h.value,h.unit,null,null,a.cellLength.w,null)}),new h(c.ns_ebutts,"multiRowAlign","auto",["p"],!0,!1,function(a){return a},null),new h(c.ns_smpte,"backgroundImage",null,["div"],!1,!1,function(a){return a},null),new h(c.ns_itts,"forcedDisplay",
...
imscUtils)},{"./names":37,"./utils":39}],39:[function(c,p,l){(function(b){var c=/#([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})?/,l=/rgb\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*\)/,p=/rgba\(\s*(\d+),\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*\)/,v={transparent:[0,0,0,0],black:[0,0,0,255],silver:[192,192,192,255],gray:[128,128,128,255],white:[255,255,255,255],maroon:[128,0,0,255],red:[255,0,0,255],purple:[128,0,128,255],fuchsia:[255,0,255,255],magenta:[255,0,255,255],green:[0,128,0,255],lime:[0,
255,0,255],olive:[128,128,0,255],yellow:[255,255,0,255],navy:[0,0,128,255],blue:[0,0,255,255],teal:[0,128,128,255],aqua:[0,255,255,255],cyan:[0,255,255,255]};b.parseColor=function(a){var b,h=null,m=v[a.toLowerCase()];void 0!==m?h=m:null!==(b=c.exec(a))?h=[parseInt(b[1],16),parseInt(b[2],16),parseInt(b[3],16),void 0!==b[4]?parseInt(b[4],16):255]:null!==(b=l.exec(a))?h=[parseInt(b[1]),parseInt(b[2]),parseInt(b[3]),255]:null!==(b=p.exec(a))&&(h=[parseInt(b[1]),parseInt(b[2]),parseInt(b[3]),parseInt(b[4])]);
return h};var H=/^((?:\+|\-)?\d*(?:\.\d+)?)(px|em|c|%|rh|rw)$/;b.parseLength=function(a){var b,c=null;null!==(b=H.exec(a))&&(c={value:parseFloat(b[1]),unit:b[2]});return c};b.parseTextShadow=function(a){a=a.split(",");for(var c=[],h=0;h<a.length;h++){var l=a[h].split(" ");if(1===l.length&&"none"===l[0])return"none";if(1<l.length&&5>l.length){var m=[null,null,null,null],p=b.parseLength(l.shift());if(null===p)return null;m[0]=p;p=b.parseLength(l.shift());if(null===p)return null;m[1]=p;if(0!==l.length&&
(p=b.parseLength(l[0]),null!==p&&(m[2]=p,l.shift()),0!==l.length)){l=b.parseColor(l[0]);if(null===l)return null;m[3]=l}c.push(m)}}return c};b.parsePosition=function(a){a=a.split(" ");var c=function(a){return"center"===a||"left"===a||"top"===a||"bottom"===a||"right"===a};if(4<a.length)return null;for(var h in a)if(a.hasOwnProperty(h)&&!c(a[h])){var l=b.parseLength(a[h]);if(null===l)return null;a[h]=l}h={h:{edge:"left",offset:{value:50,unit:"%"}},v:{edge:"top",offset:{value:50,unit:"%"}}};for(l=0;l<
a.length;){var m=a[l++];if(c(m)){var p={value:0,unit:"%"};2!==a.length&&l<a.length&&!c(a[l])&&(p=a[l++]);"right"===m?(h.h.edge=m,h.h.offset=p):"bottom"===m?(h.v.edge=m,h.v.offset=p):"left"===m?h.h.offset=p:"top"===m&&(h.v.offset=p)}else if(1===a.length||2===a.length)1===l?h.h.offset=m:h.v.offset=m;else return null}return h};b.ComputedLength=function(a,b){this.rw=a;this.rh=b};b.ComputedLength.prototype.toUsedLength=function(a,b){return a*this.rw+b*this.rh};b.ComputedLength.prototype.multiply=function(a,
