...
b):(a.styleAttrs||(a.styleAttrs={}),a.styleAttrs["http://www.w3.org/ns/ttml#styling backgroundColor"]=m.parseColor("black"));else if(c&&delete a.styleAttrs["http://www.w3.org/ns/ttml#styling backgroundColor"],a.contents)for(var f=0;f<a.contents.length;f++)g(a.contents[f],c||b)}function b(a){if("contents"in a){var c="styleAttrs"in a?a.styleAttrs[p.byName.ruby.qname]:null;c="span"===a.kind&&("container"===c||"textContainer"===c||"baseContainer"===c);for(var f=a.contents.length-1;0<=f;f--)!c||"styleAttrs"in
a.contents[f]&&p.byName.ruby.qname in a.contents[f].styleAttrs?b(a.contents[f]):delete a.contents[f]}}function h(a,b,c,f){var e=f&&"seq"===f.timeContainer,d=0;f&&(d=e&&c?c.end:f.begin);b.begin=b.explicit_begin?b.explicit_begin+d:d;c=b.begin;f=null;for(var n in b.sets)h(a,b.sets[n],f,b),c="seq"===b.timeContainer?b.sets[n].end:Math.max(c,b.sets[n].end),f=b.sets[n];if("contents"in b)for(var g in b.contents)h(a,b.contents[g],f,b),c="seq"===b.timeContainer?b.contents[g].end:Math.max(c,b.contents[g].end),
