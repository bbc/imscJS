...
b):c||b||(a.styleAttrs||(a.styleAttrs={}),a.styleAttrs["http://www.w3.org/ns/ttml#styling backgroundColor"]=m.parseColor("black"));else if(c&&delete a.styleAttrs["http://www.w3.org/ns/ttml#styling backgroundColor"],a.contents)for(var f=0;f<a.contents.length;f++)g(a.contents[f],c||b)}function b(a){if("contents"in a){var c="styleAttrs"in a?a.styleAttrs[p.byName.ruby.qname]:null;c="span"===a.kind&&("container"===c||"textContainer"===c||"baseContainer"===c);for(var f=a.contents.length-1;0<=f;f--)!c||
