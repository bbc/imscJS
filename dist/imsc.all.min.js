...
b):currentBg||b||(a.styleAttrs||(a.styleAttrs={}),a.styleAttrs["http://www.w3.org/ns/ttml#styling backgroundColor"]=m.parseColor("black"));else if(c&&delete a.styleAttrs["http://www.w3.org/ns/ttml#styling backgroundColor"],a.contents)for(var f=0;f<a.contents.length;f++)g(a.contents[f],c||b)}function b(a){if("contents"in a){var c="styleAttrs"in a?a.styleAttrs[p.byName.ruby.qname]:null;c="span"===a.kind&&("container"===c||"textContainer"===c||"baseContainer"===c);for(var f=a.contents.length-1;0<=f;f--)!c||
"styleAttrs"in a.contents[f]&&p.byName.ruby.qname in a.contents[f].styleAttrs?b(a.contents[f]):delete a.contents[f]}}function h(a,b,c,f){var e=f&&"seq"===f.timeContainer,d=0;f&&(d=e&&c?c.end:f.begin);b.begin=b.explicit_begin?b.explicit_begin+d:d;c=b.begin;f=null;for(var n in b.sets)h(a,b.sets[n],f,b),c="seq"===b.timeContainer?b.sets[n].end:Math.max(c,b.sets[n].end),f=b.sets[n];if("contents"in b)for(var g in b.contents)h(a,b.contents[g],f,b),c="seq"===b.timeContainer?b.contents[g].end:Math.max(c,b.contents[g].end),
f=b.contents[g];else c=e?b.begin:Number.POSITIVE_INFINITY;b.end=null!==b.explicit_end&&null!==b.explicit_dur?Math.min(b.begin+b.explicit_dur,d+b.explicit_end):null===b.explicit_end&&null!==b.explicit_dur?b.begin+b.explicit_dur:null!==b.explicit_end&&null===b.explicit_dur?d+b.explicit_end:c;delete b.explicit_begin;delete b.explicit_dur;delete b.explicit_end;a._registerEvent(b)}function D(a){this.node=a}function q(){this.events=[];this.head=new a;this.body=null}function a(){this.styling=new f;this.layout=
new C}function f(){this.styles={};this.initials={}}function v(){this.styleRefs=this.styleAttrs=this.id=null}function n(){this.styleAttrs=null}function C(){this.regions={}}function r(a,b){this.kind="image";this.src=a;this.type=b}function y(a){this.id=a}function w(a){this.regionID=a}function L(a){this.styleAttrs=a}function E(a){this.sets=a}function M(a){this.contents=a}function H(a,b,c){this.explicit_begin=a;this.explicit_end=b;this.explicit_dur=c}function z(){this.kind="body"}function K(){this.kind=
"div"}function O(){this.kind="p"}function G(){this.kind="span"}function A(){this.kind="span"}function R(){this.kind="br"}function k(){}function I(){}function e(a){var b=null;a&&(a=a.attributes["xml:id"]||a.attributes.id)&&(b=a.value||null);return b}function t(a){return a&&"style"in a.attributes?a.attributes.style.value.split(" "):[]}function W(a,b){var c={};if(null!==a)for(var f in a.attributes){var e=a.attributes[f].uri+" "+a.attributes[f].local,d=p.byQName[e];if(void 0!==d){var h=d.parse(a.attributes[f].value);
null!==h?(c[e]=h,d===p.byName.zIndex&&V(b,"zIndex attribute present but not used by IMSC1 since regions do not overlap")):J(b,"Cannot parse styling attribute "+e+" --\x3e "+a.attributes[f].value)}}return c}function Q(a,b,c){for(var f in a.attributes)if(a.attributes[f].uri===b&&a.attributes[f].local===c)return a.attributes[f].value;return null}function aa(a,b){a=Q(a,l.ns_tts,"extent");if(null===a)return null;var c=a.split(" ");if(2!==c.length)return V(b,"Malformed extent (ignoring)"),null;a=m.parseLength(c[0]);
c=m.parseLength(c[1]);return c&&a?{h:c,w:a}:(V(b,"Malformed extent values (ignoring)"),null)}function Y(a,b,c){var f=/^(\d{2,}):(\d\d):(\d\d(?:\.\d+)?)$/,e=/^(\d{2,}):(\d\d):(\d\d):(\d{2,})$/,d=/^(\d+(?:\.\d+)?)t$/,h=/^(\d+(?:\.\d+)?)ms$/,n=/^(\d+(?:\.\d+)?)s$/,g=/^(\d+(?:\.\d+)?)h$/,v=/^(\d+(?:\.\d+)?)m$/,k,l=null;null!==(k=/^(\d+(?:\.\d+)?)f$/.exec(c))?null!==b&&(l=parseFloat(k[1])/b):null!==(k=d.exec(c))?null!==a&&(l=parseFloat(k[1])/a):null!==(k=h.exec(c))?l=parseFloat(k[1])/1E3:null!==(k=n.exec(c))?
l=parseFloat(k[1]):null!==(k=g.exec(c))?l=3600*parseFloat(k[1]):null!==(k=v.exec(c))?l=60*parseFloat(k[1]):null!==(k=f.exec(c))?l=3600*parseInt(k[1])+60*parseInt(k[2])+parseFloat(k[3]):null!==(k=e.exec(c))&&null!==b&&(l=3600*parseInt(k[1])+60*parseInt(k[2])+parseInt(k[3])+(null===k[4]?0:parseInt(k[4])/b));return l}function u(a,b,c){for(;0<b.styleRefs.length;){var f=b.styleRefs.pop();f in a.styles?(u(a,a.styles[f],c),T(a.styles[f].styleAttrs,b.styleAttrs)):J(c,"Non-existant style id referenced")}}
function X(a,b,c,f){for(var e=b.length-1;0<=e;e--){var d=b[e];d in a.styles?T(a.styles[d].styleAttrs,c):J(f,"Non-existant style id referenced")}}function T(a,b){for(var c in a)c in b||(b[c]=a[c])}function V(a,b){if(a&&a.warn&&a.warn(b))throw b;}function J(a,b){if(a&&a.error&&a.error(b))throw b;}function P(a,b){a&&a.fatal&&a.fatal(b);throw b;}function ba(a,b){for(var c=0,f=a.length-1,e;c<=f;){e=Math.floor((c+f)/2);var d=a[e];if(d<b)c=e+1;else if(d>b)f=e-1;else return{found:!0,index:e}}return{found:!1,
index:c}}c.fromXML=function(c,e,m){var t=d.parser(!0,{xmlns:!0}),x=[],E=[],N=[],Z=0,y=null;t.onclosetag=function(a){if(x[0]instanceof f)for(var b in x[0].styles)u(x[0],x[0].styles[b],e);else if(x[0]instanceof O||x[0]instanceof G){if(1<x[0].contents.length){a=[x[0].contents[0]];for(b=1;b<x[0].contents.length;b++)x[0].contents[b]instanceof A&&a[a.length-1]instanceof A?a[a.length-1].text+=x[0].contents[b].text:a.push(x[0].contents[b]);x[0].contents=a}x[0]instanceof G&&1===x[0].contents.length&&x[0].contents[0]instanceof
A&&(x[0].text=x[0].contents[0].text,delete x[0].contents)}else if(x[0]instanceof D)if(x[0].node.uri===l.ns_tt&&"metadata"===x[0].node.local)Z--;else if(0<Z&&m&&"onCloseTag"in m)m.onCloseTag();N.shift();E.shift();x.shift()};t.ontext=function(a){if(void 0!==x[0])if(x[0]instanceof G||x[0]instanceof O){if(x[0]instanceof G){var b=x[0].styleAttrs[p.byName.ruby.qname];if("container"===b||"textContainer"===b||"baseContainer"===b)return}b=new A;b.initFromText(y,x[0],a,N[0],e);x[0].contents.push(b)}else if(x[0]instanceof
D&&0<Z&&m&&"onText"in m)m.onText(a)};t.onopentag=function(b){function c(a){l.ttaf_map[a.uri]&&(a.uri=l.ttaf_map[a.uri])}var d=b.attributes["xml:space"];d?N.unshift(d.value):0===N.length?N.unshift("default"):N.unshift(N[0]);(d=b.attributes["xml:lang"])?E.unshift(d.value):0===E.length?E.unshift(""):E.unshift(E[0]);c(b);if(b.attributes)for(var h in b.attributes)b.attributes.hasOwnProperty(h)&&c(b.attributes[h]);if(b.uri===l.ns_tt)if("tt"===b.local)null!==y&&P(e,"Two <tt> elements at ("+this.line+","+
this.column+")"),y=new q,y.initFromNode(b,e),x.unshift(y);else if("head"===b.local)x[0]instanceof q||P(e,"Parent of <head> element is not <tt> at ("+this.line+","+this.column+")"),x.unshift(y.head);else if("styling"===b.local)x[0]instanceof a||P(e,"Parent of <styling> element is not <head> at ("+this.line+","+this.column+")"),x.unshift(y.head.styling);else if("style"===b.local)if(x[0]instanceof f){var g=new v;g.initFromNode(b,e);g.id?y.head.styling.styles[g.id]=g:J(e,"<style> element missing @id attribute");
x.unshift(g)}else x[0]instanceof k?(g=new v,g.initFromNode(b,e),T(g.styleAttrs,x[0].styleAttrs),x.unshift(g)):P(e,"Parent of <style> element is not <styling> or <region> at ("+this.line+","+this.column+")");else if("initial"===b.local)if(x[0]instanceof f){h=new n;h.initFromNode(b,e);for(g in h.styleAttrs)y.head.styling.initials[g]=h.styleAttrs[g];x.unshift(h)}else P(e,"Parent of <initial> element is not <styling> at ("+this.line+","+this.column+")");else if("layout"===b.local)x[0]instanceof a||P(e,
...
break}c||(w=k.prototype.createDefaultRegion(y,e),y.head.layout.regions[w.id]=w);for(var S in y.head.layout.regions)h(y,y.head.layout.regions[S],null,null);y.body&&h(y,y.body,null,null);y.body&&b(y.body);y.body&&g(y.body);return y};q.prototype.initFromNode=function(a,b){var c=Q(a,l.ns_ttp,"cellResolution"),f=15;var e=32;null!==c&&(c=/(\d+) (\d+)/.exec(c),null!==c?(e=parseInt(c[1]),f=parseInt(c[2])):V(b,"Malformed cellResolution value (using initial value instead)"));this.cellLength={h:new m.ComputedLength(0,
1/f),w:new m.ComputedLength(1/e,0)};f=Q(a,l.ns_ttp,"frameRate");c=30;null!==f&&(e=/(\d+)/.exec(f),null!==e?c=parseInt(e[1]):V(b,"Malformed frame rate attribute (using initial value instead)"));e=Q(a,l.ns_ttp,"frameRateMultiplier");var d=1;null!==e&&(e=/(\d+) (\d+)/.exec(e),null!==e?d=parseInt(e[1])/parseInt(e[2]):V(b,"Malformed frame rate multiplier attribute (using initial value instead)"));c*=d;d=1;e=Q(a,l.ns_ttp,"tickRate");null===e?null!==f&&(d=c):(e=/(\d+)/.exec(e),null!==e?d=parseInt(e[1]):
V(b,"Malformed tick rate attribute (using initial value instead)"));this.effectiveFrameRate=c;this.tickRate=d;e=Q(a,l.ns_ittp,"aspectRatio");null===e&&(e=Q(a,l.ns_ttp,"displayAspectRatio"));f=null;null!==e&&(c=/(\d+)\s+(\d+)/.exec(e),null!==c?(e=parseInt(c[1]),c=parseInt(c[2]),0!==e&&0!==c?f=e/c:J(b,"Illegal aspectRatio values (ignoring)")):J(b,"Malformed aspectRatio attribute (ignoring)"));this.aspectRatio=f;f=Q(a,l.ns_ttp,"timeBase");null!==f&&"media"!==f&&P(b,"Unsupported time base");a=aa(a,b);
null===a?this.pxLength={h:null,w:null}:("px"===a.h.unit&&"px"===a.w.unit||P(b,"Extent on TT must be in px or absent"),this.pxLength={h:new m.ComputedLength(0,1/a.h.value),w:new m.ComputedLength(1/a.w.value,0)});this.dimensions={h:new m.ComputedLength(0,1),w:new m.ComputedLength(1,0)}};q.prototype._registerEvent=function(a){if(!(a.end<=a.begin)){var b=ba(this.events,a.begin);b.found||this.events.splice(b.index,0,a.begin);a.end!==Number.POSITIVE_INFINITY&&(b=ba(this.events,a.end),b.found||this.events.splice(b.index,
0,a.end))}};q.prototype.getMediaTimeRange=function(){return[this.events[0],this.events[this.events.length-1]]};q.prototype.getMediaTimeEvents=function(){return this.events};v.prototype.initFromNode=function(a,b){this.id=e(a);this.styleAttrs=W(a,b);this.styleRefs=t(a)};n.prototype.initFromNode=function(a,b){this.styleAttrs={};for(var c in a.attributes)if(a.attributes[c].uri===l.ns_itts||a.attributes[c].uri===l.ns_ebutts||a.attributes[c].uri===l.ns_tts)this.styleAttrs[a.attributes[c].uri+" "+a.attributes[c].local]=
a.attributes[c].value};r.prototype.initFromNode=function(a,b,c,f){(this.src="src"in c.attributes?c.attributes.src.value:null)||J(f,"Invalid image@src attribute");(this.type="type"in c.attributes?c.attributes.type.value:null)||J(f,"Invalid image@type attribute");L.prototype.initFromNode.call(this,a,b,c,f);H.prototype.initFromNode.call(this,a,b,c,f);E.prototype.initFromNode.call(this,a,b,c,f);w.prototype.initFromNode.call(this,a,b,c,f)};y.prototype.initFromNode=function(a,b,c,f){this.id=e(c)};w.prototype.initFromNode=
function(a,b,c,f){this.regionID=c&&"region"in c.attributes?c.attributes.region.value:""};L.prototype.initFromNode=function(a,b,c,f){this.styleAttrs=W(c,f);null!==a.head&&null!==a.head.styling&&X(a.head.styling,t(c),this.styleAttrs,f)};E.prototype.initFromNode=function(a,b,c,f){this.sets=[]};M.prototype.initFromNode=function(a,b,c,f){this.contents=[]};H.prototype.initFromNode=function(a,b,c,f){b=null;c&&"begin"in c.attributes&&(b=Y(a.tickRate,a.effectiveFrameRate,c.attributes.begin.value),null===b&&
V(f,"Malformed begin value "+c.attributes.begin.value+" (using 0)"));var e=null;c&&"dur"in c.attributes&&(e=Y(a.tickRate,a.effectiveFrameRate,c.attributes.dur.value),null===e&&V(f,"Malformed dur value "+c.attributes.dur.value+" (ignoring)"));var d=null;c&&"end"in c.attributes&&(d=Y(a.tickRate,a.effectiveFrameRate,c.attributes.end.value),null===d&&V(f,"Malformed end value (ignoring)"));this.explicit_begin=b;this.explicit_end=d;this.explicit_dur=e;(a=c&&"timeContainer"in c.attributes?c.attributes.timeContainer.value:
null)&&"par"!==a?"seq"===a?f="seq":(J(f,"Illegal value of timeContainer (assuming 'par')"),f="par"):f="par";this.timeContainer=f};z.prototype.initFromNode=function(a,b,c){L.prototype.initFromNode.call(this,a,null,b,c);H.prototype.initFromNode.call(this,a,null,b,c);E.prototype.initFromNode.call(this,a,null,b,c);w.prototype.initFromNode.call(this,a,null,b,c);M.prototype.initFromNode.call(this,a,null,b,c)};K.prototype.initFromNode=function(a,b,c,f){L.prototype.initFromNode.call(this,a,b,c,f);H.prototype.initFromNode.call(this,
a,b,c,f);E.prototype.initFromNode.call(this,a,b,c,f);w.prototype.initFromNode.call(this,a,b,c,f);M.prototype.initFromNode.call(this,a,b,c,f)};O.prototype.initFromNode=function(a,b,c,f){L.prototype.initFromNode.call(this,a,b,c,f);H.prototype.initFromNode.call(this,a,b,c,f);E.prototype.initFromNode.call(this,a,b,c,f);w.prototype.initFromNode.call(this,a,b,c,f);M.prototype.initFromNode.call(this,a,b,c,f)};G.prototype.initFromNode=function(a,b,c,f,e){L.prototype.initFromNode.call(this,a,b,c,e);H.prototype.initFromNode.call(this,
a,b,c,e);E.prototype.initFromNode.call(this,a,b,c,e);w.prototype.initFromNode.call(this,a,b,c,e);M.prototype.initFromNode.call(this,a,b,c,e);this.space=f};A.prototype.initFromText=function(a,b,c,f,e){H.prototype.initFromNode.call(this,a,b,null,e);this.text=c;this.space=f};R.prototype.initFromNode=function(a,b,c,f){w.prototype.initFromNode.call(this,a,b,c,f);H.prototype.initFromNode.call(this,a,b,c,f)};k.prototype.createDefaultRegion=function(a,b){var c=new k;c.id="";L.prototype.initFromNode.call(c,
...
p[c].te[h].style.textEmphasisPosition||(p[c].te[h].style.textEmphasisPosition="tb"===a.bpd?0===c?"left over":"left under":"rl"===a.bpd?0===c?"right under":"left under":0===c?"left under":"right under");a.textEmphasis=null}if(a.mra){for(c=0;c<p.length-1;c++)v=p[c].elements.length,0!==v&&!1===p[c].br&&(h=document.createElement("br"),v=p[c].elements[v-1].node,v.parentElement.insertBefore(h,v.nextSibling));a.mra=null}if(a.lp){c=a.lp.toUsedLength(a.w,a.h);for(var B in p)h=p[B].elements[p[B].start_elem],
v=p[B].elements[p[B].end_elem],E=Math.ceil(c)+"px",w="-"+Math.ceil(c)+"px",0!==p[B].elements.length&&("lr"===a.ipd?(h.node.style.borderLeftColor=h.bgcolor||"#00000000",h.node.style.borderLeftStyle="solid",h.node.style.borderLeftWidth=E,h.node.style.marginLeft=w):"rl"===a.ipd?(h.node.style.borderRightColor=h.bgcolor||"#00000000",h.node.style.borderRightStyle="solid",h.node.style.borderRightWidth=E,h.node.style.marginRight=w):"tb"===a.ipd&&(h.node.style.borderTopColor=h.bgcolor||"#00000000",h.node.style.borderTopStyle=
"solid",h.node.style.borderTopWidth=E,h.node.style.marginTop=w),"lr"===a.ipd?(v.node.style.borderRightColor=v.bgcolor||"#00000000",v.node.style.borderRightStyle="solid",v.node.style.borderRightWidth=E,v.node.style.marginRight=w):"rl"===a.ipd?(v.node.style.borderLeftColor=v.bgcolor||"#00000000",v.node.style.borderLeftStyle="solid",v.node.style.borderLeftWidth=E,v.node.style.marginLeft=w):"tb"===a.ipd&&(v.node.style.borderBottomColor=v.bgcolor||"#00000000",v.node.style.borderBottomStyle="solid",v.node.style.borderBottomWidth=
E,v.node.style.marginBottom=w));a.lp=null}if(a.flg){c=r(q.getBoundingClientRect(),a);B=c.before;c=c.after;h=Math.sign(c-B);for(v=0;v<=p.length;v++){E=0===v?B:v===p.length?c:(p[v].before+p[v-1].after)/2;if(0<v)for(var H=0;H<p[v-1].elements.length;H++)if(null!==p[v-1].elements[H].bgcolor){var z=p[v-1].elements[H];0>h*(z.after-E)&&(w=Math.ceil(Math.abs(E-z.after))+"px",z.node.style.backgroundColor=z.bgcolor,"lr"===a.bpd?z.node.style.paddingRight=w:"rl"===a.bpd?z.node.style.paddingLeft=w:"tb"===a.bpd&&
(z.node.style.paddingBottom=w))}if(v<p.length)for(H=0;H<p[v].elements.length;H++)z=p[v].elements[H],null!==z.bgcolor&&0<h*(z.before-E)&&(w=Math.ceil(Math.abs(z.before-E))+"px",z.node.style.backgroundColor=z.bgcolor,"lr"===a.bpd?z.node.style.paddingLeft=w:"rl"===a.bpd?z.node.style.paddingRight=w:"tb"===a.bpd&&(z.node.style.paddingTop=w))}a.flg=null}}"region"===d.kind&&(b(a,q,p),"tb"===a.bpd&&a.enableRollUp&&0<d.contents.length&&"after"===d.styleAttrs[l.byName.displayAlign.qname]&&(d=new m(""===d.id?
"_":d.id,p),a.currentISDState[d.id]=d,a.previousISDState&&d.id in a.previousISDState&&0<a.previousISDState[d.id].plist.length&&1<d.plist.length&&d.plist[d.plist.length-2].text===a.previousISDState[d.id].plist[a.previousISDState[d.id].plist.length-1].text&&(a=f.firstElementChild,d=d.plist[d.plist.length-1].after-d.plist[d.plist.length-1].before,a.style.bottom="-"+d+"px",a.style.transition="transform 0.4s",a.style.position="relative",a.style.transform="translateY(-"+d+"px)")))}else if(a=a.errorHandler,
d="Error processing ISD element kind: "+d.kind,a&&a.error&&a.error(d))throw d;}function m(a,b){this.id=a;this.plist=b}function r(a,b){var c={before:null,after:null,start:null,end:null};"tb"===b.bpd?(c.before=a.top,c.after=a.bottom,"lr"===b.ipd?(c.start=a.left,c.end=a.right):(c.start=a.right,c.end=a.left)):"lr"===b.bpd?(c.before=a.left,c.after=a.right,c.start=a.top,c.end=a.bottom):"rl"===b.bpd&&(c.before=a.right,c.after=a.left,c.start=a.top,c.end=a.bottom);return c}function b(a,c,d,h){if("rt"!==c.localName&&
"rtc"!==c.localName)if(h=c.style.backgroundColor||h,0===c.childElementCount)if("span"===c.localName||"rb"===c.localName){var f=c.getBoundingClientRect();if(0!==f.height&&0!==f.width){a=r(f,a);if(!(f=0===d.length)){f=a.before;var g=a.after,n=d[d.length-1].before,l=d[d.length-1].after;f=!(g<l&&f>n||l<=g&&n>=f)}f?d.push({before:a.before,after:a.after,start:a.start,end:a.end,start_elem:0,end_elem:0,elements:[],rbc:[],te:[],text:"",br:!1}):(f=Math.sign(a.after-a.before),g=Math.sign(a.end-a.start),0>f*
(a.before-d[d.length-1].before)&&(d[d.length-1].before=a.before),0<f*(a.after-d[d.length-1].after)&&(d[d.length-1].after=a.after),0>g*(a.start-d[d.length-1].start)&&(d[d.length-1].start=a.start,d[d.length-1].start_elem=d[d.length-1].elements.length),0<g*(a.end-d[d.length-1].end)&&(d[d.length-1].end=a.end,d[d.length-1].end_elem=d[d.length-1].elements.length));d[d.length-1].text+=c.textContent;d[d.length-1].elements.push({node:c,bgcolor:h,before:a.before,after:a.after})}}else"br"===c.localName&&0!==
d.length&&(d[d.length-1].br=!0);else for(c=c.firstChild;c;)c.nodeType===Node.ELEMENT_NODE&&(b(a,c,d,h),"ruby"===c.localName||"rtc"===c.localName?0<d.length&&d[d.length-1].rbc.push(c):"span"===c.localName&&c.style.textEmphasisStyle&&"none"!==c.style.textEmphasisStyle&&0<d.length&&d[d.length-1].te.push(c)),c=c.nextSibling}function h(a,b){this.qname=a;this.map=b}c.render=function(a,b,c,d,h,l,q,p,m){d=d||b.clientHeight;h=h||b.clientWidth;if(null!==a.aspectRatio){var f=d*a.aspectRatio;f>h?d=Math.round(h/
a.aspectRatio):h=f}f=document.createElement("div");f.style.position="relative";f.style.width=h+"px";f.style.height=d+"px";f.style.margin="auto";f.style.top=0;f.style.bottom=0;f.style.left=0;f.style.right=0;f.style.zIndex=0;c={h:d,w:h,regionH:null,regionW:null,imgResolver:c,displayForcedOnlyMode:l||!1,isd:a,errorHandler:q,previousISDState:p,enableRollUp:m||!1,currentISDState:{},flg:null,lp:null,mra:null,ipd:null,bpd:null,ruby:null,textEmphasis:null,rubyReserve:null};b.appendChild(f);for(var n in a.contents)g(c,
f,a.contents[n]);return c.currentISDState};var D=[new h("http://www.w3.org/ns/ttml#styling backgroundColor",function(a,b,c,d){0!==d[3]&&(b.style.backgroundColor="rgba("+d[0].toString()+","+d[1].toString()+","+d[2].toString()+","+(d[3]/255).toString()+")")}),new h("http://www.w3.org/ns/ttml#styling color",function(a,b,c,d){b.style.color="rgba("+d[0].toString()+","+d[1].toString()+","+d[2].toString()+","+(d[3]/255).toString()+")"}),new h("http://www.w3.org/ns/ttml#styling direction",function(a,b,c,
...
c,d,h,r,w,y,B,L){if(c<y.begin||c>=y.end)return null;w="regionID"in y&&""!==y.regionID?y.regionID:w;if(null!==r&&w!==d.id&&(!("contents"in y)||"contents"in y&&0===y.contents.length||""!==w))return null;var f=new D(y);for(n in y.sets)c<y.sets[n].begin||c>=y.sets[n].end||(f.styleAttrs[y.sets[n].qname]=y.sets[n].value);var n={};for(var v in f.styleAttrs)if(n[v]=!0,v===l.byName.writingMode.qname&&!(l.byName.direction.qname in f.styleAttrs)){var z=f.styleAttrs[v];if("lrtb"===z||"lr"===z)f.styleAttrs[l.byName.direction.qname]=
"ltr";else if("rltb"===z||"rl"===z)f.styleAttrs[l.byName.direction.qname]="rtl"}if(null!==r)for(var C in l.all)if(v=l.all[C],v.qname===l.byName.textDecoration.qname){z=r.styleAttrs[v.qname];var F=f.styleAttrs[v.qname],G=[];void 0===F?G=z:-1===F.indexOf("none")?((-1===F.indexOf("noUnderline")&&-1!==z.indexOf("underline")||-1!==F.indexOf("underline"))&&G.push("underline"),(-1===F.indexOf("noLineThrough")&&-1!==z.indexOf("lineThrough")||-1!==F.indexOf("lineThrough"))&&G.push("lineThrough"),(-1===F.indexOf("noOverline")&&
-1!==z.indexOf("overline")||-1!==F.indexOf("overline"))&&G.push("overline")):G.push("none");f.styleAttrs[v.qname]=G}else v.qname!==l.byName.fontSize.qname||v.qname in f.styleAttrs||"span"!==f.kind||"textContainer"!==f.styleAttrs[l.byName.ruby.qname]?v.qname!==l.byName.fontSize.qname||v.qname in f.styleAttrs||"span"!==f.kind||"text"!==f.styleAttrs[l.byName.ruby.qname]?v.inherit&&v.qname in r.styleAttrs&&!(v.qname in f.styleAttrs)&&(f.styleAttrs[v.qname]=r.styleAttrs[v.qname]):(z=r.styleAttrs[l.byName.fontSize.qname],
f.styleAttrs[v.qname]="textContainer"===r.styleAttrs[l.byName.ruby.qname]?z:new p.ComputedLength(.5*z.rw,.5*z.rh)):(z=r.styleAttrs[l.byName.fontSize.qname],f.styleAttrs[v.qname]=new p.ComputedLength(.5*z.rw,.5*z.rh));for(var A in l.all)(C=l.all[A],C.qname in f.styleAttrs||C.qname===l.byName.position.qname&&l.byName.origin.qname in f.styleAttrs||C.qname===l.byName.origin.qname&&l.byName.position.qname in f.styleAttrs||(v=a.head.styling.initials[C.qname]||C.initial,"region"!==f.kind&&(!1!==C.inherit||
null===v)))||(f.styleAttrs[C.qname]=C.parse(v),n[C.qname]=!0);for(var R in l.all)if(A=l.all[R],A.qname in n&&null!==A.compute)if(C=A.compute(a,r,f,f.styleAttrs[A.qname],L),null!==C)f.styleAttrs[A.qname]=C;else if(f.styleAttrs[A.qname]=A.compute(a,r,f,A.parse(A.initial),L),A="Style '"+A.qname+"' on element '"+f.kind+"' cannot be computed",B&&B.error&&B.error(A))throw A;if("none"===f.styleAttrs[l.byName.display.qname])return null;if(null===r)var k=null===h?[]:[h];else"contents"in y&&(k=y.contents);
for(var I in k)r=g(a,c,d,h,f,w,k[I],B,L),null!==r&&f.contents.push(r.element);for(var e in f.styleAttrs)a=!1,"span"===f.kind&&(c=f.styleAttrs[l.byName.ruby.qname],(a=("container"===c||"textContainer"===c||"baseContainer"===c)&&-1!==q.indexOf(e))||(a="container"!==c&&e===l.byName.rubyAlign.qname),a||(a=!("textContainer"===c||"text"===c)&&e===l.byName.rubyPosition.qname)),a||(a=-1===l.byQName[e].applies.indexOf(f.kind)),a&&delete f.styleAttrs[e];"span"===f.kind&&f.text&&"default"===f.space&&(e=f.text.replace(/[\t\r\n ]+/g,
" "),f.text=e);if("p"===f.kind){e=[];m(f,e);a=0;c="after_br";for(d=0;;)if("after_br"===c)a>=e.length||"br"===e[a].kind?(c="before_br",d=a,a--):("preserve"!==e[a].space&&(e[a].text=e[a].text.replace(/^[\t\r\n ]+/g,"")),0<e[a].text.length?(c="looking_br",a++):e.splice(a,1));else if("before_br"===c)if(0>a||"br"===e[a].kind){if(c="after_br",a=d+1,a>=e.length)break}else if("preserve"!==e[a].space&&(e[a].text=e[a].text.replace(/[\t\r\n ]+$/g,"")),0<e[a].text.length){if(c="after_br",a=d+1,a>=e.length)break}else e.splice(a,
1),a--;else a>=e.length||"br"===e[a].kind?(c="before_br",d=a,a--):a++;b(f)}return"div"===f.kind&&l.byName.backgroundImage.qname in f.styleAttrs||"br"===f.kind||"image"===f.kind||"contents"in f&&0<f.contents.length||"span"===f.kind&&null!==f.text||"region"===f.kind&&"always"===f.styleAttrs[l.byName.showBackground.qname]?{region_id:w,element:f}:null}function m(a,b){if("contents"in a)for(var c in a.contents)m(a.contents[c],b);else"span"!==a.kind&&"br"!==a.kind||b.push(a)}function b(a){if("br"===a.kind)return!1;
...
c;this.ns=b;this.qname=b+" "+c;this.inherit=a;this.animatable=f;this.initial=d;this.applies=g;this.parse=l;this.compute=m}c.all=[new g(d.ns_tts,"backgroundColor","transparent",["body","div","p","region","span"],!1,!0,l.parseColor,null),new g(d.ns_tts,"color","white",["span"],!0,!0,l.parseColor,null),new g(d.ns_tts,"direction","ltr",["p","span"],!0,!0,function(b){return b},null),new g(d.ns_tts,"display","auto",["body","div","p","region","span"],!1,!0,function(b){return b},null),new g(d.ns_tts,"displayAlign",
"before",["region"],!1,!0,function(b){return b},null),new g(d.ns_tts,"extent","auto",["tt","region"],!1,!0,function(b){if("auto"===b)return b;var c=b.split(" ");if(2!==c.length)return null;b=l.parseLength(c[0]);return(c=l.parseLength(c[1]))&&b?{h:c,w:b}:null},function(b,c,d,g,a){if("auto"===g)c=new l.ComputedLength(0,1);else if(c=l.toComputedLength(g.h.value,g.h.unit,null,b.dimensions.h,null,b.pxLength.h),null===c)return null;if("auto"===g)b=new l.ComputedLength(1,0);else if(b=l.toComputedLength(g.w.value,
g.w.unit,null,b.dimensions.w,null,b.pxLength.w),null===b)return null;return{h:c,w:b}}),new g(d.ns_tts,"fontFamily","default",["span"],!0,!0,function(b){b=b.split(",");var c=[],d;for(d in b)"'"!==b[d].charAt(0)&&'"'!==b[d].charAt(0)?"default"===b[d]?c.push("monospaceSerif"):c.push(b[d]):c.push(b[d]);return c},null),new g(d.ns_tts,"shear","0%",["p"],!0,!0,l.parseLength,function(b,c,d,g){if("%"===g.unit)b=100<Math.abs(g.value)?100*Math.sign(g.value):g.value;else return null;return b}),new g(d.ns_tts,
"fontSize","1c",["span"],!0,!0,l.parseLength,function(b,d,g,q,a){return l.toComputedLength(q.value,q.unit,null!==d?d.styleAttrs[c.byName.fontSize.qname]:b.cellLength.h,null!==d?d.styleAttrs[c.byName.fontSize.qname]:b.cellLength.h,b.cellLength.h,b.pxLength.h)}),new g(d.ns_tts,"fontStyle","normal",["span"],!0,!0,function(b){return b},null),new g(d.ns_tts,"fontWeight","normal",["span"],!0,!0,function(b){return b},null),new g(d.ns_tts,"lineHeight","normal",["p"],!0,!0,function(b){return"normal"===b?b:
l.parseLength(b)},function(b,d,g,q,a){if("normal"===q)b=q;else if(b=l.toComputedLength(q.value,q.unit,g.styleAttrs[c.byName.fontSize.qname],g.styleAttrs[c.byName.fontSize.qname],b.cellLength.h,b.pxLength.h),null===b)return null;return b}),new g(d.ns_tts,"opacity",1,["region"],!1,!0,parseFloat,null),new g(d.ns_tts,"origin","auto",["region"],!1,!0,function(b){if("auto"===b)return b;var c=b.split(" ");if(2!==c.length)return null;b=l.parseLength(c[0]);return(c=l.parseLength(c[1]))&&b?{h:c,w:b}:null},
...
var c=[],d;for(d in b){var g=l.parseLength(b[d]);if(!g)return null;c.push(g)}return c},function(b,d,g,q,a){if(1===q.length)d=[q[0],q[0],q[0],q[0]];else if(2===q.length)d=[q[0],q[1],q[0],q[1]];else if(3===q.length)d=[q[0],q[1],q[2],q[1]];else if(4===q.length)d=[q[0],q[1],q[2],q[3]];else return null;q=g.styleAttrs[c.byName.writingMode.qname];if("lrtb"===q||"lr"===q)d=[d[0],d[3],d[2],d[1]];else if("rltb"===q||"rl"===q)d=[d[0],d[1],d[2],d[3]];else if("tblr"===q)d=[d[3],d[0],d[1],d[2]];else if("tbrl"===
q||"tb"===q)d=[d[3],d[2],d[1],d[0]];else return null;q=[];for(var f in d)if(0===d[f].value)q[f]=new l.ComputedLength(0,0);else if(q[f]=l.toComputedLength(d[f].value,d[f].unit,g.styleAttrs[c.byName.fontSize.qname],"0"===f||"2"===f?g.styleAttrs[c.byName.extent.qname].h:g.styleAttrs[c.byName.extent.qname].w,"0"===f||"2"===f?b.cellLength.h:b.cellLength.w,"0"===f||"2"===f?b.pxLength.h:b.pxLength.w),null===q[f])return null;return q}),new g(d.ns_tts,"position","top left",["region"],!1,!0,function(b){return l.parsePosition(b)},
function(b,d,g,q){d=l.toComputedLength(q.v.offset.value,q.v.offset.unit,null,new l.ComputedLength(-g.styleAttrs[c.byName.extent.qname].h.rw,b.dimensions.h.rh-g.styleAttrs[c.byName.extent.qname].h.rh),null,b.pxLength.h);if(null===d)return null;"bottom"===q.v.edge&&(d=new l.ComputedLength(-d.rw-g.styleAttrs[c.byName.extent.qname].h.rw,b.dimensions.h.rh-d.rh-g.styleAttrs[c.byName.extent.qname].h.rh));var a=l.toComputedLength(q.h.offset.value,q.h.offset.unit,null,new l.ComputedLength(b.dimensions.w.rw-
g.styleAttrs[c.byName.extent.qname].w.rw,-g.styleAttrs[c.byName.extent.qname].w.rh),null,b.pxLength.w);if(null===d)return null;"right"===q.h.edge&&(a=new l.ComputedLength(b.dimensions.w.rw-a.rw-g.styleAttrs[c.byName.extent.qname].w.rw,-a.rh-g.styleAttrs[c.byName.extent.qname].w.rh));return{h:d,w:a}}),new g(d.ns_tts,"ruby","none",["span"],!1,!0,function(b){return b},null),new g(d.ns_tts,"rubyAlign","center",["span"],!0,!0,function(b){return"center"!==b&&"spaceAround"!==b?null:b},null),new g(d.ns_tts,
"rubyPosition","outside",["span"],!0,!0,function(b){return b},null),new g(d.ns_tts,"rubyReserve","none",["p"],!0,!0,function(b){var c=b.split(" ");b=[null,null];if(0===c.length||2<c.length||"none"!==c[0]&&"both"!==c[0]&&"after"!==c[0]&&"before"!==c[0]&&"outside"!==c[0])return null;b[0]=c[0];if(2===c.length&&"none"!==c[0])if(c=l.parseLength(c[1]))b[1]=c;else return null;return b},function(b,d,g,q,a){if("none"===q[0])return q;b=null===q[1]?new l.ComputedLength(.5*g.styleAttrs[c.byName.fontSize.qname].rw,
.5*g.styleAttrs[c.byName.fontSize.qname].rh):l.toComputedLength(q[1].value,q[1].unit,g.styleAttrs[c.byName.fontSize.qname],g.styleAttrs[c.byName.fontSize.qname],b.cellLength.h,b.pxLength.h);return null===b?null:[q[0],b]}),new g(d.ns_tts,"showBackground","whenActive",["region"],!1,!0,function(b){return b},null),new g(d.ns_tts,"textAlign","start",["p"],!0,!0,function(b){return b},function(b,c,d,g,a){return"left"===g?"start":"right"===g?"end":g}),new g(d.ns_tts,"textCombine","none",["span"],!0,!0,function(b){b=
b.split(" ");return 1!==b.length||"none"!==b[0]&&"all"!==b[0]?null:[b[0]]},null),new g(d.ns_tts,"textDecoration","none",["span"],!0,!0,function(b){return b.split(" ")},null),new g(d.ns_tts,"textEmphasis","none",["span"],!0,!0,function(b){b=b.split(" ");var c={style:null,symbol:null,color:null,position:null},d;for(d in b)if("none"===b[d]||"auto"===b[d])c.style=b[d];else if("filled"===b[d]||"open"===b[d])c.style=b[d];else if("circle"===b[d]||"dot"===b[d]||"sesame"===b[d])c.symbol=b[d];else if("current"===
b[d])c.color=b[d];else if("outside"===b[d]||"before"===b[d]||"after"===b[d])c.position=b[d];else if(c.color=l.parseColor(b[d]),null===c.color)return null;null==c.style&&null==c.symbol?c.style="auto":(c.symbol=c.symbol||"circle",c.style=c.style||"filled");c.position=c.position||"outside";c.color=c.color||"current";return c},null),new g(d.ns_tts,"textOutline","none",["span"],!0,!0,function(b){if("none"===b)return b;var c={};b=b.split(" ");if(0===b.length||2<b.length)return null;var d=l.parseColor(b[0]);
c.color=d;null!==d&&b.shift();if(1!==b.length)return null;b=l.parseLength(b[0]);if(!b)return null;c.thickness=b;return c},function(b,d,g,q,a){if("none"===q)return q;d={};d.color=null===q.color?g.styleAttrs[c.byName.color.qname]:q.color;d.thickness=l.toComputedLength(q.thickness.value,q.thickness.unit,g.styleAttrs[c.byName.fontSize.qname],g.styleAttrs[c.byName.fontSize.qname],b.cellLength.h,b.pxLength.h);return null===d.thickness?null:d}),new g(d.ns_tts,"textShadow","none",["span"],!0,!0,l.parseTextShadow,
function(b,d,g,q){if("none"===q)return q;d=[];for(var a in q){var f={};f.x_off=l.toComputedLength(q[a][0].value,q[a][0].unit,null,g.styleAttrs[c.byName.fontSize.qname],null,b.pxLength.w);if(null===f.x_off)return null;f.y_off=l.toComputedLength(q[a][1].value,q[a][1].unit,null,g.styleAttrs[c.byName.fontSize.qname],null,b.pxLength.h);if(null===f.y_off)return null;if(null===q[a][2])f.b_radius=0;else if(f.b_radius=l.toComputedLength(q[a][2].value,q[a][2].unit,null,g.styleAttrs[c.byName.fontSize.qname],
null,b.pxLength.h),null===f.b_radius)return null;f.color=null===q[a][3]?g.styleAttrs[c.byName.color.qname]:q[a][3];d.push(f)}return d}),new g(d.ns_tts,"unicodeBidi","normal",["span","p"],!1,!0,function(b){return b},null),new g(d.ns_tts,"visibility","visible",["body","div","p","region","span"],!0,!0,function(b){return b},null),new g(d.ns_tts,"wrapOption","wrap",["span"],!0,!0,function(b){return b},null),new g(d.ns_tts,"writingMode","lrtb",["region"],!1,!0,function(b){return b},null),new g(d.ns_tts,
"zIndex","auto",["region"],!1,!0,function(b){"auto"!==b&&(b=parseInt(b),isNaN(b)&&(b=null));return b},null),new g(d.ns_ebutts,"linePadding","0c",["p"],!0,!1,l.parseLength,function(b,c,d,g,a){return l.toComputedLength(g.value,g.unit,null,null,b.cellLength.w,null)}),new g(d.ns_ebutts,"multiRowAlign","auto",["p"],!0,!1,function(b){return b},null),new g(d.ns_smpte,"backgroundImage",null,["div"],!1,!1,function(b){return b},null),new g(d.ns_itts,"forcedDisplay","false",["body","div","p","region","span"],
!0,!0,function(b){return"true"===b?!0:!1},null),new g(d.ns_itts,"fillLineGap","true",["p"],!0,!0,function(b){return"true"===b?!0:!1},null)];c.byQName={};for(var m in c.all)c.byQName[c.all[m].qname]=c.all[m];c.byName={};for(var r in c.all)c.byName[c.all[r].name]=c.all[r]})("undefined"===typeof m?this.imscStyles={}:m,"undefined"===typeof imscNames?d("./names"):imscNames,"undefined"===typeof imscUtils?d("./utils"):imscUtils)},{"./names":37,"./utils":39}],39:[function(d,r,m){(function(c){var d=/#([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})?/,
l=/rgb\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*\)/,m=/rgba\(\s*(\d+),\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*\)/,r={transparent:[0,0,0,0],black:[0,0,0,255],silver:[192,192,192,255],gray:[128,128,128,255],white:[255,255,255,255],maroon:[128,0,0,255],red:[255,0,0,255],purple:[128,0,128,255],fuchsia:[255,0,255,255],magenta:[255,0,255,255],green:[0,128,0,255],lime:[0,255,0,255],olive:[128,128,0,255],yellow:[255,255,0,255],navy:[0,0,128,255],blue:[0,0,255,255],teal:[0,128,128,255],aqua:[0,255,255,255],cyan:[0,
255,255,255]};c.parseColor=function(b){var c,g=null,q=r[b.toLowerCase()];void 0!==q?g=q:null!==(c=d.exec(b))?g=[parseInt(c[1],16),parseInt(c[2],16),parseInt(c[3],16),void 0!==c[4]?parseInt(c[4],16):255]:null!==(c=l.exec(b))?g=[parseInt(c[1]),parseInt(c[2]),parseInt(c[3]),255]:null!==(c=m.exec(b))&&(g=[parseInt(c[1]),parseInt(c[2]),parseInt(c[3]),parseInt(c[4])]);return g};var B=/^((?:\+|\-)?\d*(?:\.\d+)?)(px|em|c|%|rh|rw)$/;c.parseLength=function(b){var c,d=null;null!==(c=B.exec(b))&&(d={value:parseFloat(c[1]),
unit:c[2]});return d};c.parseTextShadow=function(b){b=b.split(",");var d=[],g;for(g in b){var l=b[g].split(" ");if(1===l.length&&"none"===l[0])return"none";if(1<l.length&&5>l.length){var a=[null,null,null,null],f=c.parseLength(l.shift());if(null===f)return null;a[0]=f;f=c.parseLength(l.shift());if(null===f)return null;a[1]=f;if(0!==l.length&&(f=c.parseLength(l[0]),null!==f&&(a[2]=f,l.shift()),0!==l.length)){l=c.parseColor(l[0]);if(null===l)return null;a[3]=l}d.push(a)}}return d};c.parsePosition=function(b){b=
b.split(" ");var d=function(a){return"center"===a||"left"===a||"top"===a||"bottom"===a||"right"===a};if(4<b.length)return null;for(var g in b)if(!d(b[g])){var l=c.parseLength(b[g]);if(null===l)return null;b[g]=l}g={h:{edge:"left",offset:{value:50,unit:"%"}},v:{edge:"top",offset:{value:50,unit:"%"}}};for(l=0;l<b.length;){var a=b[l++];if(d(a)){var f={value:0,unit:"%"};2!==b.length&&l<b.length&&!d(b[l])&&(f=b[l++]);"right"===a?(g.h.edge=a,g.h.offset=f):"bottom"===a?(g.v.edge=a,g.v.offset=f):"left"===
a?g.h.offset=f:"top"===a&&(g.v.offset=f)}else if(1===b.length||2===b.length)1===l?g.h.offset=a:g.v.offset=a;else return null}return g};c.ComputedLength=function(b,c){this.rw=b;this.rh=c};c.ComputedLength.prototype.toUsedLength=function(b,c){return b*this.rw+c*this.rh};c.ComputedLength.prototype.isZero=function(){return 0===this.rw&&0===this.rh};c.toComputedLength=function(b,d,g,l,a,f){return"%"===d&&l?new c.ComputedLength(l.rw*b/100,l.rh*b/100):"em"===d&&g?new c.ComputedLength(g.rw*b,g.rh*b):"c"===
d&&a?new c.ComputedLength(b*a.rw,b*a.rh):"px"===d&&f?new c.ComputedLength(b*f.rw,b*f.rh):"rh"===d?new c.ComputedLength(0,b/100):"rw"===d?new c.ComputedLength(b/100,0):null}})("undefined"===typeof m?this.imscUtils={}:m)},{}]},{},[36])(36)});
